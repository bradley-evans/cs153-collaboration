...
main(int argc, char *argv[])
{
  ...
  printf(1, "stressfs starting\n");
  16:	c7 44 24 04 1e 08 00 	movl   $0x81e,0x4(%esp)
  1d:	00 
  memset(data, 'a', sizeof(data));
...
main(int argc, char *argv[])
{
  ...
  printf(1, "write %d\n", i);
  7e:	c7 44 24 04 31 08 00 	movl   $0x831,0x4(%esp)
  85:	00 
...
//    printf(fd, "%d\n", i);
  ...
  printf(1, "read\n");
  d6:	c7 44 24 04 3b 08 00 	movl   $0x83b,0x4(%esp)
  dd:	00 
...
putc(int fd, char c)
{
 ...
 5df:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 5e1:	b8 41 08 00 00       	mov    $0x841,%eax
...
000006a0 <free>:
 6a0:	55                   	push   %ebp
 6a1:	a1 c4 0a 00 00       	mov    0xac4,%eax
 ...
 6f9:	a3 c4 0a 00 00       	mov    %eax,0xac4
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 701:	5d                   	pop    %ebp
 ...
 71d:	a3 c4 0a 00 00       	mov    %eax,0xac4
...
00000730 <malloc>:
 ...
 73c:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
 ...
 791:	39 05 c4 0a 00 00    	cmp    %eax,0xac4
 ...
 7bb:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
 ...
 7df:	89 15 c4 0a 00 00    	mov    %edx,0xac4
 ...
 7f6:	c7 05 c4 0a 00 00 c8 	movl   $0xac8,0xac4
 7fd:	0a 00 00 
 800:	c7 05 c8 0a 00 00 c8 	movl   $0xac8,0xac8
 807:	0a 00 00 
 80a:	b8 c8 0a 00 00       	mov    $0xac8,%eax
 80f:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 816:	00 00 00 
