...
main(int argc, char *argv[])
{
  ...
  5f:	c7 44 24 04 71 07 00 	movl   $0x771,0x4(%esp)
  66:	00 
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 85 07 00 00       	mov    $0x785,%eax
...
00000670 <malloc>:
 ...
 6d1:	39 05 04 0a 00 00    	cmp    %eax,0xa04
 ...
 6fb:	8b 15 04 0a 00 00    	mov    0xa04,%edx
 ...
 71f:	89 15 04 0a 00 00    	mov    %edx,0xa04
 ...
 736:	c7 05 04 0a 00 00 08 	movl   $0xa08,0xa04
 73d:	0a 00 00 
 740:	c7 05 08 0a 00 00 08 	movl   $0xa08,0xa08
 747:	0a 00 00 
 74a:	b8 08 0a 00 00       	mov    $0xa08,%eax
 74f:	c7 05 0c 0a 00 00 00 	movl   $0x0,0xa0c
 756:	00 00 00 
