...
80101e68:	68 ff 76 10 80       	push   $0x801076ff
...
80102e79:	e8 32 29 00 00       	call   801057b0 <idtinit>
...
80102f1b:	e8 30 09 00 00       	call   80103850 <pinit>
  tvinit();        // trap vectors
80102f20:	e8 eb 27 00 00       	call   80105710 <tvinit>
  binit();         // buffer cache
...
8010300a:	e8 51 fe ff ff       	call   80102e60 <mpmain>
  ...
  if(!ismp)
    timerinit();   // uniprocessor timer
8010300f:	e8 9c 26 00 00       	call   801056b0 <timerinit>
...
801037b4:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801037b7:	c7 40 14 fe 56 10 80 	movl   $0x801056fe,0x14(%eax)
...
80103c41:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx

  if(proc == initproc)
80103c48:	3b 15 bc a5 10 80    	cmp    0x8010a5bc,%edx
...
80103c55:	89 42 7c             	mov    %eax,0x7c(%edx)

  if(proc == initproc)
80103c58:	0f 84 19 01 00 00    	je     80103d77 <exit+0x137>
80103c5e:	31 db                	xor    %ebx,%ebx
    panic("init exiting");
...
801040a8:	8b 14 85 fc 75 10 80 	mov    -0x7fef8a04(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
80104126:	68 b5 75 10 80       	push   $0x801075b5
...
8010414a:	68 14 76 10 80       	push   $0x80107614
...
8010432b:	68 1f 76 10 80       	push   $0x8010761f
...
8010442f:	68 3e 76 10 80       	push   $0x8010763e
...
8010443c:	68 27 76 10 80       	push   $0x80107627
...
8010446e:	68 45 76 10 80       	push   $0x80107645
...
801048bc:	8b 0c 85 80 76 10 80 	mov    -0x7fef8980(,%eax,4),%ecx
...
801048e0:	68 4d 76 10 80       	push   $0x8010764d
...
80104a54:	68 d0 75 10 80       	push   $0x801075d0
...
80104a6c:	68 cf 75 10 80       	push   $0x801075cf
...
80104a8e:	68 f7 76 10 80       	push   $0x801076f7
...
80104e9d:	58                   	pop    %eax
80104e9e:	5a                   	pop    %edx
80104e9f:	68 d0 75 10 80       	push   $0x801075d0
...
80104eb8:	68 cf 75 10 80       	push   $0x801075cf
...
8010500d:	68 19 77 10 80       	push   $0x80107719
...
8010501a:	68 2b 77 10 80       	push   $0x8010772b
...
80105027:	68 07 77 10 80       	push   $0x80107707
...
801054f3:	83 ec 14             	sub    $0x14,%esp
  exit(status);
801054f6:	ff 75 08             	pushl  0x8(%ebp)
801054f9:	e8 42 e7 ff ff       	call   80103c40 <exit>
  return 0;  // not reached
}
801054fe:	31 c0                	xor    %eax,%eax
80105500:	c9                   	leave  
80105501:	c3                   	ret    
...
8010552c:	e8 5f f2 ff ff       	call   80104790 <argint>
...
8010553e:	e8 8d ea ff ff       	call   80103fd0 <kill>
...
80105597:	e8 c4 e3 ff ff       	call   80103960 <growproc>
...
801055cd:	e8 be f1 ff ff       	call   80104790 <argint>
...
801055e0:	68 e0 4d 11 80       	push   $0x80114de0
801055e5:	e8 86 ec ff ff       	call   80104270 <acquire>
  ticks0 = ticks;
...
801055ed:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801055f0:	8b 1d 20 56 11 80    	mov    0x80115620,%ebx
  while(ticks - ticks0 < n){
...
80105603:	68 e0 4d 11 80       	push   $0x80114de0
80105608:	68 20 56 11 80       	push   $0x80115620
8010560d:	e8 be e7 ff ff       	call   80103dd0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105612:	a1 20 56 11 80       	mov    0x80115620,%eax
...
80105631:	68 e0 4d 11 80       	push   $0x80114de0
80105636:	e8 15 ee ff ff       	call   80104450 <release>
      return -1;
...
80105653:	68 e0 4d 11 80       	push   $0x80114de0
...
80105674:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105677:	68 e0 4d 11 80       	push   $0x80114de0
8010567c:	e8 ef eb ff ff       	call   80104270 <acquire>
  xticks = ticks;
80105681:	8b 1d 20 56 11 80    	mov    0x80115620,%ebx
  release(&tickslock);
80105687:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
...
801056a3:	83 ec 08             	sub    $0x8,%esp
	myhello();
801056a6:	e8 75 ea ff ff       	call   80104120 <myhello>
	return 0;   
}
...
801056b6:	b8 34 00 00 00       	mov    $0x34,%eax
801056bb:	89 e5                	mov    %esp,%ebp
801056bd:	83 ec 14             	sub    $0x14,%esp
801056c0:	ee                   	out    %al,(%dx)
801056c1:	ba 40 00 00 00       	mov    $0x40,%edx
801056c6:	b8 9c ff ff ff       	mov    $0xffffff9c,%eax
801056cb:	ee                   	out    %al,(%dx)
801056cc:	b8 2e 00 00 00       	mov    $0x2e,%eax
...
801056d4:	e8 a7 db ff ff       	call   80103280 <picenable>
}
...
801056df:	06                   	push   %es
  pushl %fs
801056e0:	0f a0                	push   %fs
  pushl %gs
801056e2:	0f a8                	push   %gs
  pushal
801056e4:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
801056e5:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056e9:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056eb:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
801056ed:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
801056f1:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
801056f3:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
801056f5:	54                   	push   %esp
  call trap
801056f6:	e8 e5 00 00 00       	call   801057e0 <trap>
  addl $4, %esp
801056fb:	83 c4 04             	add    $0x4,%esp
...
801056fe:	61                   	popa   
  popl %gs
801056ff:	0f a9                	pop    %gs
  popl %fs
80105701:	0f a1                	pop    %fs
  popl %es
80105703:	07                   	pop    %es
  popl %ds
80105704:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105705:	83 c4 08             	add    $0x8,%esp
  iret
80105708:	cf                   	iret   
...
80105724:	c6 04 c5 24 4e 11 80 	movb   $0x0,-0x7feeb1dc(,%eax,8)
8010572b:	00 
8010572c:	66 89 0c c5 22 4e 11 	mov    %cx,-0x7feeb1de(,%eax,8)
80105733:	80 
80105734:	c6 04 c5 25 4e 11 80 	movb   $0x8e,-0x7feeb1db(,%eax,8)
8010573b:	8e 
8010573c:	66 89 14 c5 20 4e 11 	mov    %dx,-0x7feeb1e0(,%eax,8)
80105743:	80 
80105744:	c1 ea 10             	shr    $0x10,%edx
80105747:	66 89 14 c5 26 4e 11 	mov    %dx,-0x7feeb1da(,%eax,8)
8010574e:	80 
void
tvinit(void)
{
...
80105769:	68 3a 77 10 80       	push   $0x8010773a
8010576e:	68 e0 4d 11 80       	push   $0x80114de0
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105773:	66 89 15 22 50 11 80 	mov    %dx,0x80115022
8010577a:	c6 05 24 50 11 80 00 	movb   $0x0,0x80115024
80105781:	66 a3 20 50 11 80    	mov    %ax,0x80115020
80105787:	c1 e8 10             	shr    $0x10,%eax
8010578a:	c6 05 25 50 11 80 ef 	movb   $0xef,0x80115025
80105791:	66 a3 26 50 11 80    	mov    %ax,0x80115026

  initlock(&tickslock, "time");
80105797:	e8 b4 ea ff ff       	call   80104250 <initlock>
}
...
801057bb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801057bf:	b8 20 4e 11 80       	mov    $0x80114e20,%eax
...
801057fe:	77 68                	ja     80105868 <trap+0x88>
...
80105809:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
80105810:	e8 bb ce ff ff       	call   801026d0 <cpunum>
80105815:	85 c0                	test   %eax,%eax
80105817:	0f 84 c3 01 00 00    	je     801059e0 <trap+0x200>
    kbdintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_COM1:
    uartintr();
    lapiceoi();
8010581d:	e8 4e cf ff ff       	call   80102770 <lapiceoi>
  }
...
8010582a:	74 2d                	je     80105859 <trap+0x79>
8010582c:	8b 50 24             	mov    0x24(%eax),%edx
8010582f:	85 d2                	test   %edx,%edx
80105831:	0f 85 86 00 00 00    	jne    801058bd <trap+0xdd>
    exit(0);

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80105837:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
8010583b:	0f 84 ef 00 00 00    	je     80105930 <trap+0x150>
    yield();
...
80105861:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80105868:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
8010586f:	85 c9                	test   %ecx,%ecx
80105871:	0f 84 9d 01 00 00    	je     80105a14 <trap+0x234>
80105877:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010587b:	0f 84 93 01 00 00    	je     80105a14 <trap+0x234>
...
80105884:	8b 73 38             	mov    0x38(%ebx),%esi
80105887:	e8 44 ce ff ff       	call   801026d0 <cpunum>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
8010588c:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
...
80105896:	ff 73 34             	pushl  0x34(%ebx)
80105899:	ff 73 30             	pushl  0x30(%ebx)
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
8010589c:	8d 42 6c             	lea    0x6c(%edx),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
...
801058a0:	ff 72 10             	pushl  0x10(%edx)
801058a3:	68 9c 77 10 80       	push   $0x8010779c
801058a8:	e8 b3 ad ff ff       	call   80100660 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
            rcr2());
    proc->killed = 1;
...
801058b6:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
  ...
  // until it gets to the regular system call return.)
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801058bd:	0f b7 53 3c          	movzwl 0x3c(%ebx),%edx
801058c1:	83 e2 03             	and    $0x3,%edx
801058c4:	66 83 fa 03          	cmp    $0x3,%dx
801058c8:	0f 85 69 ff ff ff    	jne    80105837 <trap+0x57>
    exit(0);
801058ce:	83 ec 0c             	sub    $0xc,%esp
801058d1:	6a 00                	push   $0x0
801058d3:	e8 68 e3 ff ff       	call   80103c40 <exit>
...
801058e3:	0f 85 4e ff ff ff    	jne    80105837 <trap+0x57>
801058e9:	e9 6b ff ff ff       	jmp    80105859 <trap+0x79>
...
801058fb:	0f 85 bf 00 00 00    	jne    801059c0 <trap+0x1e0>
      exit(0);
    proc->tf = tf;
80105901:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105904:	e8 97 ef ff ff       	call   801048a0 <syscall>
    if(proc->killed)
80105909:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010590f:	8b 58 24             	mov    0x24(%eax),%ebx
80105912:	85 db                	test   %ebx,%ebx
80105914:	0f 84 3f ff ff ff    	je     80105859 <trap+0x79>
      exit(0);
...
80105927:	5d                   	pop    %ebp
    ...
    if(proc->killed)
      exit(0);
80105928:	e9 13 e3 ff ff       	jmp    80103c40 <exit>
...
80105934:	0f 85 07 ff ff ff    	jne    80105841 <trap+0x61>
    yield();
8010593a:	e8 51 e4 ff ff       	call   80103d90 <yield>
8010593f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80105945:	85 c0                	test   %eax,%eax
80105947:	0f 85 f4 fe ff ff    	jne    80105841 <trap+0x61>
8010594d:	e9 07 ff ff ff       	jmp    80105859 <trap+0x79>
80105952:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105958:	e8 53 cc ff ff       	call   801025b0 <kbdintr>
    lapiceoi();
8010595d:	e8 0e ce ff ff       	call   80102770 <lapiceoi>
    break;
80105962:	e9 bb fe ff ff       	jmp    80105822 <trap+0x42>
...
80105975:	e9 a3 fe ff ff       	jmp    8010581d <trap+0x3d>
...
80105980:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105984:	8b 7b 38             	mov    0x38(%ebx),%edi
80105987:	e8 44 cd ff ff       	call   801026d0 <cpunum>
8010598c:	57                   	push   %edi
8010598d:	56                   	push   %esi
8010598e:	50                   	push   %eax
8010598f:	68 44 77 10 80       	push   $0x80107744
80105994:	e8 c7 ac ff ff       	call   80100660 <cprintf>
            cpunum(), tf->cs, tf->eip);
    lapiceoi();
80105999:	e8 d2 cd ff ff       	call   80102770 <lapiceoi>
    break;
8010599e:	83 c4 10             	add    $0x10,%esp
801059a1:	e9 7c fe ff ff       	jmp    80105822 <trap+0x42>
...
801059a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801059b0:	e8 6b c6 ff ff       	call   80102020 <ideintr>
    lapiceoi();
801059b5:	e8 b6 cd ff ff       	call   80102770 <lapiceoi>
    break;
801059ba:	e9 63 fe ff ff       	jmp    80105822 <trap+0x42>
801059bf:	90                   	nop
void
trap(struct trapframe *tf)
{
...
801059c5:	e8 76 e2 ff ff       	call   80103c40 <exit>
801059ca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059d0:	83 c4 10             	add    $0x10,%esp
801059d3:	e9 29 ff ff ff       	jmp    80105901 <trap+0x121>
801059d8:	90                   	nop
...
801059e8:	e8 83 e8 ff ff       	call   80104270 <acquire>
      ticks++;
      wakeup(&ticks);
801059ed:	c7 04 24 20 56 11 80 	movl   $0x80115620,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
      ticks++;
801059f4:	83 05 20 56 11 80 01 	addl   $0x1,0x80115620
      wakeup(&ticks);
801059fb:	e8 70 e5 ff ff       	call   80103f70 <wakeup>
      release(&tickslock);
80105a00:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
80105a07:	e8 44 ea ff ff       	call   80104450 <release>
80105a0c:	83 c4 10             	add    $0x10,%esp
80105a0f:	e9 09 fe ff ff       	jmp    8010581d <trap+0x3d>
...
80105a1a:	e8 b1 cc ff ff       	call   801026d0 <cpunum>
...
80105a35:	68 3f 77 10 80       	push   $0x8010773f
...
80105b3c:	bb 60 78 10 80       	mov    $0x80107860,%ebx
...
80105bc7:	6a 00                	push   $0x0
  jmp alltraps
80105bc9:	e9 10 fb ff ff       	jmp    801056de <alltraps>
...
80105bd0:	6a 01                	push   $0x1
  jmp alltraps
80105bd2:	e9 07 fb ff ff       	jmp    801056de <alltraps>
...
80105bd9:	6a 02                	push   $0x2
  jmp alltraps
80105bdb:	e9 fe fa ff ff       	jmp    801056de <alltraps>
...
80105be2:	6a 03                	push   $0x3
  jmp alltraps
80105be4:	e9 f5 fa ff ff       	jmp    801056de <alltraps>
...
80105beb:	6a 04                	push   $0x4
  jmp alltraps
80105bed:	e9 ec fa ff ff       	jmp    801056de <alltraps>
...
80105bf4:	6a 05                	push   $0x5
  jmp alltraps
80105bf6:	e9 e3 fa ff ff       	jmp    801056de <alltraps>
...
80105bfd:	6a 06                	push   $0x6
  jmp alltraps
80105bff:	e9 da fa ff ff       	jmp    801056de <alltraps>
...
80105c06:	6a 07                	push   $0x7
  jmp alltraps
80105c08:	e9 d1 fa ff ff       	jmp    801056de <alltraps>
...
80105c0d:	6a 08                	push   $0x8
  jmp alltraps
80105c0f:	e9 ca fa ff ff       	jmp    801056de <alltraps>
...
80105c16:	6a 09                	push   $0x9
  jmp alltraps
80105c18:	e9 c1 fa ff ff       	jmp    801056de <alltraps>
...
80105c1d:	6a 0a                	push   $0xa
  jmp alltraps
80105c1f:	e9 ba fa ff ff       	jmp    801056de <alltraps>
...
80105c24:	6a 0b                	push   $0xb
  jmp alltraps
80105c26:	e9 b3 fa ff ff       	jmp    801056de <alltraps>
...
80105c2b:	6a 0c                	push   $0xc
  jmp alltraps
80105c2d:	e9 ac fa ff ff       	jmp    801056de <alltraps>
...
80105c32:	6a 0d                	push   $0xd
  jmp alltraps
80105c34:	e9 a5 fa ff ff       	jmp    801056de <alltraps>
...
80105c39:	6a 0e                	push   $0xe
  jmp alltraps
80105c3b:	e9 9e fa ff ff       	jmp    801056de <alltraps>
...
80105c42:	6a 0f                	push   $0xf
  jmp alltraps
80105c44:	e9 95 fa ff ff       	jmp    801056de <alltraps>
...
80105c4b:	6a 10                	push   $0x10
  jmp alltraps
80105c4d:	e9 8c fa ff ff       	jmp    801056de <alltraps>
...
80105c52:	6a 11                	push   $0x11
  jmp alltraps
80105c54:	e9 85 fa ff ff       	jmp    801056de <alltraps>
...
80105c5b:	6a 12                	push   $0x12
  jmp alltraps
80105c5d:	e9 7c fa ff ff       	jmp    801056de <alltraps>
...
80105c64:	6a 13                	push   $0x13
  jmp alltraps
80105c66:	e9 73 fa ff ff       	jmp    801056de <alltraps>
...
80105c6d:	6a 14                	push   $0x14
  jmp alltraps
80105c6f:	e9 6a fa ff ff       	jmp    801056de <alltraps>
...
80105c76:	6a 15                	push   $0x15
  jmp alltraps
80105c78:	e9 61 fa ff ff       	jmp    801056de <alltraps>
...
80105c7f:	6a 16                	push   $0x16
  jmp alltraps
80105c81:	e9 58 fa ff ff       	jmp    801056de <alltraps>
...
80105c88:	6a 17                	push   $0x17
  jmp alltraps
80105c8a:	e9 4f fa ff ff       	jmp    801056de <alltraps>
...
80105c91:	6a 18                	push   $0x18
  jmp alltraps
80105c93:	e9 46 fa ff ff       	jmp    801056de <alltraps>
...
80105c9a:	6a 19                	push   $0x19
  jmp alltraps
80105c9c:	e9 3d fa ff ff       	jmp    801056de <alltraps>
...
80105ca3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ca5:	e9 34 fa ff ff       	jmp    801056de <alltraps>
...
80105cac:	6a 1b                	push   $0x1b
  jmp alltraps
80105cae:	e9 2b fa ff ff       	jmp    801056de <alltraps>
...
80105cb5:	6a 1c                	push   $0x1c
  jmp alltraps
80105cb7:	e9 22 fa ff ff       	jmp    801056de <alltraps>
...
80105cbe:	6a 1d                	push   $0x1d
  jmp alltraps
80105cc0:	e9 19 fa ff ff       	jmp    801056de <alltraps>
...
80105cc7:	6a 1e                	push   $0x1e
  jmp alltraps
80105cc9:	e9 10 fa ff ff       	jmp    801056de <alltraps>
...
80105cd0:	6a 1f                	push   $0x1f
  jmp alltraps
80105cd2:	e9 07 fa ff ff       	jmp    801056de <alltraps>
...
80105cd9:	6a 20                	push   $0x20
  jmp alltraps
80105cdb:	e9 fe f9 ff ff       	jmp    801056de <alltraps>
...
80105ce2:	6a 21                	push   $0x21
  jmp alltraps
80105ce4:	e9 f5 f9 ff ff       	jmp    801056de <alltraps>
...
80105ceb:	6a 22                	push   $0x22
  jmp alltraps
80105ced:	e9 ec f9 ff ff       	jmp    801056de <alltraps>
...
80105cf4:	6a 23                	push   $0x23
  jmp alltraps
80105cf6:	e9 e3 f9 ff ff       	jmp    801056de <alltraps>
...
80105cfd:	6a 24                	push   $0x24
  jmp alltraps
80105cff:	e9 da f9 ff ff       	jmp    801056de <alltraps>
...
80105d06:	6a 25                	push   $0x25
  jmp alltraps
80105d08:	e9 d1 f9 ff ff       	jmp    801056de <alltraps>
...
80105d0f:	6a 26                	push   $0x26
  jmp alltraps
80105d11:	e9 c8 f9 ff ff       	jmp    801056de <alltraps>
...
80105d18:	6a 27                	push   $0x27
  jmp alltraps
80105d1a:	e9 bf f9 ff ff       	jmp    801056de <alltraps>
...
80105d21:	6a 28                	push   $0x28
  jmp alltraps
80105d23:	e9 b6 f9 ff ff       	jmp    801056de <alltraps>
...
80105d2a:	6a 29                	push   $0x29
  jmp alltraps
80105d2c:	e9 ad f9 ff ff       	jmp    801056de <alltraps>
...
80105d33:	6a 2a                	push   $0x2a
  jmp alltraps
80105d35:	e9 a4 f9 ff ff       	jmp    801056de <alltraps>
...
80105d3c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d3e:	e9 9b f9 ff ff       	jmp    801056de <alltraps>
...
80105d45:	6a 2c                	push   $0x2c
  jmp alltraps
80105d47:	e9 92 f9 ff ff       	jmp    801056de <alltraps>
...
80105d4e:	6a 2d                	push   $0x2d
  jmp alltraps
80105d50:	e9 89 f9 ff ff       	jmp    801056de <alltraps>
...
80105d57:	6a 2e                	push   $0x2e
  jmp alltraps
80105d59:	e9 80 f9 ff ff       	jmp    801056de <alltraps>
...
80105d60:	6a 2f                	push   $0x2f
  jmp alltraps
80105d62:	e9 77 f9 ff ff       	jmp    801056de <alltraps>
...
80105d69:	6a 30                	push   $0x30
  jmp alltraps
80105d6b:	e9 6e f9 ff ff       	jmp    801056de <alltraps>
...
80105d72:	6a 31                	push   $0x31
  jmp alltraps
80105d74:	e9 65 f9 ff ff       	jmp    801056de <alltraps>
...
80105d7b:	6a 32                	push   $0x32
  jmp alltraps
80105d7d:	e9 5c f9 ff ff       	jmp    801056de <alltraps>
...
80105d84:	6a 33                	push   $0x33
  jmp alltraps
80105d86:	e9 53 f9 ff ff       	jmp    801056de <alltraps>
...
80105d8d:	6a 34                	push   $0x34
  jmp alltraps
80105d8f:	e9 4a f9 ff ff       	jmp    801056de <alltraps>
...
80105d96:	6a 35                	push   $0x35
  jmp alltraps
80105d98:	e9 41 f9 ff ff       	jmp    801056de <alltraps>
...
80105d9f:	6a 36                	push   $0x36
  jmp alltraps
80105da1:	e9 38 f9 ff ff       	jmp    801056de <alltraps>
...
80105da8:	6a 37                	push   $0x37
  jmp alltraps
80105daa:	e9 2f f9 ff ff       	jmp    801056de <alltraps>
...
80105db1:	6a 38                	push   $0x38
  jmp alltraps
80105db3:	e9 26 f9 ff ff       	jmp    801056de <alltraps>
...
80105dba:	6a 39                	push   $0x39
  jmp alltraps
80105dbc:	e9 1d f9 ff ff       	jmp    801056de <alltraps>
...
80105dc3:	6a 3a                	push   $0x3a
  jmp alltraps
80105dc5:	e9 14 f9 ff ff       	jmp    801056de <alltraps>
...
80105dcc:	6a 3b                	push   $0x3b
  jmp alltraps
80105dce:	e9 0b f9 ff ff       	jmp    801056de <alltraps>
...
80105dd5:	6a 3c                	push   $0x3c
  jmp alltraps
80105dd7:	e9 02 f9 ff ff       	jmp    801056de <alltraps>
...
80105dde:	6a 3d                	push   $0x3d
  jmp alltraps
80105de0:	e9 f9 f8 ff ff       	jmp    801056de <alltraps>
...
80105de7:	6a 3e                	push   $0x3e
  jmp alltraps
80105de9:	e9 f0 f8 ff ff       	jmp    801056de <alltraps>
...
80105df0:	6a 3f                	push   $0x3f
  jmp alltraps
80105df2:	e9 e7 f8 ff ff       	jmp    801056de <alltraps>
...
80105df9:	6a 40                	push   $0x40
  jmp alltraps
80105dfb:	e9 de f8 ff ff       	jmp    801056de <alltraps>
...
80105e02:	6a 41                	push   $0x41
  jmp alltraps
80105e04:	e9 d5 f8 ff ff       	jmp    801056de <alltraps>
...
80105e0b:	6a 42                	push   $0x42
  jmp alltraps
80105e0d:	e9 cc f8 ff ff       	jmp    801056de <alltraps>
...
80105e14:	6a 43                	push   $0x43
  jmp alltraps
80105e16:	e9 c3 f8 ff ff       	jmp    801056de <alltraps>
...
80105e1d:	6a 44                	push   $0x44
  jmp alltraps
80105e1f:	e9 ba f8 ff ff       	jmp    801056de <alltraps>
...
80105e26:	6a 45                	push   $0x45
  jmp alltraps
80105e28:	e9 b1 f8 ff ff       	jmp    801056de <alltraps>
...
80105e2f:	6a 46                	push   $0x46
  jmp alltraps
80105e31:	e9 a8 f8 ff ff       	jmp    801056de <alltraps>
...
80105e38:	6a 47                	push   $0x47
  jmp alltraps
80105e3a:	e9 9f f8 ff ff       	jmp    801056de <alltraps>
...
80105e41:	6a 48                	push   $0x48
  jmp alltraps
80105e43:	e9 96 f8 ff ff       	jmp    801056de <alltraps>
...
80105e4a:	6a 49                	push   $0x49
  jmp alltraps
80105e4c:	e9 8d f8 ff ff       	jmp    801056de <alltraps>
...
80105e53:	6a 4a                	push   $0x4a
  jmp alltraps
80105e55:	e9 84 f8 ff ff       	jmp    801056de <alltraps>
...
80105e5c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e5e:	e9 7b f8 ff ff       	jmp    801056de <alltraps>
...
80105e65:	6a 4c                	push   $0x4c
  jmp alltraps
80105e67:	e9 72 f8 ff ff       	jmp    801056de <alltraps>
...
80105e6e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e70:	e9 69 f8 ff ff       	jmp    801056de <alltraps>
...
80105e77:	6a 4e                	push   $0x4e
  jmp alltraps
80105e79:	e9 60 f8 ff ff       	jmp    801056de <alltraps>
...
80105e80:	6a 4f                	push   $0x4f
  jmp alltraps
80105e82:	e9 57 f8 ff ff       	jmp    801056de <alltraps>
...
80105e89:	6a 50                	push   $0x50
  jmp alltraps
80105e8b:	e9 4e f8 ff ff       	jmp    801056de <alltraps>
...
80105e92:	6a 51                	push   $0x51
  jmp alltraps
80105e94:	e9 45 f8 ff ff       	jmp    801056de <alltraps>
...
80105e9b:	6a 52                	push   $0x52
  jmp alltraps
80105e9d:	e9 3c f8 ff ff       	jmp    801056de <alltraps>
...
80105ea4:	6a 53                	push   $0x53
  jmp alltraps
80105ea6:	e9 33 f8 ff ff       	jmp    801056de <alltraps>
...
80105ead:	6a 54                	push   $0x54
  jmp alltraps
80105eaf:	e9 2a f8 ff ff       	jmp    801056de <alltraps>
...
80105eb6:	6a 55                	push   $0x55
  jmp alltraps
80105eb8:	e9 21 f8 ff ff       	jmp    801056de <alltraps>
...
80105ebf:	6a 56                	push   $0x56
  jmp alltraps
80105ec1:	e9 18 f8 ff ff       	jmp    801056de <alltraps>
...
80105ec8:	6a 57                	push   $0x57
  jmp alltraps
80105eca:	e9 0f f8 ff ff       	jmp    801056de <alltraps>
...
80105ed1:	6a 58                	push   $0x58
  jmp alltraps
80105ed3:	e9 06 f8 ff ff       	jmp    801056de <alltraps>
...
80105eda:	6a 59                	push   $0x59
  jmp alltraps
80105edc:	e9 fd f7 ff ff       	jmp    801056de <alltraps>
...
80105ee3:	6a 5a                	push   $0x5a
  jmp alltraps
80105ee5:	e9 f4 f7 ff ff       	jmp    801056de <alltraps>
...
80105eec:	6a 5b                	push   $0x5b
  jmp alltraps
80105eee:	e9 eb f7 ff ff       	jmp    801056de <alltraps>
...
80105ef5:	6a 5c                	push   $0x5c
  jmp alltraps
80105ef7:	e9 e2 f7 ff ff       	jmp    801056de <alltraps>
...
80105efe:	6a 5d                	push   $0x5d
  jmp alltraps
80105f00:	e9 d9 f7 ff ff       	jmp    801056de <alltraps>
...
80105f07:	6a 5e                	push   $0x5e
  jmp alltraps
80105f09:	e9 d0 f7 ff ff       	jmp    801056de <alltraps>
...
80105f10:	6a 5f                	push   $0x5f
  jmp alltraps
80105f12:	e9 c7 f7 ff ff       	jmp    801056de <alltraps>
...
80105f19:	6a 60                	push   $0x60
  jmp alltraps
80105f1b:	e9 be f7 ff ff       	jmp    801056de <alltraps>
...
80105f22:	6a 61                	push   $0x61
  jmp alltraps
80105f24:	e9 b5 f7 ff ff       	jmp    801056de <alltraps>
...
80105f2b:	6a 62                	push   $0x62
  jmp alltraps
80105f2d:	e9 ac f7 ff ff       	jmp    801056de <alltraps>
...
80105f34:	6a 63                	push   $0x63
  jmp alltraps
80105f36:	e9 a3 f7 ff ff       	jmp    801056de <alltraps>
...
80105f3d:	6a 64                	push   $0x64
  jmp alltraps
80105f3f:	e9 9a f7 ff ff       	jmp    801056de <alltraps>
...
80105f46:	6a 65                	push   $0x65
  jmp alltraps
80105f48:	e9 91 f7 ff ff       	jmp    801056de <alltraps>
...
80105f4f:	6a 66                	push   $0x66
  jmp alltraps
80105f51:	e9 88 f7 ff ff       	jmp    801056de <alltraps>
...
80105f58:	6a 67                	push   $0x67
  jmp alltraps
80105f5a:	e9 7f f7 ff ff       	jmp    801056de <alltraps>
...
80105f61:	6a 68                	push   $0x68
  jmp alltraps
80105f63:	e9 76 f7 ff ff       	jmp    801056de <alltraps>
...
80105f6a:	6a 69                	push   $0x69
  jmp alltraps
80105f6c:	e9 6d f7 ff ff       	jmp    801056de <alltraps>
...
80105f73:	6a 6a                	push   $0x6a
  jmp alltraps
80105f75:	e9 64 f7 ff ff       	jmp    801056de <alltraps>
...
80105f7c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f7e:	e9 5b f7 ff ff       	jmp    801056de <alltraps>
...
80105f85:	6a 6c                	push   $0x6c
  jmp alltraps
80105f87:	e9 52 f7 ff ff       	jmp    801056de <alltraps>
...
80105f8e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f90:	e9 49 f7 ff ff       	jmp    801056de <alltraps>
...
80105f97:	6a 6e                	push   $0x6e
  jmp alltraps
80105f99:	e9 40 f7 ff ff       	jmp    801056de <alltraps>
...
80105fa0:	6a 6f                	push   $0x6f
  jmp alltraps
80105fa2:	e9 37 f7 ff ff       	jmp    801056de <alltraps>
...
80105fa9:	6a 70                	push   $0x70
  jmp alltraps
80105fab:	e9 2e f7 ff ff       	jmp    801056de <alltraps>
...
80105fb2:	6a 71                	push   $0x71
  jmp alltraps
80105fb4:	e9 25 f7 ff ff       	jmp    801056de <alltraps>
...
80105fbb:	6a 72                	push   $0x72
  jmp alltraps
80105fbd:	e9 1c f7 ff ff       	jmp    801056de <alltraps>
...
80105fc4:	6a 73                	push   $0x73
  jmp alltraps
80105fc6:	e9 13 f7 ff ff       	jmp    801056de <alltraps>
...
80105fcd:	6a 74                	push   $0x74
  jmp alltraps
80105fcf:	e9 0a f7 ff ff       	jmp    801056de <alltraps>
...
80105fd6:	6a 75                	push   $0x75
  jmp alltraps
80105fd8:	e9 01 f7 ff ff       	jmp    801056de <alltraps>
...
80105fdf:	6a 76                	push   $0x76
  jmp alltraps
80105fe1:	e9 f8 f6 ff ff       	jmp    801056de <alltraps>
...
80105fe8:	6a 77                	push   $0x77
  jmp alltraps
80105fea:	e9 ef f6 ff ff       	jmp    801056de <alltraps>
...
80105ff1:	6a 78                	push   $0x78
  jmp alltraps
80105ff3:	e9 e6 f6 ff ff       	jmp    801056de <alltraps>
...
80105ffa:	6a 79                	push   $0x79
  jmp alltraps
80105ffc:	e9 dd f6 ff ff       	jmp    801056de <alltraps>
...
80106003:	6a 7a                	push   $0x7a
  jmp alltraps
80106005:	e9 d4 f6 ff ff       	jmp    801056de <alltraps>
...
8010600c:	6a 7b                	push   $0x7b
  jmp alltraps
8010600e:	e9 cb f6 ff ff       	jmp    801056de <alltraps>
...
80106015:	6a 7c                	push   $0x7c
  jmp alltraps
80106017:	e9 c2 f6 ff ff       	jmp    801056de <alltraps>
...
8010601e:	6a 7d                	push   $0x7d
  jmp alltraps
80106020:	e9 b9 f6 ff ff       	jmp    801056de <alltraps>
...
80106027:	6a 7e                	push   $0x7e
  jmp alltraps
80106029:	e9 b0 f6 ff ff       	jmp    801056de <alltraps>
...
80106030:	6a 7f                	push   $0x7f
  jmp alltraps
80106032:	e9 a7 f6 ff ff       	jmp    801056de <alltraps>
...
80106039:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010603e:	e9 9b f6 ff ff       	jmp    801056de <alltraps>
...
80106045:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010604a:	e9 8f f6 ff ff       	jmp    801056de <alltraps>
...
80106051:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106056:	e9 83 f6 ff ff       	jmp    801056de <alltraps>
...
8010605d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106062:	e9 77 f6 ff ff       	jmp    801056de <alltraps>
...
80106069:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010606e:	e9 6b f6 ff ff       	jmp    801056de <alltraps>
...
80106075:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010607a:	e9 5f f6 ff ff       	jmp    801056de <alltraps>
...
80106081:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106086:	e9 53 f6 ff ff       	jmp    801056de <alltraps>
...
8010608d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106092:	e9 47 f6 ff ff       	jmp    801056de <alltraps>
...
80106099:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010609e:	e9 3b f6 ff ff       	jmp    801056de <alltraps>
...
801060a5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801060aa:	e9 2f f6 ff ff       	jmp    801056de <alltraps>
...
801060b1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801060b6:	e9 23 f6 ff ff       	jmp    801056de <alltraps>
...
801060bd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060c2:	e9 17 f6 ff ff       	jmp    801056de <alltraps>
...
801060c9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801060ce:	e9 0b f6 ff ff       	jmp    801056de <alltraps>
...
801060d5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801060da:	e9 ff f5 ff ff       	jmp    801056de <alltraps>
...
801060e1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801060e6:	e9 f3 f5 ff ff       	jmp    801056de <alltraps>
...
801060ed:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801060f2:	e9 e7 f5 ff ff       	jmp    801056de <alltraps>
...
801060f9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060fe:	e9 db f5 ff ff       	jmp    801056de <alltraps>
...
80106105:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010610a:	e9 cf f5 ff ff       	jmp    801056de <alltraps>
...
80106111:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106116:	e9 c3 f5 ff ff       	jmp    801056de <alltraps>
...
8010611d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106122:	e9 b7 f5 ff ff       	jmp    801056de <alltraps>
...
80106129:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010612e:	e9 ab f5 ff ff       	jmp    801056de <alltraps>
...
80106135:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010613a:	e9 9f f5 ff ff       	jmp    801056de <alltraps>
...
80106141:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106146:	e9 93 f5 ff ff       	jmp    801056de <alltraps>
...
8010614d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106152:	e9 87 f5 ff ff       	jmp    801056de <alltraps>
...
80106159:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010615e:	e9 7b f5 ff ff       	jmp    801056de <alltraps>
...
80106165:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010616a:	e9 6f f5 ff ff       	jmp    801056de <alltraps>
...
80106171:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106176:	e9 63 f5 ff ff       	jmp    801056de <alltraps>
...
8010617d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106182:	e9 57 f5 ff ff       	jmp    801056de <alltraps>
...
80106189:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010618e:	e9 4b f5 ff ff       	jmp    801056de <alltraps>
...
80106195:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010619a:	e9 3f f5 ff ff       	jmp    801056de <alltraps>
...
801061a1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801061a6:	e9 33 f5 ff ff       	jmp    801056de <alltraps>
...
801061ad:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801061b2:	e9 27 f5 ff ff       	jmp    801056de <alltraps>
...
801061b9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801061be:	e9 1b f5 ff ff       	jmp    801056de <alltraps>
...
801061c5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801061ca:	e9 0f f5 ff ff       	jmp    801056de <alltraps>
...
801061d1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801061d6:	e9 03 f5 ff ff       	jmp    801056de <alltraps>
...
801061dd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801061e2:	e9 f7 f4 ff ff       	jmp    801056de <alltraps>
...
801061e9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801061ee:	e9 eb f4 ff ff       	jmp    801056de <alltraps>
...
801061f5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801061fa:	e9 df f4 ff ff       	jmp    801056de <alltraps>
...
80106201:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106206:	e9 d3 f4 ff ff       	jmp    801056de <alltraps>
...
8010620d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106212:	e9 c7 f4 ff ff       	jmp    801056de <alltraps>
...
80106219:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010621e:	e9 bb f4 ff ff       	jmp    801056de <alltraps>
...
80106225:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010622a:	e9 af f4 ff ff       	jmp    801056de <alltraps>
...
80106231:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106236:	e9 a3 f4 ff ff       	jmp    801056de <alltraps>
...
8010623d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106242:	e9 97 f4 ff ff       	jmp    801056de <alltraps>
...
80106249:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010624e:	e9 8b f4 ff ff       	jmp    801056de <alltraps>
...
80106255:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010625a:	e9 7f f4 ff ff       	jmp    801056de <alltraps>
...
80106261:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106266:	e9 73 f4 ff ff       	jmp    801056de <alltraps>
...
8010626d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106272:	e9 67 f4 ff ff       	jmp    801056de <alltraps>
...
80106279:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010627e:	e9 5b f4 ff ff       	jmp    801056de <alltraps>
...
80106285:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010628a:	e9 4f f4 ff ff       	jmp    801056de <alltraps>
...
80106291:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106296:	e9 43 f4 ff ff       	jmp    801056de <alltraps>
...
8010629d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801062a2:	e9 37 f4 ff ff       	jmp    801056de <alltraps>
...
801062a9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801062ae:	e9 2b f4 ff ff       	jmp    801056de <alltraps>
...
801062b5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801062ba:	e9 1f f4 ff ff       	jmp    801056de <alltraps>
...
801062c1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801062c6:	e9 13 f4 ff ff       	jmp    801056de <alltraps>
...
801062cd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801062d2:	e9 07 f4 ff ff       	jmp    801056de <alltraps>
...
801062d9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801062de:	e9 fb f3 ff ff       	jmp    801056de <alltraps>
...
801062e5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801062ea:	e9 ef f3 ff ff       	jmp    801056de <alltraps>
...
801062f1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801062f6:	e9 e3 f3 ff ff       	jmp    801056de <alltraps>
...
801062fd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106302:	e9 d7 f3 ff ff       	jmp    801056de <alltraps>
...
80106309:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010630e:	e9 cb f3 ff ff       	jmp    801056de <alltraps>
...
80106315:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010631a:	e9 bf f3 ff ff       	jmp    801056de <alltraps>
...
80106321:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106326:	e9 b3 f3 ff ff       	jmp    801056de <alltraps>
...
8010632d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106332:	e9 a7 f3 ff ff       	jmp    801056de <alltraps>
...
80106339:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010633e:	e9 9b f3 ff ff       	jmp    801056de <alltraps>
...
80106345:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010634a:	e9 8f f3 ff ff       	jmp    801056de <alltraps>
...
80106351:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106356:	e9 83 f3 ff ff       	jmp    801056de <alltraps>
...
8010635d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106362:	e9 77 f3 ff ff       	jmp    801056de <alltraps>
...
80106369:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010636e:	e9 6b f3 ff ff       	jmp    801056de <alltraps>
...
80106375:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010637a:	e9 5f f3 ff ff       	jmp    801056de <alltraps>
...
80106381:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106386:	e9 53 f3 ff ff       	jmp    801056de <alltraps>
...
8010638d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106392:	e9 47 f3 ff ff       	jmp    801056de <alltraps>
...
80106399:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010639e:	e9 3b f3 ff ff       	jmp    801056de <alltraps>
...
801063a5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801063aa:	e9 2f f3 ff ff       	jmp    801056de <alltraps>
...
801063b1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801063b6:	e9 23 f3 ff ff       	jmp    801056de <alltraps>
...
801063bd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801063c2:	e9 17 f3 ff ff       	jmp    801056de <alltraps>
...
801063c9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801063ce:	e9 0b f3 ff ff       	jmp    801056de <alltraps>
...
801063d5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801063da:	e9 ff f2 ff ff       	jmp    801056de <alltraps>
...
801063e1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801063e6:	e9 f3 f2 ff ff       	jmp    801056de <alltraps>
...
801063ed:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801063f2:	e9 e7 f2 ff ff       	jmp    801056de <alltraps>
...
801063f9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801063fe:	e9 db f2 ff ff       	jmp    801056de <alltraps>
...
80106405:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010640a:	e9 cf f2 ff ff       	jmp    801056de <alltraps>
...
80106411:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106416:	e9 c3 f2 ff ff       	jmp    801056de <alltraps>
...
8010641d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106422:	e9 b7 f2 ff ff       	jmp    801056de <alltraps>
...
80106429:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010642e:	e9 ab f2 ff ff       	jmp    801056de <alltraps>
...
80106435:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010643a:	e9 9f f2 ff ff       	jmp    801056de <alltraps>
...
80106441:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106446:	e9 93 f2 ff ff       	jmp    801056de <alltraps>
...
8010644d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106452:	e9 87 f2 ff ff       	jmp    801056de <alltraps>
...
80106459:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010645e:	e9 7b f2 ff ff       	jmp    801056de <alltraps>
...
80106465:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010646a:	e9 6f f2 ff ff       	jmp    801056de <alltraps>
...
80106471:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106476:	e9 63 f2 ff ff       	jmp    801056de <alltraps>
...
8010647d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106482:	e9 57 f2 ff ff       	jmp    801056de <alltraps>
...
80106489:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010648e:	e9 4b f2 ff ff       	jmp    801056de <alltraps>
...
80106495:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010649a:	e9 3f f2 ff ff       	jmp    801056de <alltraps>
...
801064a1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801064a6:	e9 33 f2 ff ff       	jmp    801056de <alltraps>
...
801064ad:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801064b2:	e9 27 f2 ff ff       	jmp    801056de <alltraps>
...
801064b9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801064be:	e9 1b f2 ff ff       	jmp    801056de <alltraps>
...
801064c5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801064ca:	e9 0f f2 ff ff       	jmp    801056de <alltraps>
...
801064d1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801064d6:	e9 03 f2 ff ff       	jmp    801056de <alltraps>
...
801064dd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801064e2:	e9 f7 f1 ff ff       	jmp    801056de <alltraps>
...
801064e9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801064ee:	e9 eb f1 ff ff       	jmp    801056de <alltraps>
...
801064f5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801064fa:	e9 df f1 ff ff       	jmp    801056de <alltraps>
...
80106501:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106506:	e9 d3 f1 ff ff       	jmp    801056de <alltraps>
...
8010650d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106512:	e9 c7 f1 ff ff       	jmp    801056de <alltraps>
...
80106519:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010651e:	e9 bb f1 ff ff       	jmp    801056de <alltraps>
...
80106525:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010652a:	e9 af f1 ff ff       	jmp    801056de <alltraps>
...
80106531:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106536:	e9 a3 f1 ff ff       	jmp    801056de <alltraps>
...
8010653d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106542:	e9 97 f1 ff ff       	jmp    801056de <alltraps>
...
80106549:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010654e:	e9 8b f1 ff ff       	jmp    801056de <alltraps>
...
80106555:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010655a:	e9 7f f1 ff ff       	jmp    801056de <alltraps>
...
80106561:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106566:	e9 73 f1 ff ff       	jmp    801056de <alltraps>
...
8010656d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106572:	e9 67 f1 ff ff       	jmp    801056de <alltraps>
...
80106579:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010657e:	e9 5b f1 ff ff       	jmp    801056de <alltraps>
...
80106585:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010658a:	e9 4f f1 ff ff       	jmp    801056de <alltraps>
...
80106591:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106596:	e9 43 f1 ff ff       	jmp    801056de <alltraps>
...
8010659d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801065a2:	e9 37 f1 ff ff       	jmp    801056de <alltraps>
...
801065a9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801065ae:	e9 2b f1 ff ff       	jmp    801056de <alltraps>
...
801065b5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801065ba:	e9 1f f1 ff ff       	jmp    801056de <alltraps>
...
801065c1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801065c6:	e9 13 f1 ff ff       	jmp    801056de <alltraps>
...
801065cd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801065d2:	e9 07 f1 ff ff       	jmp    801056de <alltraps>
...
801065d9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801065de:	e9 fb f0 ff ff       	jmp    801056de <alltraps>
...
801065e5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801065ea:	e9 ef f0 ff ff       	jmp    801056de <alltraps>
...
801065f1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801065f6:	e9 e3 f0 ff ff       	jmp    801056de <alltraps>
...
801065fd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106602:	e9 d7 f0 ff ff       	jmp    801056de <alltraps>
...
80106609:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010660e:	e9 cb f0 ff ff       	jmp    801056de <alltraps>
...
80106615:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010661a:	e9 bf f0 ff ff       	jmp    801056de <alltraps>
...
80106621:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106626:	e9 b3 f0 ff ff       	jmp    801056de <alltraps>
...
8010662d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106632:	e9 a7 f0 ff ff       	jmp    801056de <alltraps>
...
8010669a:	e8 01 de ff ff       	call   801044a0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106960:	e8 3b db ff ff       	call   801044a0 <memset>
...
801069bb:	a3 24 56 11 80       	mov    %eax,0x80115624
}
...
801069d0 <switchkvm>:
801069d0:	a1 24 56 11 80       	mov    0x80115624,%eax
...
80106a12:	0f 84 8a 00 00 00    	je     80106aa2 <switchuvm+0xb2>
  ...
  pushcli();
80106a18:	e8 b3 d9 ff ff       	call   801043d0 <pushcli>
...
80106a8f:	c9                   	leave  
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106a90:	e9 6b d9 ff ff       	jmp    80104400 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106a98:	68 6e 78 10 80       	push   $0x8010786e
...
80106aa5:	68 99 78 10 80       	push   $0x80107899
...
80106ab2:	68 84 78 10 80       	push   $0x80107884
...
80106aef:	e8 ac d9 ff ff       	call   801044a0 <memset>
...
80106b20:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106b21:	e9 2a da ff ff       	jmp    80104550 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106b29:	68 ad 78 10 80       	push   $0x801078ad
...
80106bdd:	68 c7 78 10 80       	push   $0x801078c7
...
80106bea:	68 68 79 10 80       	push   $0x80107968
...
80106c43:	e8 58 d8 ff ff       	call   801044a0 <memset>
...
80106c81:	68 e5 78 10 80       	push   $0x801078e5
...
80106cb3:	68 fd 78 10 80       	push   $0x801078fd
...
80106d9c:	68 19 79 10 80       	push   $0x80107919
...
80106dcf:	68 2a 79 10 80       	push   $0x8010792a
...
80106e20:	e8 2b d7 ff ff       	call   80104550 <memmove>
...
80106eb2:	68 4e 79 10 80       	push   $0x8010794e
...
80106ebf:	68 34 79 10 80       	push   $0x80107934
...
80106f4f:	e8 fc d5 ff ff       	call   80104550 <memmove>
    len -= n;
    buf += n;
