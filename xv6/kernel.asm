...
8010009b:	80 
8010009c:	e8 cf 41 00 00       	call   80104270 <initsleeplock>
...
8010016c:	e8 3f 41 00 00       	call   801042b0 <acquiresleep>
bread(uint dev, uint blockno)
{
  struct buf *b;
...
801001b0:	e8 9b 41 00 00       	call   80104350 <holdingsleep>
...
801001f1:	e8 5a 41 00 00       	call   80104350 <holdingsleep>
...
801001fd:	e8 0e 41 00 00       	call   80104310 <releasesleep>
...
801002c4:	e8 07 3b 00 00       	call   80103dd0 <sleep>
...
80100312:	e8 19 42 00 00       	call   80104530 <release>
  ilock(ip);
...
801003b3:	e8 e8 3f 00 00       	call   801043a0 <getcallerpcs>
  for(i=0; i<10; i++)
    cprintf(" %p", pcs[i]);
...
801008ad:	a3 c4 ff 10 80       	mov    %eax,0x8010ffc4
          wakeup(&input.r);
801008b2:	e8 d9 37 00 00       	call   80104090 <wakeup>
...
80100b6c:	e8 af 61 00 00       	call   80106d20 <allocuvm>
...
80100b84:	e8 a7 62 00 00       	call   80106e30 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100bad:	e8 fe 62 00 00       	call   80106eb0 <clearpteu>
  sp = sz;
...
80100be9:	e8 b2 3b 00 00       	call   801047a0 <strlen>
...
80100bfa:	e8 a1 3b 00 00       	call   801047a0 <strlen>
...
80100c19:	e8 f2 63 00 00       	call   80107010 <copyout>
...
80100c86:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c8c:	e8 7f 63 00 00       	call   80107010 <copyout>
...
80100cd7:	e8 84 3a 00 00       	call   80104760 <safestrcpy>
...
80100d11:	e8 fa 5d 00 00       	call   80106b10 <switchuvm>
  freevm(oldpgdir);
...
80100d55:	e8 26 36 00 00       	call   80104380 <initlock>
}
80100d5a:	c9                   	leave  
80100d5b:	c3                   	ret    
...
80100d73:	e8 88 36 00 00       	call   80104400 <acquire>
...
80100d99:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100da0:	e8 8b 37 00 00       	call   80104530 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100db7:	e8 74 37 00 00       	call   80104530 <release>
  return 0;
}
...
80100de1:	e8 1a 36 00 00       	call   80104400 <acquire>
  if(f->ref < 1)
...
80100dfa:	e8 31 37 00 00       	call   80104530 <release>
  return f;
}
...
80100e33:	e8 c8 35 00 00       	call   80104400 <acquire>
  if(f->ref < 1)
...
80100e5a:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e5b:	e9 d0 36 00 00       	jmp    80104530 <release>
    return;
  }
  ff = *f;
...
80100e7c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e7f:	e8 ac 36 00 00       	call   80104530 <release>
...
801011e8:	e8 93 33 00 00       	call   80104580 <memset>
  log_write(bp);
...
80101229:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
8010122c:	e8 cf 31 00 00       	call   80104400 <acquire>
...
80101266:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101269:	e8 c2 32 00 00       	call   80104530 <release>
  ip->ref = 1;
  ip->flags = 0;
  release(&icache.lock);
...
801012ae:	e8 7d 32 00 00       	call   80104530 <release>
...
801013c2:	e8 59 32 00 00       	call   80104620 <memmove>
  brelse(bp);
...
801014a0:	80 
801014a1:	e8 ca 2d 00 00       	call   80104270 <initsleeplock>
iinit(int dev)
{
  int i = 0;
...
801016d4:	e8 d7 2b 00 00       	call   801042b0 <acquiresleep>
...
80101795:	e8 b6 2b 00 00       	call   80104350 <holdingsleep>
...
iunlock(struct inode *ip)
{
  ...
  releasesleep(&ip->lock);
801017ae:	e9 5d 2b 00 00       	jmp    80104310 <releasesleep>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
801017d3:	e8 28 2c 00 00       	call   80104400 <acquire>
...
801017f3:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017f4:	e9 37 2d 00 00       	jmp    80104530 <release>
...
80101816:	e8 15 2d 00 00       	call   80104530 <release>
...
8010186e:	e8 8d 2b 00 00       	call   80104400 <acquire>
...
801019e8:	e8 33 2c 00 00       	call   80104620 <memmove>
    brelse(bp);
...
80101ae4:	e8 37 2b 00 00       	call   80104620 <memmove>
    log_write(bp);
...
80101b8b:	e8 10 2b 00 00       	call   801046a0 <strncmp>
}
80101b90:	c9                   	leave  
80101b91:	c3                   	ret    
...
80101c09:	e8 92 2a 00 00       	call   801046a0 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
    if(de.inum == 0)
...
80101c99:	e8 92 28 00 00       	call   80104530 <release>
...
80101cfb:	e8 20 29 00 00       	call   80104620 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d89:	e8 92 28 00 00       	call   80104620 <memmove>
    name[len] = 0;
...
80101e83:	e8 88 28 00 00       	call   80104710 <strncpy>
  de.inum = inum;
...
80101ecc:	e8 8f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ed1:	c7 04 24 ca 77 10 80 	movl   $0x801077ca,(%esp)
...
80101ff5:	e8 86 23 00 00       	call   80104380 <initlock>
  picenable(IRQ_IDE);
...
80102080:	e8 7b 23 00 00       	call   80104400 <acquire>
  if((b = idequeue) == 0){
...
801020ac:	e8 df 1f 00 00       	call   80104090 <wakeup>
...
801020c6:	e8 65 24 00 00       	call   80104530 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
80102120:	e8 2b 22 00 00       	call   80104350 <holdingsleep>
...
80102156:	e8 a5 22 00 00       	call   80104400 <acquire>
...
8010219b:	e8 30 1c 00 00       	call   80103dd0 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
801021b5:	5d                   	pop    %ebp
  ...
  release(&idelock);
801021b6:	e9 75 23 00 00       	jmp    80104530 <release>
...
8010231a:	e8 61 22 00 00       	call   80104580 <memset>
...
80102353:	5d                   	pop    %ebp
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
80102354:	e9 d7 21 00 00       	jmp    80104530 <release>
...
80102367:	e8 94 20 00 00       	call   80104400 <acquire>
...
801023ea:	e8 91 1f 00 00       	call   80104380 <initlock>
...
801024bd:	e8 6e 20 00 00       	call   80104530 <release>
  return (char*)r;
}
...
801024d7:	e8 24 1f 00 00       	call   80104400 <acquire>
...
8010290c:	e8 bf 1c 00 00       	call   801045d0 <memcmp>
...
80102a37:	e8 e4 1b 00 00       	call   80104620 <memmove>
...
80102afa:	e8 81 18 00 00       	call   80104380 <initlock>
  readsb(dev, &sb);
...
80102b8d:	e8 6e 18 00 00       	call   80104400 <acquire>
...
80102ba7:	e8 24 12 00 00       	call   80103dd0 <sleep>
void
begin_op(void)
{
  acquire(&log.lock);
...
80102bd5:	a3 dc 26 11 80       	mov    %eax,0x801126dc
      release(&log.lock);
80102bda:	e8 51 19 00 00       	call   80104530 <release>
      break;
    }
  }
}
...
80102c00:	e8 fb 17 00 00       	call   80104400 <acquire>
  log.outstanding -= 1;
...
80102c38:	00 00 00 
  ...
  release(&log.lock);
80102c3b:	e8 f0 18 00 00       	call   80104530 <release>
}
...
80102c9f:	e8 7c 19 00 00       	call   80104620 <memmove>
...
80102d5d:	e8 9e 16 00 00       	call   80104400 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dae:	5d                   	pop    %ebp
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102daf:	e9 7c 17 00 00       	jmp    80104530 <release>
...
80102e0b:	e8 d0 2a 00 00       	call   801058e0 <idtinit>
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 b5 3c 00 00       	call   80106af0 <switchkvm>
  seginit();
80102e3b:	e8 d0 3a 00 00       	call   80106910 <seginit>
  lapicinit();
...
80102e6e:	e8 5d 3c 00 00       	call   80106ad0 <kvmalloc>
...
80102e80:	e8 8b 3a 00 00       	call   80106910 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpunum());
...
80102eb0:	e8 9b 08 00 00       	call   80103750 <pinit>
  tvinit();        // trap vectors
80102eb5:	e8 86 29 00 00       	call   80105840 <tvinit>
  binit();         // buffer cache
...
80102ef3:	e8 28 17 00 00       	call   80104620 <memmove>
...
80102f9c:	e8 4f fe ff ff       	call   80102df0 <mpmain>
  ...
  if(!ismp)
    timerinit();   // uniprocessor timer
80102fa1:	e8 3a 28 00 00       	call   801057e0 <timerinit>
...
80102fdb:	e8 f0 15 00 00       	call   801045d0 <memcmp>
...
80103096:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103099:	e8 32 15 00 00       	call   801045d0 <memcmp>
...
80103326:	80 
80103327:	e8 54 10 00 00       	call   80104380 <initlock>
  (*f0)->type = FD_PIPE;
...
801033b1:	e8 4a 10 00 00       	call   80104400 <acquire>
  if(writable){
...
801033cd:	e8 be 0c 00 00       	call   80104090 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801033ee:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
801033ef:	e9 3c 11 00 00       	jmp    80104530 <release>
...
8010340b:	e8 80 0c 00 00       	call   80104090 <wakeup>
...
8010341b:	e8 10 11 00 00       	call   80104530 <release>
    kfree((char*)p);
...
8010343f:	e8 bc 0f 00 00       	call   80104400 <acquire>
  for(i = 0; i < n; i++){
...
801034c2:	e8 c9 0b 00 00       	call   80104090 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801034c7:	89 7c 24 04          	mov    %edi,0x4(%esp)
801034cb:	89 1c 24             	mov    %ebx,(%esp)
801034ce:	e8 fd 08 00 00       	call   80103dd0 <sleep>
{
  int i;
...
8010351a:	e8 71 0b 00 00       	call   80104090 <wakeup>
  release(&p->lock);
8010351f:	89 3c 24             	mov    %edi,(%esp)
80103522:	e8 09 10 00 00       	call   80104530 <release>
  return n;
...
80103533:	e8 f8 0f 00 00       	call   80104530 <release>
        return -1;
...
80103562:	e8 99 0e 00 00       	call   80104400 <acquire>
...
8010358f:	e8 3c 08 00 00       	call   80103dd0 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801035bc:	e8 6f 0f 00 00       	call   80104530 <release>
...
80103615:	e8 76 0a 00 00       	call   80104090 <wakeup>
  release(&p->lock);
8010361a:	89 34 24             	mov    %esi,(%esp)
8010361d:	e8 0e 0f 00 00       	call   80104530 <release>
  return i;
}
...
80103643:	e8 b8 0d 00 00       	call   80104400 <acquire>
...
//  p->priority = 20;      // MOD 4/30 : PRISCHED - Set default priority to 20.
  ...
  release(&ptable.lock);
80103684:	e8 a7 0e 00 00       	call   80104530 <release>
...
801036a0:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801036a3:	c7 40 14 2d 58 10 80 	movl   $0x8010582d,0x14(%eax)
...
801036bd:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
801036c0:	e8 bb 0e 00 00       	call   80104580 <memset>
...
801036df:	e8 4c 0e 00 00       	call   80104530 <release>
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
...
8010370d:	e8 1e 0e 00 00       	call   80104530 <release>
...
80103756:	c7 44 24 04 ed 75 10 	movl   $0x801075ed,0x4(%esp)
8010375d:	80 
8010375e:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
80103765:	e8 16 0c 00 00       	call   80104380 <initlock>
}
8010376a:	c9                   	leave  
8010376b:	c3                   	ret    
...
801037a5:	80 
801037a6:	e8 35 34 00 00       	call   80106be0 <inituvm>
  p->sz = PGSIZE;
...
801037c7:	e8 b4 0d 00 00       	call   80104580 <memset>
...
80103822:	00 
80103823:	c7 44 24 04 0d 76 10 	movl   $0x8010760d,0x4(%esp)
8010382a:	80 
8010382b:	89 04 24             	mov    %eax,(%esp)
8010382e:	e8 2d 0f 00 00       	call   80104760 <safestrcpy>
  p->cwd = namei("/");
80103833:	c7 04 24 16 76 10 80 	movl   $0x80107616,(%esp)
...
80103849:	e8 b2 0b 00 00       	call   80104400 <acquire>
...
8010385c:	e8 cf 0c 00 00       	call   80104530 <release>
}
...
80103866:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
80103867:	c7 04 24 f4 75 10 80 	movl   $0x801075f4,(%esp)
...
801038a7:	e8 74 34 00 00       	call   80106d20 <allocuvm>
...
801038c2:	e8 49 32 00 00       	call   80106b10 <switchuvm>
  return 0;
...
8010392a:	e8 b1 35 00 00       	call   80106ee0 <copyuvm>
...
801039bc:	e8 9f 0d 00 00       	call   80104760 <safestrcpy>
...
801039cb:	e8 30 0a 00 00       	call   80104400 <acquire>
...
801039de:	e8 4d 0b 00 00       	call   80104530 <release>
...
80103a23:	53                   	push   %ebx
  ...
  int priority = 65000;
80103a24:	bb e8 fd 00 00       	mov    $0xfde8,%ebx
  }
}
...
80103a33:	e8 c8 09 00 00       	call   80104400 <acquire>
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
...
80103a77:	e8 b4 0a 00 00       	call   80104530 <release>
  return priority;
}
...
80103ab0:	bb d4 2d 11 80       	mov    $0x80112dd4,%ebx
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103ab5:	e8 46 09 00 00       	call   80104400 <acquire>
...
80103acc:	0f 84 8e 00 00 00    	je     80103b60 <scheduler+0xc0>
      if(p->state != RUNNABLE) {
...
80103adf:	e8 4c 0a 00 00       	call   80104530 <release>
...
80103ae4:	e8 37 ff ff ff       	call   80103a20 <getprocpriority>
      ...
      acquire(&ptable.lock);
80103ae9:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
      }
...
80103af0:	89 c6                	mov    %eax,%esi
      ...
      acquire(&ptable.lock);
80103af2:	e8 09 09 00 00       	call   80104400 <acquire>
      
      if (priority < p->priority) {
80103af7:	3b b3 4c 01 00 00    	cmp    0x14c(%ebx),%esi
80103afd:	7d 06                	jge    80103b05 <scheduler+0x65>
        p->priority = priority;
80103aff:	89 b3 4c 01 00 00    	mov    %esi,0x14c(%ebx)
      }
...
80103b05:	89 1c 24             	mov    %ebx,(%esp)
      ...
      // before jumping back to us.
      proc = p;
80103b08:	65 89 1d 04 00 00 00 	mov    %ebx,%gs:0x4
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103b0f:	81 c3 50 01 00 00    	add    $0x150,%ebx
      }
      // Switch to chosen process.  It is the process's job
      // to release ptable.lock and then reacquire it
      // before jumping back to us.
      proc = p;
      switchuvm(p);
80103b15:	e8 f6 2f 00 00       	call   80106b10 <switchuvm>
      p->state = RUNNING;
      swtch(&cpu->scheduler, p->context);
80103b1a:	8b 83 cc fe ff ff    	mov    -0x134(%ebx),%eax
      // Switch to chosen process.  It is the process's job
      // to release ptable.lock and then reacquire it
      // before jumping back to us.
      proc = p;
      switchuvm(p);
      p->state = RUNNING;
80103b20:	c7 83 bc fe ff ff 04 	movl   $0x4,-0x144(%ebx)
80103b27:	00 00 00 
      swtch(&cpu->scheduler, p->context);
80103b2a:	89 44 24 04          	mov    %eax,0x4(%esp)
80103b2e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80103b34:	83 c0 04             	add    $0x4,%eax
80103b37:	89 04 24             	mov    %eax,(%esp)
80103b3a:	e8 7c 0c 00 00       	call   801047bb <swtch>
      switchkvm();
80103b3f:	e8 ac 2f 00 00       	call   80106af0 <switchkvm>
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103b44:	81 fb d4 81 11 80    	cmp    $0x801181d4,%ebx
      swtch(&cpu->scheduler, p->context);
      switchkvm();
      ...
      proc = 0;
80103b4a:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80103b51:	00 00 00 00 
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103b55:	0f 85 77 ff ff ff    	jne    80103ad2 <scheduler+0x32>
80103b5b:	90                   	nop
...
80103b67:	e8 c4 09 00 00       	call   80104530 <release>
  }
80103b6c:	e9 37 ff ff ff       	jmp    80103aa8 <scheduler+0x8>
80103b71:	eb 0d                	jmp    80103b80 <setpriority>
80103b73:	90                   	nop
80103b74:	90                   	nop
80103b75:	90                   	nop
80103b76:	90                   	nop
...
80103b81:	b8 3f 00 00 00       	mov    $0x3f,%eax
80103b86:	89 e5                	mov    %esp,%ebp
80103b88:	8b 55 08             	mov    0x8(%ebp),%edx
80103b8b:	83 fa 3f             	cmp    $0x3f,%edx
80103b8e:	0f 4e c2             	cmovle %edx,%eax
80103b91:	31 d2                	xor    %edx,%edx
80103b93:	85 c0                	test   %eax,%eax
80103b95:	0f 49 d0             	cmovns %eax,%edx
    num = 0;
  } else if (num > 63) {
    num = 63;
  }
...
80103b9e:	89 90 4c 01 00 00    	mov    %edx,0x14c(%eax)
...
80103bbe:	e8 cd 08 00 00       	call   80104490 <holding>
...
80103bfd:	e8 b9 0b 00 00       	call   801047bb <swtch>
  cpu->intena = intena;
...
sched(void)
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103c14:	c7 04 24 18 76 10 80 	movl   $0x80107618,(%esp)
80103c1b:	e8 40 c7 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103c20:	c7 04 24 44 76 10 80 	movl   $0x80107644,(%esp)
80103c27:	e8 34 c7 ff ff       	call   80100360 <panic>
  ...
  if(proc->state == RUNNING)
    panic("sched running");
80103c2c:	c7 04 24 36 76 10 80 	movl   $0x80107636,(%esp)
80103c33:	e8 28 c7 ff ff       	call   80100360 <panic>
  ...
  if(cpu->ncli != 1)
    panic("sched locks");
80103c38:	c7 04 24 2a 76 10 80 	movl   $0x8010762a,(%esp)
...
80103c67:	0f 84 11 01 00 00    	je     80103d7e <exit+0x12e>
...
80103cc9:	e8 32 07 00 00       	call   80104400 <acquire>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ce0:	05 50 01 00 00       	add    $0x150,%eax
80103ce5:	3d d4 81 11 80       	cmp    $0x801181d4,%eax
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cfe:	05 50 01 00 00       	add    $0x150,%eax
80103d03:	3d d4 81 11 80       	cmp    $0x801181d4,%eax
...
80103d17:	90                   	nop
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d18:	81 c2 50 01 00 00    	add    $0x150,%edx
80103d1e:	81 fa d4 81 11 80    	cmp    $0x801181d4,%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d40:	05 50 01 00 00       	add    $0x150,%eax
80103d45:	3d d4 81 11 80       	cmp    $0x801181d4,%eax
...
80103d60:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  proc->state = ZOMBIE;
80103d63:	c7 41 0c 05 00 00 00 	movl   $0x5,0xc(%ecx)
      if(p->state == ZOMBIE)
        wakeup1(initproc);
    }
  }
  ...
  proc->status = status; // MOD - 4/18
80103d6a:	89 41 7c             	mov    %eax,0x7c(%ecx)
  // Jump into the scheduler, never to return.
  proc->state = ZOMBIE;
  sched();
80103d6d:	e8 3e fe ff ff       	call   80103bb0 <sched>
  panic("zombie exit");
80103d72:	c7 04 24 65 76 10 80 	movl   $0x80107665,(%esp)
80103d79:	e8 e2 c5 ff ff       	call   80100360 <panic>
  int fd;
  ...
  if(proc == initproc)
    panic("init exiting");
80103d7e:	c7 04 24 58 76 10 80 	movl   $0x80107658,(%esp)
...
80103d9d:	e8 5e 06 00 00       	call   80104400 <acquire>
  proc->state = RUNNABLE;
...
80103dbb:	e8 70 07 00 00       	call   80104530 <release>
}
80103dc0:	c9                   	leave  
80103dc1:	c3                   	ret    
...
80103dd5:	83 ec 10             	sub    $0x10,%esp
  if(proc == 0)
80103dd8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
sleep(void *chan, struct spinlock *lk)
{
80103dde:	8b 75 08             	mov    0x8(%ebp),%esi
80103de1:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  if(proc == 0)
80103de4:	85 c0                	test   %eax,%eax
80103de6:	0f 84 8b 00 00 00    	je     80103e77 <sleep+0xa7>
    panic("sleep");

  if(lk == 0)
80103dec:	85 db                	test   %ebx,%ebx
80103dee:	74 7b                	je     80103e6b <sleep+0x9b>
...
80103df0:	81 fb a0 2d 11 80    	cmp    $0x80112da0,%ebx
80103df6:	74 50                	je     80103e48 <sleep+0x78>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103df8:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
80103dff:	e8 fc 05 00 00       	call   80104400 <acquire>
    release(lk);
80103e04:	89 1c 24             	mov    %ebx,(%esp)
80103e07:	e8 24 07 00 00       	call   80104530 <release>
  }

  // Go to sleep.
  proc->chan = chan;
80103e0c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103e12:	89 70 20             	mov    %esi,0x20(%eax)
  proc->state = SLEEPING;
80103e15:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80103e1c:	e8 8f fd ff ff       	call   80103bb0 <sched>

  // Tidy up.
  proc->chan = 0;
80103e21:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103e27:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103e2e:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
80103e35:	e8 f6 06 00 00       	call   80104530 <release>
    acquire(lk);
80103e3a:	89 5d 08             	mov    %ebx,0x8(%ebp)
  }
}
...
80103e42:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103e43:	e9 b8 05 00 00       	jmp    80104400 <acquire>
    acquire(&ptable.lock);  //DOC: sleeplock1
    release(lk);
  }
  ...
  // Go to sleep.
  proc->chan = chan;
80103e48:	89 70 20             	mov    %esi,0x20(%eax)
  proc->state = SLEEPING;
80103e4b:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80103e52:	e8 59 fd ff ff       	call   80103bb0 <sched>

  // Tidy up.
  proc->chan = 0;
80103e57:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103e5d:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
...
80103e6b:	c7 04 24 77 76 10 80 	movl   $0x80107677,(%esp)
80103e72:	e8 e9 c4 ff ff       	call   80100360 <panic>
// Reacquires lock when awakened.
void
sleep(void *chan, struct spinlock *lk)
{
  if(proc == 0)
    panic("sleep");
80103e77:	c7 04 24 71 76 10 80 	movl   $0x80107671,(%esp)
80103e7e:	e8 dd c4 ff ff       	call   80100360 <panic>
...
80103e95:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ptable.lock);
80103e98:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
80103e9f:	e8 5c 05 00 00       	call   80104400 <acquire>
80103ea4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
80103eaa:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eac:	bb d4 2d 11 80       	mov    $0x80112dd4,%ebx
80103eb1:	eb 13                	jmp    80103ec6 <wait+0x36>
80103eb3:	90                   	nop
80103eb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103eb8:	81 c3 50 01 00 00    	add    $0x150,%ebx
80103ebe:	81 fb d4 81 11 80    	cmp    $0x801181d4,%ebx
80103ec4:	74 22                	je     80103ee8 <wait+0x58>
      if(p->parent != proc)
80103ec6:	39 43 14             	cmp    %eax,0x14(%ebx)
80103ec9:	75 ed                	jne    80103eb8 <wait+0x28>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80103ecb:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103ecf:	74 34                	je     80103f05 <wait+0x75>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ed1:	81 c3 50 01 00 00    	add    $0x150,%ebx
      if(p->parent != proc)
        continue;
      havekids = 1;
80103ed7:	ba 01 00 00 00       	mov    $0x1,%edx
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103edc:	81 fb d4 81 11 80    	cmp    $0x801181d4,%ebx
...
80103eea:	74 76                	je     80103f62 <wait+0xd2>
80103eec:	8b 50 24             	mov    0x24(%eax),%edx
80103eef:	85 d2                	test   %edx,%edx
80103ef1:	75 6f                	jne    80103f62 <wait+0xd2>
      release(&ptable.lock);
      return -1;
    }
...
80103ef3:	c7 44 24 04 a0 2d 11 	movl   $0x80112da0,0x4(%esp)
80103efa:	80 
80103efb:	89 04 24             	mov    %eax,(%esp)
80103efe:	e8 cd fe ff ff       	call   80103dd0 <sleep>
  }
80103f03:	eb 9f                	jmp    80103ea4 <wait+0x14>
      if(p->state == ZOMBIE){
        // Found one.
        ...
        if (p->status != 0) {
          *status = p->status;
80103f05:	8b 53 7c             	mov    0x7c(%ebx),%edx
...
80103f0b:	89 10                	mov    %edx,(%eax)
        ...
        pid = p->pid;
        kfree(p->kstack);
80103f0d:	8b 43 08             	mov    0x8(%ebx),%eax
        // MOD - 4/29
        if (p->status != 0) {
          *status = p->status;
        } else *status = 0;
        ...
        pid = p->pid;
80103f10:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103f13:	89 04 24             	mov    %eax,(%esp)
80103f16:	e8 c5 e3 ff ff       	call   801022e0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80103f1b:	8b 43 04             	mov    0x4(%ebx),%eax
          *status = p->status;
        } else *status = 0;
        ...
        kfree(p->kstack);
        p->kstack = 0;
80103f1e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f25:	89 04 24             	mov    %eax,(%esp)
80103f28:	e8 03 2f 00 00       	call   80106e30 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
80103f2d:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
...
80103f4d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f54:	e8 d7 05 00 00       	call   80104530 <release>
    }
...
80103f61:	c3                   	ret    
    ...
    if(!havekids || proc->killed){
      release(&ptable.lock);
80103f62:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
80103f69:	e8 c2 05 00 00       	call   80104530 <release>
    }
...
80103f84:	53                   	push   %ebx
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f85:	bb d4 2d 11 80       	mov    $0x80112dd4,%ebx
// prevents the current process from execution until a process with the
// given pid terminates.
...
80103f97:	e8 64 04 00 00       	call   80104400 <acquire>
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
...
80103f9e:	66 90                	xchg   %ax,%ax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa0:	81 fb d4 81 11 80    	cmp    $0x801181d4,%ebx
80103fa6:	72 30                	jb     80103fd8 <waitpid+0x58>
...
80103faa:	74 6c                	je     80104018 <waitpid+0x98>
80103fac:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103fb2:	8b 50 24             	mov    0x24(%eax),%edx
80103fb5:	85 d2                	test   %edx,%edx
80103fb7:	75 5f                	jne    80104018 <waitpid+0x98>
      release(&ptable.lock);
      return -1;
    }
...
80103fb9:	89 04 24             	mov    %eax,(%esp)
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fbc:	bb d4 2d 11 80       	mov    $0x80112dd4,%ebx
      release(&ptable.lock);
      return -1;
    }
    ...
    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
80103fc1:	c7 44 24 04 a0 2d 11 	movl   $0x80112da0,0x4(%esp)
80103fc8:	80 
80103fc9:	e8 02 fe ff ff       	call   80103dd0 <sleep>
  int havekids;   // MOD - 4/29 : now using parameter pid
  ...
  for(;;){
    // Scan through table looking for exited children.
    havekids = 0;
80103fce:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fd0:	81 fb d4 81 11 80    	cmp    $0x801181d4,%ebx
80103fd6:	73 d0                	jae    80103fa8 <waitpid+0x28>
      if(p->pid != pid) {  // MOD - 4/29
80103fd8:	39 73 10             	cmp    %esi,0x10(%ebx)
80103fdb:	74 0b                	je     80103fe8 <waitpid+0x68>
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fdd:	81 c3 50 01 00 00    	add    $0x150,%ebx
80103fe3:	eb bb                	jmp    80103fa0 <waitpid+0x20>
...
80103fec:	74 42                	je     80104030 <waitpid+0xb0>
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
        return pid;
        ...
        p->procswaiting++;
80103fee:	8b 83 48 01 00 00    	mov    0x148(%ebx),%eax
80103ff4:	8d 50 01             	lea    0x1(%eax),%edx
80103ff7:	89 93 48 01 00 00    	mov    %edx,0x148(%ebx)
        p->wpidlist[p->procswaiting] = proc;
80103ffd:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104004:	89 94 83 84 00 00 00 	mov    %edx,0x84(%ebx,%eax,4)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
      if(p->pid != pid) {  // MOD - 4/29
        continue;
      }
      ...
      havekids = 1;
8010400b:	b8 01 00 00 00       	mov    $0x1,%eax
80104010:	eb cb                	jmp    80103fdd <waitpid+0x5d>
80104012:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(!havekids || proc->killed){
      release(&ptable.lock);
80104018:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
8010401f:	e8 0c 05 00 00       	call   80104530 <release>
    }
...
8010402f:	c3                   	ret    
      if(p->state == ZOMBIE){
        ...
        if (p->status != 0) {
          *status = p->status;
80104030:	8b 53 7c             	mov    0x7c(%ebx),%edx
...
80104036:	89 10                	mov    %edx,(%eax)
        ...
        pid = p->pid;
        kfree(p->kstack);
80104038:	8b 43 08             	mov    0x8(%ebx),%eax
        // MOD - 4/29
        if (p->status != 0) {
          *status = p->status;
        } else *status = 0;
        ...
        pid = p->pid;
8010403b:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
8010403e:	89 04 24             	mov    %eax,(%esp)
80104041:	e8 9a e2 ff ff       	call   801022e0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80104046:	8b 43 04             	mov    0x4(%ebx),%eax
          *status = p->status;
        } else *status = 0;
...
80104053:	e8 d8 2d 00 00       	call   80106e30 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
80104058:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
        ...
        freevm(p->pgdir);
        p->pid = 0;
8010405f:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104066:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010406d:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104071:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80104078:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010407f:	e8 ac 04 00 00       	call   80104530 <release>
    }
...
80104097:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010409a:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
801040a1:	e8 5a 03 00 00       	call   80104400 <acquire>
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040a6:	b8 d4 2d 11 80       	mov    $0x80112dd4,%eax
801040ab:	eb 0f                	jmp    801040bc <wakeup+0x2c>
801040ad:	8d 76 00             	lea    0x0(%esi),%esi
801040b0:	05 50 01 00 00       	add    $0x150,%eax
801040b5:	3d d4 81 11 80       	cmp    $0x801181d4,%eax
801040ba:	74 24                	je     801040e0 <wakeup+0x50>
    if(p->state == SLEEPING && p->chan == chan)
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040ce:	05 50 01 00 00       	add    $0x150,%eax
801040d3:	3d d4 81 11 80       	cmp    $0x801181d4,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
801040e0:	c7 45 08 a0 2d 11 80 	movl   $0x80112da0,0x8(%ebp)
}
801040e7:	83 c4 14             	add    $0x14,%esp
801040ea:	5b                   	pop    %ebx
801040eb:	5d                   	pop    %ebp
void
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
801040ec:	e9 3f 04 00 00       	jmp    80104530 <release>
801040f1:	eb 0d                	jmp    80104100 <kill>
801040f3:	90                   	nop
801040f4:	90                   	nop
801040f5:	90                   	nop
801040f6:	90                   	nop
...
80104107:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010410a:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
80104111:	e8 ea 02 00 00       	call   80104400 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104116:	b8 d4 2d 11 80       	mov    $0x80112dd4,%eax
8010411b:	eb 0f                	jmp    8010412c <kill+0x2c>
8010411d:	8d 76 00             	lea    0x0(%esi),%esi
80104120:	05 50 01 00 00       	add    $0x150,%eax
80104125:	3d d4 81 11 80       	cmp    $0x801181d4,%eax
...
80104145:	e8 e6 03 00 00       	call   80104530 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104161:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&ptable.lock);
80104168:	c7 04 24 a0 2d 11 80 	movl   $0x80112da0,(%esp)
8010416f:	e8 bc 03 00 00       	call   80104530 <release>
  return -1;
}
80104174:	83 c4 14             	add    $0x14,%esp
      release(&ptable.lock);
      return 0;
    }
  }
...
80104186:	bb 40 2e 11 80       	mov    $0x80112e40,%ebx
8010418b:	83 ec 4c             	sub    $0x4c,%esp
8010418e:	8d 75 e8             	lea    -0x18(%ebp),%esi
80104191:	eb 23                	jmp    801041b6 <procdump+0x36>
80104193:	90                   	nop
80104194:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80104198:	c7 04 24 c6 75 10 80 	movl   $0x801075c6,(%esp)
8010419f:	e8 ac c4 ff ff       	call   80100650 <cprintf>
801041a4:	81 c3 50 01 00 00    	add    $0x150,%ebx
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041aa:	81 fb 40 82 11 80    	cmp    $0x80118240,%ebx
801041b0:	0f 84 8a 00 00 00    	je     80104240 <procdump+0xc0>
    if(p->state == UNUSED)
801041b6:	8b 43 a0             	mov    -0x60(%ebx),%eax
801041b9:	85 c0                	test   %eax,%eax
801041bb:	74 e7                	je     801041a4 <procdump+0x24>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801041bd:	83 f8 05             	cmp    $0x5,%eax
      state = states[p->state];
    else
      state = "???";
801041c0:	ba 88 76 10 80       	mov    $0x80107688,%edx
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801041c5:	77 11                	ja     801041d8 <procdump+0x58>
801041c7:	8b 14 85 c8 76 10 80 	mov    -0x7fef8938(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801041ce:	b8 88 76 10 80       	mov    $0x80107688,%eax
801041d3:	85 d2                	test   %edx,%edx
801041d5:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801041d8:	8b 43 a4             	mov    -0x5c(%ebx),%eax
801041db:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801041df:	89 54 24 08          	mov    %edx,0x8(%esp)
801041e3:	c7 04 24 8c 76 10 80 	movl   $0x8010768c,(%esp)
801041ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801041ee:	e8 5d c4 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
801041f3:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
801041f7:	75 9f                	jne    80104198 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801041f9:	8d 45 c0             	lea    -0x40(%ebp),%eax
801041fc:	89 44 24 04          	mov    %eax,0x4(%esp)
80104200:	8b 43 b0             	mov    -0x50(%ebx),%eax
...
8010420f:	e8 8c 01 00 00       	call   801043a0 <getcallerpcs>
...
80104229:	c7 04 24 e9 70 10 80 	movl   $0x801070e9,(%esp)
...
80104253:	83 ec 18             	sub    $0x18,%esp
  cprintf("hello!\n");
80104256:	c7 04 24 95 76 10 80 	movl   $0x80107695,(%esp)
8010425d:	e8 ee c3 ff ff       	call   80100650 <cprintf>
}
80104262:	c9                   	leave  
80104263:	c3                   	ret    
...
8010427a:	c7 44 24 04 e0 76 10 	movl   $0x801076e0,0x4(%esp)
80104281:	80 
80104282:	8d 43 04             	lea    0x4(%ebx),%eax
80104285:	89 04 24             	mov    %eax,(%esp)
80104288:	e8 f3 00 00 00       	call   80104380 <initlock>
  lk->name = name;
8010428d:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
80104290:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80104296:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
...
initsleeplock(struct sleeplock *lk, char *name)
{
  initlock(&lk->lk, "sleep lock");
  lk->name = name;
8010429d:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
  lk->pid = 0;
}
801042a0:	83 c4 14             	add    $0x14,%esp
801042a3:	5b                   	pop    %ebx
801042a4:	5d                   	pop    %ebp
801042a5:	c3                   	ret    
...
801042c1:	e8 3a 01 00 00       	call   80104400 <acquire>
  while (lk->locked) {
801042c6:	8b 13                	mov    (%ebx),%edx
801042c8:	85 d2                	test   %edx,%edx
801042ca:	74 16                	je     801042e2 <acquiresleep+0x32>
801042cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
801042d0:	89 74 24 04          	mov    %esi,0x4(%esp)
801042d4:	89 1c 24             	mov    %ebx,(%esp)
801042d7:	e8 f4 fa ff ff       	call   80103dd0 <sleep>
...
801042e0:	75 ee                	jne    801042d0 <acquiresleep+0x20>
    sleep(lk, &lk->lk);
  }
  lk->locked = 1;
801042e2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = proc->pid;
...
801042fc:	5d                   	pop    %ebp
  ...
  lk->pid = proc->pid;
  release(&lk->lk);
801042fd:	e9 2e 02 00 00       	jmp    80104530 <release>
...
8010431e:	89 34 24             	mov    %esi,(%esp)
80104321:	e8 da 00 00 00       	call   80104400 <acquire>
  lk->locked = 0;
80104326:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
8010432c:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80104333:	89 1c 24             	mov    %ebx,(%esp)
80104336:	e8 55 fd ff ff       	call   80104090 <wakeup>
  release(&lk->lk);
8010433b:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80104343:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
80104344:	e9 e7 01 00 00       	jmp    80104530 <release>
...
8010435e:	89 34 24             	mov    %esi,(%esp)
80104361:	e8 9a 00 00 00       	call   80104400 <acquire>
  r = lk->locked;
80104366:	8b 1b                	mov    (%ebx),%ebx
  release(&lk->lk);
80104368:	89 34 24             	mov    %esi,(%esp)
8010436b:	e8 c0 01 00 00       	call   80104530 <release>
  return r;
}
...
80104408:	fa                   	cli    
{
  ...
  cli();
  if(cpu->ncli == 0)
80104409:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010440f:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104415:	85 d2                	test   %edx,%edx
80104417:	75 0c                	jne    80104425 <acquire+0x25>
    cpu->intena = eflags & FL_IF;
80104419:	81 e1 00 02 00 00    	and    $0x200,%ecx
8010441f:	89 88 b0 00 00 00    	mov    %ecx,0xb0(%eax)
  cpu->ncli += 1;
80104425:	83 c2 01             	add    $0x1,%edx
80104428:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
// other CPUs to waste time spinning to acquire it.
void
acquire(struct spinlock *lk)
{
...
80104431:	8b 0a                	mov    (%edx),%ecx
80104433:	85 c9                	test   %ecx,%ecx
80104435:	74 05                	je     8010443c <acquire+0x3c>
80104437:	3b 42 08             	cmp    0x8(%edx),%eax
8010443a:	74 3e                	je     8010447a <acquire+0x7a>
xchg(volatile uint *addr, uint newval)
{
  uint result;
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
8010443c:	b9 01 00 00 00       	mov    $0x1,%ecx
80104441:	eb 08                	jmp    8010444b <acquire+0x4b>
80104443:	90                   	nop
...
80104452:	75 f4                	jne    80104448 <acquire+0x48>
    ;
...
80104463:	83 c0 0c             	add    $0xc,%eax
  ...
  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104466:	89 50 fc             	mov    %edx,-0x4(%eax)
  getcallerpcs(&lk, lk->pcs);
80104469:	89 44 24 04          	mov    %eax,0x4(%esp)
8010446d:	8d 45 08             	lea    0x8(%ebp),%eax
80104470:	89 04 24             	mov    %eax,(%esp)
80104473:	e8 28 ff ff ff       	call   801043a0 <getcallerpcs>
}
80104478:	c9                   	leave  
80104479:	c3                   	ret    
void
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
8010447a:	c7 04 24 eb 76 10 80 	movl   $0x801076eb,(%esp)
80104481:	e8 da be ff ff       	call   80100360 <panic>
...
8010449c:	74 0f                	je     801044ad <holding+0x1d>
8010449e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801044a4:	39 42 08             	cmp    %eax,0x8(%edx)
801044a7:	0f 94 c0             	sete   %al
...
801044eb:	75 34                	jne    80104521 <popcli+0x41>
    panic("popcli - interruptible");
  if(--cpu->ncli < 0)
801044ed:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801044f3:	8b 88 ac 00 00 00    	mov    0xac(%eax),%ecx
801044f9:	8d 51 ff             	lea    -0x1(%ecx),%edx
801044fc:	85 d2                	test   %edx,%edx
801044fe:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104504:	78 0f                	js     80104515 <popcli+0x35>
    panic("popcli");
  if(cpu->ncli == 0 && cpu->intena)
80104506:	75 0b                	jne    80104513 <popcli+0x33>
80104508:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010450e:	85 c0                	test   %eax,%eax
80104510:	74 01                	je     80104513 <popcli+0x33>
}
...
popcli(void)
{
  ...
  if(--cpu->ncli < 0)
    panic("popcli");
80104515:	c7 04 24 0a 77 10 80 	movl   $0x8010770a,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104521:	c7 04 24 f3 76 10 80 	movl   $0x801076f3,(%esp)
80104528:	e8 33 be ff ff       	call   80100360 <panic>
...
80104549:	74 0d                	je     80104558 <release+0x28>
// Release the lock.
void
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
8010454b:	c7 04 24 11 77 10 80 	movl   $0x80107711,(%esp)
80104552:	e8 09 be ff ff       	call   80100360 <panic>
80104557:	90                   	nop

  lk->pcs[0] = 0;
80104558:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
8010455f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  // Tell the C compiler and the processor to not move loads or stores
  ...
  __sync_synchronize();
80104566:	f0 83 0c 24 00       	lock orl $0x0,(%esp)

  // Release the lock, equivalent to lk->locked = 0.
  // This code can't use a C assignment, since it might
  // not be atomic. A real OS would use C atomics here.
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010456b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
80104571:	c9                   	leave  
  ...
  popcli();
80104572:	e9 69 ff ff ff       	jmp    801044e0 <popcli>
...
{
  return memmove(dst, src, n);
80104694:	e9 87 ff ff ff       	jmp    80104620 <memmove>
...
801047da:	8b 45 08             	mov    0x8(%ebp),%eax
  if(addr >= proc->sz || addr+4 > proc->sz)
801047dd:	8b 12                	mov    (%edx),%edx
801047df:	39 c2                	cmp    %eax,%edx
801047e1:	76 15                	jbe    801047f8 <fetchint+0x28>
801047e3:	8d 48 04             	lea    0x4(%eax),%ecx
801047e6:	39 ca                	cmp    %ecx,%edx
801047e8:	72 0e                	jb     801047f8 <fetchint+0x28>
    return -1;
  *ip = *(int*)(addr);
...
80104809:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ...
  if(addr >= proc->sz)
8010480c:	39 08                	cmp    %ecx,(%eax)
8010480e:	76 2c                	jbe    8010483c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104810:	8b 55 0c             	mov    0xc(%ebp),%edx
80104813:	89 c8                	mov    %ecx,%eax
80104815:	89 0a                	mov    %ecx,(%edx)
  ep = (char*)proc->sz;
80104817:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010481e:	8b 12                	mov    (%edx),%edx
  for(s = *pp; s < ep; s++)
80104820:	39 d1                	cmp    %edx,%ecx
80104822:	73 18                	jae    8010483c <fetchstr+0x3c>
    if(*s == 0)
80104824:	80 39 00             	cmpb   $0x0,(%ecx)
80104827:	75 0c                	jne    80104835 <fetchstr+0x35>
80104829:	eb 1d                	jmp    80104848 <fetchstr+0x48>
8010482b:	90                   	nop
8010482c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104830:	80 38 00             	cmpb   $0x0,(%eax)
80104833:	74 13                	je     80104848 <fetchstr+0x48>
...
8010485d:	8b 42 18             	mov    0x18(%edx),%eax
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
80104862:	8b 40 44             	mov    0x44(%eax),%eax
80104865:	8d 04 88             	lea    (%eax,%ecx,4),%eax
80104868:	8d 48 04             	lea    0x4(%eax),%ecx
...
{
  if(addr >= proc->sz || addr+4 > proc->sz)
8010486b:	39 d1                	cmp    %edx,%ecx
8010486d:	73 19                	jae    80104888 <argint+0x38>
8010486f:	8d 48 08             	lea    0x8(%eax),%ecx
80104872:	39 ca                	cmp    %ecx,%edx
80104874:	72 12                	jb     80104888 <argint+0x38>
    return -1;
  *ip = *(int*)(addr);
80104876:	8b 50 04             	mov    0x4(%eax),%edx
80104879:	8b 45 0c             	mov    0xc(%ebp),%eax
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
8010489a:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010489d:	8b 50 18             	mov    0x18(%eax),%edx
801048a0:	8b 52 44             	mov    0x44(%edx),%edx
801048a3:	8d 0c 8a             	lea    (%edx,%ecx,4),%ecx
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
801048ad:	8d 59 04             	lea    0x4(%ecx),%ebx
...
{
  if(addr >= proc->sz || addr+4 > proc->sz)
801048b0:	39 d3                	cmp    %edx,%ebx
801048b2:	73 25                	jae    801048d9 <argptr+0x49>
801048b4:	8d 59 08             	lea    0x8(%ecx),%ebx
801048b7:	39 da                	cmp    %ebx,%edx
801048b9:	72 1e                	jb     801048d9 <argptr+0x49>
{
  int i;
...
801048bb:	8b 5d 10             	mov    0x10(%ebp),%ebx
int
fetchint(uint addr, int *ip)
{
  if(addr >= proc->sz || addr+4 > proc->sz)
    return -1;
  *ip = *(int*)(addr);
801048be:	8b 49 04             	mov    0x4(%ecx),%ecx
{
  int i;
  ...
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= proc->sz || (uint)i+size > proc->sz)
801048c1:	85 db                	test   %ebx,%ebx
801048c3:	78 14                	js     801048d9 <argptr+0x49>
801048c5:	39 d1                	cmp    %edx,%ecx
801048c7:	73 10                	jae    801048d9 <argptr+0x49>
801048c9:	8b 5d 10             	mov    0x10(%ebp),%ebx
801048cc:	01 cb                	add    %ecx,%ebx
801048ce:	39 d3                	cmp    %edx,%ebx
801048d0:	77 07                	ja     801048d9 <argptr+0x49>
    return -1;
  *pp = (char*)i;
801048d2:	8b 45 0c             	mov    0xc(%ebp),%eax
801048d5:	89 08                	mov    %ecx,(%eax)
  return 0;
...
801048ec:	8b 50 18             	mov    0x18(%eax),%edx
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
801048f1:	8b 52 44             	mov    0x44(%edx),%edx
801048f4:	8d 14 8a             	lea    (%edx,%ecx,4),%edx
801048f7:	8d 4a 04             	lea    0x4(%edx),%ecx
...
{
  if(addr >= proc->sz || addr+4 > proc->sz)
801048fa:	39 c1                	cmp    %eax,%ecx
801048fc:	73 07                	jae    80104905 <argstr+0x25>
801048fe:	8d 4a 08             	lea    0x8(%edx),%ecx
80104901:	39 c8                	cmp    %ecx,%eax
80104903:	73 0b                	jae    80104910 <argstr+0x30>
int
argstr(int n, char **pp)
{
  int addr;
...
fetchint(uint addr, int *ip)
{
  if(addr >= proc->sz || addr+4 > proc->sz)
    return -1;
  *ip = *(int*)(addr);
80104910:	8b 4a 04             	mov    0x4(%edx),%ecx
int
fetchstr(uint addr, char **pp)
{
  char *s, *ep;
  ...
  if(addr >= proc->sz)
80104913:	39 c1                	cmp    %eax,%ecx
80104915:	73 ee                	jae    80104905 <argstr+0x25>
    return -1;
  *pp = (char*)addr;
80104917:	8b 55 0c             	mov    0xc(%ebp),%edx
8010491a:	89 c8                	mov    %ecx,%eax
8010491c:	89 0a                	mov    %ecx,(%edx)
  ep = (char*)proc->sz;
8010491e:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104925:	8b 12                	mov    (%edx),%edx
  for(s = *pp; s < ep; s++)
80104927:	39 d1                	cmp    %edx,%ecx
80104929:	73 da                	jae    80104905 <argstr+0x25>
    if(*s == 0)
8010492b:	80 39 00             	cmpb   $0x0,(%ecx)
8010492e:	75 12                	jne    80104942 <argstr+0x62>
80104930:	eb 1e                	jmp    80104950 <argstr+0x70>
80104932:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104938:	80 38 00             	cmpb   $0x0,(%eax)
8010493b:	90                   	nop
8010493c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104940:	74 0e                	je     80104950 <argstr+0x70>
...
80104945:	39 c2                	cmp    %eax,%edx
80104947:	77 ef                	ja     80104938 <argstr+0x58>
80104949:	eb ba                	jmp    80104905 <argstr+0x25>
8010494b:	90                   	nop
8010494c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(*s == 0)
      return s - *pp;
80104950:	29 c8                	sub    %ecx,%eax
{
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
8010496e:	8b 5a 18             	mov    0x18(%edx),%ebx
80104971:	8b 43 1c             	mov    0x1c(%ebx),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104974:	8d 48 ff             	lea    -0x1(%eax),%ecx
80104977:	83 f9 17             	cmp    $0x17,%ecx
8010497a:	77 1c                	ja     80104998 <syscall+0x38>
8010497c:	8b 0c 85 40 77 10 80 	mov    -0x7fef88c0(,%eax,4),%ecx
80104983:	85 c9                	test   %ecx,%ecx
80104985:	74 11                	je     80104998 <syscall+0x38>
    proc->tf->eax = syscalls[num]();
80104987:	ff d1                	call   *%ecx
80104989:	89 43 1c             	mov    %eax,0x1c(%ebx)
  } else {
...
8010498c:	83 c4 14             	add    $0x14,%esp
8010498f:	5b                   	pop    %ebx
80104990:	5d                   	pop    %ebp
80104991:	c3                   	ret    
80104992:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80104998:	89 44 24 0c          	mov    %eax,0xc(%esp)
            proc->pid, proc->name, num);
8010499c:	8d 42 6c             	lea    0x6c(%edx),%eax
8010499f:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
801049a3:	8b 42 10             	mov    0x10(%edx),%eax
801049a6:	c7 04 24 19 77 10 80 	movl   $0x80107719,(%esp)
801049ad:	89 44 24 04          	mov    %eax,0x4(%esp)
801049b1:	e8 9a bc ff ff       	call   80100650 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801049b6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801049bc:	8b 40 18             	mov    0x18(%eax),%eax
801049bf:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
801049c6:	83 c4 14             	add    $0x14,%esp
801049c9:	5b                   	pop    %ebx
801049ca:	5d                   	pop    %ebp
801049cb:	c3                   	ret    
...
801049d6:	83 ec 4c             	sub    $0x4c,%esp
801049d9:	89 4d c0             	mov    %ecx,-0x40(%ebp)
801049dc:	8b 4d 08             	mov    0x8(%ebp),%ecx
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801049df:	8d 5d da             	lea    -0x26(%ebp),%ebx
801049e2:	89 5c 24 04          	mov    %ebx,0x4(%esp)
...
create(char *path, short type, short major, short minor)
{
801049e9:	89 55 c4             	mov    %edx,-0x3c(%ebp)
801049ec:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801049ef:	e8 0c d5 ff ff       	call   80101f00 <nameiparent>
801049f4:	85 c0                	test   %eax,%eax
801049f6:	89 c7                	mov    %eax,%edi
801049f8:	0f 84 da 00 00 00    	je     80104ad8 <create+0x108>
    return 0;
  ilock(dp);
801049fe:	89 04 24             	mov    %eax,(%esp)
80104a01:	e8 aa cc ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80104a06:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80104a09:	89 44 24 08          	mov    %eax,0x8(%esp)
80104a0d:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104a11:	89 3c 24             	mov    %edi,(%esp)
80104a14:	e8 87 d1 ff ff       	call   80101ba0 <dirlookup>
80104a19:	85 c0                	test   %eax,%eax
80104a1b:	89 c6                	mov    %eax,%esi
80104a1d:	74 41                	je     80104a60 <create+0x90>
    iunlockput(dp);
80104a1f:	89 3c 24             	mov    %edi,(%esp)
80104a22:	e8 c9 ce ff ff       	call   801018f0 <iunlockput>
    ilock(ip);
80104a27:	89 34 24             	mov    %esi,(%esp)
80104a2a:	e8 81 cc ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104a2f:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104a34:	75 12                	jne    80104a48 <create+0x78>
80104a36:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104a3b:	89 f0                	mov    %esi,%eax
80104a3d:	75 09                	jne    80104a48 <create+0x78>
...
80104a3f:	83 c4 4c             	add    $0x4c,%esp
80104a42:	5b                   	pop    %ebx
80104a43:	5e                   	pop    %esi
80104a44:	5f                   	pop    %edi
80104a45:	5d                   	pop    %ebp
...
80104a4b:	e8 a0 ce ff ff       	call   801018f0 <iunlockput>
    panic("create: dirlink");
...
80104a50:	83 c4 4c             	add    $0x4c,%esp
    iunlockput(dp);
    ilock(ip);
    if(type == T_FILE && ip->type == T_FILE)
      return ip;
...
80104a68:	8b 07                	mov    (%edi),%eax
80104a6a:	89 04 24             	mov    %eax,(%esp)
80104a6d:	e8 ae ca ff ff       	call   80101520 <ialloc>
80104a72:	85 c0                	test   %eax,%eax
80104a74:	89 c6                	mov    %eax,%esi
80104a76:	0f 84 bf 00 00 00    	je     80104b3b <create+0x16b>
    panic("create: ialloc");

  ilock(ip);
80104a7c:	89 04 24             	mov    %eax,(%esp)
80104a7f:	e8 2c cc ff ff       	call   801016b0 <ilock>
  ip->major = major;
80104a84:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
80104a88:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
80104a8c:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
80104a90:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104a94:	b8 01 00 00 00       	mov    $0x1,%eax
80104a99:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
80104a9d:	89 34 24             	mov    %esi,(%esp)
80104aa0:	e8 4b cb ff ff       	call   801015f0 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80104aa5:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
80104aaa:	74 34                	je     80104ae0 <create+0x110>
...
80104aac:	8b 46 04             	mov    0x4(%esi),%eax
80104aaf:	89 5c 24 04          	mov    %ebx,0x4(%esp)
...
80104ac1:	78 6c                	js     80104b2f <create+0x15f>
    panic("create: dirlink");

  iunlockput(dp);
80104ac3:	89 3c 24             	mov    %edi,(%esp)
80104ac6:	e8 25 ce ff ff       	call   801018f0 <iunlockput>

  return ip;
}
80104acb:	83 c4 4c             	add    $0x4c,%esp
  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
...
80104ada:	e9 60 ff ff ff       	jmp    80104a3f <create+0x6f>
80104adf:	90                   	nop
  ip->minor = minor;
  ip->nlink = 1;
  iupdate(ip);
  ...
  if(type == T_DIR){  // Create . and .. entries.
    dp->nlink++;  // for ".."
80104ae0:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
80104ae5:	89 3c 24             	mov    %edi,(%esp)
80104ae8:	e8 03 cb ff ff       	call   801015f0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104aed:	8b 46 04             	mov    0x4(%esi),%eax
80104af0:	c7 44 24 04 c0 77 10 	movl   $0x801077c0,0x4(%esp)
80104af7:	80 
80104af8:	89 34 24             	mov    %esi,(%esp)
80104afb:	89 44 24 08          	mov    %eax,0x8(%esp)
80104aff:	e8 fc d2 ff ff       	call   80101e00 <dirlink>
80104b04:	85 c0                	test   %eax,%eax
80104b06:	78 1b                	js     80104b23 <create+0x153>
80104b08:	8b 47 04             	mov    0x4(%edi),%eax
80104b0b:	c7 44 24 04 bf 77 10 	movl   $0x801077bf,0x4(%esp)
80104b12:	80 
...
80104b21:	79 89                	jns    80104aac <create+0xdc>
      panic("create dots");
80104b23:	c7 04 24 b3 77 10 80 	movl   $0x801077b3,(%esp)
80104b2a:	e8 31 b8 ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
80104b2f:	c7 04 24 c2 77 10 80 	movl   $0x801077c2,(%esp)
80104b36:	e8 25 b8 ff ff       	call   80100360 <panic>
    iunlockput(ip);
    return 0;
  }
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
80104b3b:	c7 04 24 a4 77 10 80 	movl   $0x801077a4,(%esp)
80104b42:	e8 19 b8 ff ff       	call   80100360 <panic>
...
80104b57:	89 d3                	mov    %edx,%ebx
80104b59:	83 ec 20             	sub    $0x20,%esp
{
  int fd;
  struct file *f;
...
80104b63:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104b6a:	e8 e1 fc ff ff       	call   80104850 <argint>
80104b6f:	85 c0                	test   %eax,%eax
80104b71:	78 35                	js     80104ba8 <argfd.constprop.0+0x58>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80104b73:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80104b76:	83 f9 0f             	cmp    $0xf,%ecx
80104b79:	77 2d                	ja     80104ba8 <argfd.constprop.0+0x58>
80104b7b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b81:	8b 44 88 28          	mov    0x28(%eax,%ecx,4),%eax
80104b85:	85 c0                	test   %eax,%eax
80104b87:	74 1f                	je     80104ba8 <argfd.constprop.0+0x58>
    return -1;
  if(pfd)
80104b89:	85 f6                	test   %esi,%esi
80104b8b:	74 02                	je     80104b8f <argfd.constprop.0+0x3f>
    *pfd = fd;
80104b8d:	89 0e                	mov    %ecx,(%esi)
  if(pf)
80104b8f:	85 db                	test   %ebx,%ebx
80104b91:	74 0d                	je     80104ba0 <argfd.constprop.0+0x50>
    *pf = f;
80104b93:	89 03                	mov    %eax,(%ebx)
  return 0;
80104b95:	31 c0                	xor    %eax,%eax
}
80104b97:	83 c4 20             	add    $0x20,%esp
80104b9a:	5b                   	pop    %ebx
80104b9b:	5e                   	pop    %esi
80104b9c:	5d                   	pop    %ebp
80104b9d:	c3                   	ret    
...
80104ba2:	eb f3                	jmp    80104b97 <argfd.constprop.0+0x47>
...
80104bad:	eb e8                	jmp    80104b97 <argfd.constprop.0+0x47>
80104baf:	90                   	nop
...
80104bb6:	83 ec 24             	sub    $0x24,%esp
  struct file *f;
  int fd;

  if(argfd(0, 0, &f) < 0)
80104bb9:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104bbc:	e8 8f ff ff ff       	call   80104b50 <argfd.constprop.0>
80104bc1:	85 c0                	test   %eax,%eax
80104bc3:	78 1b                	js     80104be0 <sys_dup+0x30>
    return -1;
  if((fd=fdalloc(f)) < 0)
...
80104bca:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    if(proc->ofile[fd] == 0){
80104bd0:	8b 4c 98 28          	mov    0x28(%eax,%ebx,4),%ecx
80104bd4:	85 c9                	test   %ecx,%ecx
...
80104be0:	83 c4 24             	add    $0x24,%esp
{
  struct file *f;
  int fd;
...
80104bec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80104bf0:	89 54 98 28          	mov    %edx,0x28(%eax,%ebx,4)
  ...
  if((fd=fdalloc(f)) < 0)
    return -1;
  filedup(f);
80104bf4:	89 14 24             	mov    %edx,(%esp)
80104bf7:	e8 d4 c1 ff ff       	call   80100dd0 <filedup>
  return fd;
}
80104bfc:	83 c4 24             	add    $0x24,%esp
  if(argfd(0, 0, &f) < 0)
    return -1;
  if((fd=fdalloc(f)) < 0)
    return -1;
...
80104c32:	e8 19 fc ff ff       	call   80104850 <argint>
...
80104c6d:	e8 be c2 ff ff       	call   80100f30 <fileread>
}
80104c72:	c9                   	leave  
80104c73:	c3                   	ret    
...
80104ca2:	e8 a9 fb ff ff       	call   80104850 <argint>
...
80104cdd:	e8 ee c2 ff ff       	call   80100fd0 <filewrite>
}
80104ce2:	c9                   	leave  
80104ce3:	c3                   	ret    
...
80104d03:	78 23                	js     80104d28 <sys_close+0x38>
    return -1;
  proc->ofile[fd] = 0;
80104d05:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104d08:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d0e:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104d15:	00 
  fileclose(f);
80104d16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d19:	89 04 24             	mov    %eax,(%esp)
80104d1c:	e8 ff c0 ff ff       	call   80100e20 <fileclose>
  return 0;
...
80104d3b:	e8 10 fe ff ff       	call   80104b50 <argfd.constprop.0>
...
80104d70:	e8 6b c1 ff ff       	call   80100ee0 <filestat>
}
80104d75:	c9                   	leave  
80104d76:	c3                   	ret    
80104d77:	90                   	nop
...
80104d97:	e8 44 fb ff ff       	call   801048e0 <argstr>
...
80104dff:	e8 7c c9 ff ff       	call   80101780 <iunlock>
...
80104e35:	e8 c6 cf ff ff       	call   80101e00 <dirlink>
...
80104e41:	e8 aa ca ff ff       	call   801018f0 <iunlockput>
  iput(ip);
80104e46:	89 1c 24             	mov    %ebx,(%esp)
80104e49:	e8 72 c9 ff ff       	call   801017c0 <iput>

  end_op();
80104e4e:	e8 9d dd ff ff       	call   80102bf0 <end_op>
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
  end_op();
...
80104e63:	e8 88 ca ff ff       	call   801018f0 <iunlockput>
  end_op();
...
80104e80:	e8 6b ca ff ff       	call   801018f0 <iunlockput>
  end_op();
80104e85:	e8 66 dd ff ff       	call   80102bf0 <end_op>
  return -1;
}
...
80104eb7:	e8 24 fa ff ff       	call   801048e0 <argstr>
80104ebc:	85 c0                	test   %eax,%eax
80104ebe:	0f 88 76 01 00 00    	js     8010503a <sys_unlink+0x19a>
    return -1;

  begin_op();
80104ec4:	e8 b7 dc ff ff       	call   80102b80 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104ed6:	e8 25 d0 ff ff       	call   80101f00 <nameiparent>
...
80104ef1:	c7 44 24 04 c0 77 10 	movl   $0x801077c0,0x4(%esp)
80104ef8:	80 
80104ef9:	89 1c 24             	mov    %ebx,(%esp)
80104efc:	e8 6f cc ff ff       	call   80101b70 <namecmp>
80104f01:	85 c0                	test   %eax,%eax
80104f03:	0f 84 21 01 00 00    	je     8010502a <sys_unlink+0x18a>
80104f09:	c7 44 24 04 bf 77 10 	movl   $0x801077bf,0x4(%esp)
80104f10:	80 
80104f11:	89 1c 24             	mov    %ebx,(%esp)
80104f14:	e8 57 cc ff ff       	call   80101b70 <namecmp>
...
80104f2f:	e8 6c cc ff ff       	call   80101ba0 <dirlookup>
...
80104f6e:	e8 0d f6 ff ff       	call   80104580 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104f8c:	e8 af ca ff ff       	call   80101a40 <writei>
...
80104fc0:	e8 2b c9 ff ff       	call   801018f0 <iunlockput>
  ...
  end_op();
80104fc5:	e8 26 dc ff ff       	call   80102bf0 <end_op>
...
80105011:	e8 2a c9 ff ff       	call   80101940 <readi>
...
80105025:	e8 c6 c8 ff ff       	call   801018f0 <iunlockput>
  end_op();
...
80105030:	e8 bb c8 ff ff       	call   801018f0 <iunlockput>
  end_op();
80105035:	e8 b6 db ff ff       	call   80102bf0 <end_op>
  return -1;
}
...
80105058:	e9 48 ff ff ff       	jmp    80104fa5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
8010505d:	c7 04 24 e4 77 10 80 	movl   $0x801077e4,(%esp)
80105064:	e8 f7 b2 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80105069:	c7 04 24 f6 77 10 80 	movl   $0x801077f6,(%esp)
80105070:	e8 eb b2 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80105075:	c7 04 24 d2 77 10 80 	movl   $0x801077d2,(%esp)
...
801050a7:	e8 34 f8 ff ff       	call   801048e0 <argstr>
801050ac:	85 c0                	test   %eax,%eax
801050ae:	0f 88 81 00 00 00    	js     80105135 <sys_open+0xa5>
801050b4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801050b7:	89 44 24 04          	mov    %eax,0x4(%esp)
801050bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801050c2:	e8 89 f7 ff ff       	call   80104850 <argint>
801050c7:	85 c0                	test   %eax,%eax
801050c9:	78 6a                	js     80105135 <sys_open+0xa5>
    return -1;

  begin_op();
801050cb:	e8 b0 da ff ff       	call   80102b80 <begin_op>

  if(omode & O_CREATE){
801050d0:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
801050d4:	75 72                	jne    80105148 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801050dc:	e8 ff cd ff ff       	call   80101ee0 <namei>
801050e1:	85 c0                	test   %eax,%eax
801050e3:	89 c7                	mov    %eax,%edi
801050e5:	74 49                	je     80105130 <sys_open+0xa0>
      end_op();
      return -1;
    }
    ilock(ip);
801050e7:	89 04 24             	mov    %eax,(%esp)
801050ea:	e8 c1 c5 ff ff       	call   801016b0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801050ef:	66 83 7f 50 01       	cmpw   $0x1,0x50(%edi)
801050f4:	0f 84 ae 00 00 00    	je     801051a8 <sys_open+0x118>
      end_op();
      return -1;
    }
  }
...
801050fa:	e8 61 bc ff ff       	call   80100d60 <filealloc>
801050ff:	85 c0                	test   %eax,%eax
80105101:	89 c6                	mov    %eax,%esi
80105103:	74 23                	je     80105128 <sys_open+0x98>
80105105:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010510c:	31 db                	xor    %ebx,%ebx
...
80105116:	74 50                	je     80105168 <sys_open+0xd8>
static int
fdalloc(struct file *f)
{
  int fd;
...
8010511e:	75 f0                	jne    80105110 <sys_open+0x80>
    }
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    if(f)
      fileclose(f);
80105120:	89 34 24             	mov    %esi,(%esp)
80105123:	e8 f8 bc ff ff       	call   80100e20 <fileclose>
    iunlockput(ip);
80105128:	89 3c 24             	mov    %edi,(%esp)
8010512b:	e8 c0 c7 ff ff       	call   801018f0 <iunlockput>
    end_op();
...
80105135:	83 c4 2c             	add    $0x2c,%esp
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    if(f)
      fileclose(f);
    iunlockput(ip);
...
80105148:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010514b:	31 c9                	xor    %ecx,%ecx
8010514d:	ba 02 00 00 00       	mov    $0x2,%edx
80105152:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105159:	e8 72 f8 ff ff       	call   801049d0 <create>
    if(ip == 0){
8010515e:	85 c0                	test   %eax,%eax
  ...
  if(omode & O_CREATE){
    ip = create(path, T_FILE, 0, 0);
80105160:	89 c7                	mov    %eax,%edi
    if(ip == 0){
80105162:	75 96                	jne    801050fa <sys_open+0x6a>
80105164:	eb ca                	jmp    80105130 <sys_open+0xa0>
80105166:	66 90                	xchg   %ax,%ax
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80105168:	89 74 9a 28          	mov    %esi,0x28(%edx,%ebx,4)
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
8010516c:	89 3c 24             	mov    %edi,(%esp)
8010516f:	e8 0c c6 ff ff       	call   80101780 <iunlock>
  end_op();
80105174:	e8 77 da ff ff       	call   80102bf0 <end_op>

  f->type = FD_INODE;
80105179:	c7 06 02 00 00 00    	movl   $0x2,(%esi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
8010517f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  }
  iunlock(ip);
  end_op();
  ...
  f->type = FD_INODE;
  f->ip = ip;
80105182:	89 7e 10             	mov    %edi,0x10(%esi)
  f->off = 0;
80105185:	c7 46 14 00 00 00 00 	movl   $0x0,0x14(%esi)
  f->readable = !(omode & O_WRONLY);
8010518c:	89 d0                	mov    %edx,%eax
8010518e:	83 e0 01             	and    $0x1,%eax
80105191:	83 f0 01             	xor    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105194:	83 e2 03             	and    $0x3,%edx
  end_op();
  ...
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105197:	88 46 08             	mov    %al,0x8(%esi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
  return fd;
8010519a:	89 d8                	mov    %ebx,%eax
  ...
  f->readable = !(omode & O_WRONLY);
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010519c:	0f 95 46 09          	setne  0x9(%esi)
  return fd;
}
801051a0:	83 c4 2c             	add    $0x2c,%esp
801051a3:	5b                   	pop    %ebx
801051a4:	5e                   	pop    %esi
801051a5:	5f                   	pop    %edi
801051a6:	5d                   	pop    %ebp
...
801051ad:	0f 84 47 ff ff ff    	je     801050fa <sys_open+0x6a>
801051b3:	e9 70 ff ff ff       	jmp    80105128 <sys_open+0x98>
801051b8:	90                   	nop
...
801051c3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801051c6:	e8 b5 d9 ff ff       	call   80102b80 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
801051cb:	8d 45 f4             	lea    -0xc(%ebp),%eax
801051ce:	89 44 24 04          	mov    %eax,0x4(%esp)
801051d2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801051d9:	e8 02 f7 ff ff       	call   801048e0 <argstr>
801051de:	85 c0                	test   %eax,%eax
801051e0:	78 2e                	js     80105210 <sys_mkdir+0x50>
801051e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051e5:	31 c9                	xor    %ecx,%ecx
801051e7:	ba 01 00 00 00       	mov    $0x1,%edx
801051ec:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801051f3:	e8 d8 f7 ff ff       	call   801049d0 <create>
801051f8:	85 c0                	test   %eax,%eax
801051fa:	74 14                	je     80105210 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105223:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105226:	e8 55 d9 ff ff       	call   80102b80 <begin_op>
  if((argstr(0, &path)) < 0 ||
8010522b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010522e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105232:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105239:	e8 a2 f6 ff ff       	call   801048e0 <argstr>
8010523e:	85 c0                	test   %eax,%eax
80105240:	78 5e                	js     801052a0 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
80105242:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105245:	89 44 24 04          	mov    %eax,0x4(%esp)
80105249:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105250:	e8 fb f5 ff ff       	call   80104850 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
80105257:	78 47                	js     801052a0 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105259:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010525c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105260:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105267:	e8 e4 f5 ff ff       	call   80104850 <argint>
  char *path;
  int major, minor;
...
8010526e:	78 30                	js     801052a0 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105270:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
  int major, minor;
  ...
  if((argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105274:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
80105279:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
...
80105283:	e8 48 f7 ff ff       	call   801049d0 <create>
80105288:	85 c0                	test   %eax,%eax
8010528a:	74 14                	je     801052a0 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
    return -1;
  }
...
8010528f:	e8 5c c6 ff ff       	call   801018f0 <iunlockput>
  end_op();
80105294:	e8 57 d9 ff ff       	call   80102bf0 <end_op>
  return 0;
...
8010529d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if((argstr(0, &path)) < 0 ||
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
801052a0:	e8 4b d9 ff ff       	call   80102bf0 <end_op>
    return -1;
...
801052b4:	83 ec 24             	sub    $0x24,%esp
  ...
  begin_op();
801052b7:	e8 c4 d8 ff ff       	call   80102b80 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
801052bc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801052bf:	89 44 24 04          	mov    %eax,0x4(%esp)
801052c3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801052ca:	e8 11 f6 ff ff       	call   801048e0 <argstr>
801052cf:	85 c0                	test   %eax,%eax
801052d1:	78 5a                	js     8010532d <sys_chdir+0x7d>
801052d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052d6:	89 04 24             	mov    %eax,(%esp)
801052d9:	e8 02 cc ff ff       	call   80101ee0 <namei>
801052de:	85 c0                	test   %eax,%eax
801052e0:	89 c3                	mov    %eax,%ebx
801052e2:	74 49                	je     8010532d <sys_chdir+0x7d>
    end_op();
    return -1;
  }
  ilock(ip);
801052e4:	89 04 24             	mov    %eax,(%esp)
801052e7:	e8 c4 c3 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
...
801052f1:	89 1c 24             	mov    %ebx,(%esp)
  ...
  ilock(ip);
  if(ip->type != T_DIR){
801052f4:	75 32                	jne    80105328 <sys_chdir+0x78>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
801052f6:	e8 85 c4 ff ff       	call   80101780 <iunlock>
  iput(proc->cwd);
801052fb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105301:	8b 40 68             	mov    0x68(%eax),%eax
80105304:	89 04 24             	mov    %eax,(%esp)
80105307:	e8 b4 c4 ff ff       	call   801017c0 <iput>
  end_op();
8010530c:	e8 df d8 ff ff       	call   80102bf0 <end_op>
  proc->cwd = ip;
80105311:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105317:	89 58 68             	mov    %ebx,0x68(%eax)
  return 0;
}
8010531a:	83 c4 24             	add    $0x24,%esp
  }
  iunlock(ip);
  iput(proc->cwd);
  end_op();
...
80105322:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  if(ip->type != T_DIR){
    iunlockput(ip);
80105328:	e8 c3 c5 ff ff       	call   801018f0 <iunlockput>
    end_op();
8010532d:	e8 be d8 ff ff       	call   80102bf0 <end_op>
  iunlock(ip);
  iput(proc->cwd);
  end_op();
  proc->cwd = ip;
...
80105332:	83 c4 24             	add    $0x24,%esp
  }
  ilock(ip);
  if(ip->type != T_DIR){
    iunlockput(ip);
...
80105346:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
8010534c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
80105352:	89 44 24 04          	mov    %eax,0x4(%esp)
80105356:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010535d:	e8 7e f5 ff ff       	call   801048e0 <argstr>
80105362:	85 c0                	test   %eax,%eax
80105364:	0f 88 84 00 00 00    	js     801053ee <sys_exec+0xae>
8010536a:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105370:	89 44 24 04          	mov    %eax,0x4(%esp)
80105374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010537b:	e8 d0 f4 ff ff       	call   80104850 <argint>
80105380:	85 c0                	test   %eax,%eax
80105382:	78 6a                	js     801053ee <sys_exec+0xae>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105384:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010538a:	31 db                	xor    %ebx,%ebx
  ...
  memset(argv, 0, sizeof(argv));
8010538c:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105393:	00 
80105394:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
8010539a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801053a1:	00 
801053a2:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
801053a8:	89 04 24             	mov    %eax,(%esp)
801053ab:	e8 d0 f1 ff ff       	call   80104580 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801053b0:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801053b6:	89 7c 24 04          	mov    %edi,0x4(%esp)
801053ba:	8d 04 98             	lea    (%eax,%ebx,4),%eax
801053bd:	89 04 24             	mov    %eax,(%esp)
801053c0:	e8 0b f4 ff ff       	call   801047d0 <fetchint>
801053c5:	85 c0                	test   %eax,%eax
801053c7:	78 25                	js     801053ee <sys_exec+0xae>
      return -1;
    if(uarg == 0){
801053c9:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801053cf:	85 c0                	test   %eax,%eax
801053d1:	74 2d                	je     80105400 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
801053d3:	89 74 24 04          	mov    %esi,0x4(%esp)
801053d7:	89 04 24             	mov    %eax,(%esp)
801053da:	e8 21 f4 ff ff       	call   80104800 <fetchstr>
801053df:	85 c0                	test   %eax,%eax
801053e1:	78 0b                	js     801053ee <sys_exec+0xae>
...
801053e6:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
801053e9:	83 fb 20             	cmp    $0x20,%ebx
801053ec:	75 c2                	jne    801053b0 <sys_exec+0x70>
    }
    if(fetchstr(uarg, &argv[i]) < 0)
      return -1;
  }
...
801053ee:	81 c4 ac 00 00 00    	add    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;
...
8010540a:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
      return -1;
    if(uarg == 0){
      argv[i] = 0;
80105410:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105417:	00 00 00 00 
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
      return -1;
...
8010541e:	e8 8d b5 ff ff       	call   801009b0 <exec>
}
80105423:	81 c4 ac 00 00 00    	add    $0xac,%esp
80105429:	5b                   	pop    %ebx
8010542a:	5e                   	pop    %esi
8010542b:	5f                   	pop    %edi
8010542c:	5d                   	pop    %ebp
...
80105439:	8d 45 dc             	lea    -0x24(%ebp),%eax
8010543c:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105443:	00 
80105444:	89 44 24 04          	mov    %eax,0x4(%esp)
80105448:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010544f:	e8 3c f4 ff ff       	call   80104890 <argptr>
80105454:	85 c0                	test   %eax,%eax
80105456:	78 7a                	js     801054d2 <sys_pipe+0xa2>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80105458:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010545b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010545f:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105462:	89 04 24             	mov    %eax,(%esp)
80105465:	e8 46 de ff ff       	call   801032b0 <pipealloc>
8010546a:	85 c0                	test   %eax,%eax
8010546c:	78 64                	js     801054d2 <sys_pipe+0xa2>
8010546e:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
static int
fdalloc(struct file *f)
{
  int fd;
...
80105477:	8b 5d e0             	mov    -0x20(%ebp),%ebx
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
8010547a:	8b 54 81 28          	mov    0x28(%ecx,%eax,4),%edx
8010547e:	85 d2                	test   %edx,%edx
80105480:	74 16                	je     80105498 <sys_pipe+0x68>
...
8010548e:	74 2f                	je     801054bf <sys_pipe+0x8f>
    if(proc->ofile[fd] == 0){
80105490:	8b 54 81 28          	mov    0x28(%ecx,%eax,4),%edx
80105494:	85 d2                	test   %edx,%edx
80105496:	75 f0                	jne    80105488 <sys_pipe+0x58>
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
    return -1;
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105498:	8b 7d e4             	mov    -0x1c(%ebp),%edi
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
8010549b:	8d 70 08             	lea    0x8(%eax),%esi
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010549e:	31 d2                	xor    %edx,%edx
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
801054a0:	89 5c b1 08          	mov    %ebx,0x8(%ecx,%esi,4)
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
801054a8:	83 7c 91 28 00       	cmpl   $0x0,0x28(%ecx,%edx,4)
801054ad:	74 31                	je     801054e0 <sys_pipe+0xb0>
static int
fdalloc(struct file *f)
{
  int fd;
...
801054b2:	83 fa 10             	cmp    $0x10,%edx
801054b5:	75 f1                	jne    801054a8 <sys_pipe+0x78>
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      proc->ofile[fd0] = 0;
801054b7:	c7 44 b1 08 00 00 00 	movl   $0x0,0x8(%ecx,%esi,4)
801054be:	00 
    fileclose(rf);
801054bf:	89 1c 24             	mov    %ebx,(%esp)
801054c2:	e8 59 b9 ff ff       	call   80100e20 <fileclose>
    fileclose(wf);
801054c7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801054ca:	89 04 24             	mov    %eax,(%esp)
801054cd:	e8 4e b9 ff ff       	call   80100e20 <fileclose>
    return -1;
  }
  fd[0] = fd0;
  fd[1] = fd1;
...
801054d2:	83 c4 2c             	add    $0x2c,%esp
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      proc->ofile[fd0] = 0;
    fileclose(rf);
...
801054df:	90                   	nop
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
801054e0:	89 7c 91 28          	mov    %edi,0x28(%ecx,%edx,4)
      proc->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
801054e4:	8b 4d dc             	mov    -0x24(%ebp),%ecx
801054e7:	89 01                	mov    %eax,(%ecx)
  fd[1] = fd1;
801054e9:	8b 45 dc             	mov    -0x24(%ebp),%eax
801054ec:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
}
801054ef:	83 c4 2c             	add    $0x2c,%esp
    fileclose(wf);
    return -1;
  }
  fd[0] = fd0;
...
{
  return fork();
80105504:	e9 f7 e3 ff ff       	jmp    80103900 <fork>
...
80105524:	e8 27 f3 ff ff       	call   80104850 <argint>
...
80105533:	e8 18 e7 ff ff       	call   80103c50 <exit>
...
8010557b:	e8 10 e9 ff ff       	call   80103e90 <wait>
}
80105580:	c9                   	leave  
80105581:	c3                   	ret    
...
801055a4:	e8 a7 f2 ff ff       	call   80104850 <argint>
...
801055da:	e8 71 f2 ff ff       	call   80104850 <argint>
...
801055f7:	e8 84 e9 ff ff       	call   80103f80 <waitpid>
}
801055fc:	c9                   	leave  
801055fd:	c3                   	ret    
...
80105624:	e8 27 f2 ff ff       	call   80104850 <argint>
...
80105633:	e8 c8 ea ff ff       	call   80104100 <kill>
}
80105638:	c9                   	leave  
80105639:	c3                   	ret    
...
80105675:	e8 d6 f1 ff ff       	call   80104850 <argint>
...
8010568c:	e8 ef e1 ff ff       	call   80103880 <growproc>
...
801056c5:	e8 86 f1 ff ff       	call   80104850 <argint>
801056ca:	85 c0                	test   %eax,%eax
801056cc:	78 7e                	js     8010574c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
801056ce:	c7 04 24 e0 81 11 80 	movl   $0x801181e0,(%esp)
801056d5:	e8 26 ed ff ff       	call   80104400 <acquire>
  ticks0 = ticks;
...
801056da:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801056dd:	8b 1d 20 8a 11 80    	mov    0x80118a20,%ebx
  while(ticks - ticks0 < n){
...
801056f0:	c7 44 24 04 e0 81 11 	movl   $0x801181e0,0x4(%esp)
801056f7:	80 
801056f8:	c7 04 24 20 8a 11 80 	movl   $0x80118a20,(%esp)
801056ff:	e8 cc e6 ff ff       	call   80103dd0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105704:	a1 20 8a 11 80       	mov    0x80118a20,%eax
...
8010571b:	74 d3                	je     801056f0 <sys_sleep+0x40>
      release(&tickslock);
8010571d:	c7 04 24 e0 81 11 80 	movl   $0x801181e0,(%esp)
80105724:	e8 07 ee ff ff       	call   80104530 <release>
      return -1;
...
80105734:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105738:	c7 04 24 e0 81 11 80 	movl   $0x801181e0,(%esp)
8010573f:	e8 ec ed ff ff       	call   80104530 <release>
  return 0;
}
...
80105764:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105767:	c7 04 24 e0 81 11 80 	movl   $0x801181e0,(%esp)
8010576e:	e8 8d ec ff ff       	call   80104400 <acquire>
  xticks = ticks;
80105773:	8b 1d 20 8a 11 80    	mov    0x80118a20,%ebx
  release(&tickslock);
80105779:	c7 04 24 e0 81 11 80 	movl   $0x801181e0,(%esp)
80105780:	e8 ab ed ff ff       	call   80104530 <release>
  return xticks;
}
...
80105793:	83 ec 08             	sub    $0x8,%esp
  hello();
80105796:	e8 b5 ea ff ff       	call   80104250 <hello>
  return 0;
}
...
801057b4:	e8 97 f0 ff ff       	call   80104850 <argint>
801057b9:	85 c0                	test   %eax,%eax
801057bb:	78 13                	js     801057d0 <sys_setpriority+0x30>
    return -1;
  }
...
801057c3:	e8 b8 e3 ff ff       	call   80103b80 <setpriority>
801057c8:	c9                   	leave  
801057c9:	c3                   	ret    
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801057e1:	ba 43 00 00 00       	mov    $0x43,%edx
801057e6:	89 e5                	mov    %esp,%ebp
801057e8:	b8 34 00 00 00       	mov    $0x34,%eax
801057ed:	83 ec 18             	sub    $0x18,%esp
801057f0:	ee                   	out    %al,(%dx)
801057f1:	b8 9c ff ff ff       	mov    $0xffffff9c,%eax
801057f6:	b2 40                	mov    $0x40,%dl
801057f8:	ee                   	out    %al,(%dx)
801057f9:	b8 2e 00 00 00       	mov    $0x2e,%eax
801057fe:	ee                   	out    %al,(%dx)
...
80105806:	e8 e5 d9 ff ff       	call   801031f0 <picenable>
}
8010580b:	c9                   	leave  
8010580c:	c3                   	ret    
...
8010581a:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
8010581c:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80105820:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80105822:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80105824:	54                   	push   %esp
  call trap
80105825:	e8 e6 00 00 00       	call   80105910 <trap>
  addl $4, %esp
8010582a:	83 c4 04             	add    $0x4,%esp
...
8010582d:	61                   	popa   
  popl %gs
8010582e:	0f a9                	pop    %gs
  popl %fs
80105830:	0f a1                	pop    %fs
  popl %es
80105832:	07                   	pop    %es
  popl %ds
80105833:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105834:	83 c4 08             	add    $0x8,%esp
  iret
80105837:	cf                   	iret   
...
80105848:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
8010584f:	b9 08 00 00 00       	mov    $0x8,%ecx
80105854:	66 89 0c c5 22 82 11 	mov    %cx,-0x7fee7dde(,%eax,8)
8010585b:	80 
8010585c:	c6 04 c5 24 82 11 80 	movb   $0x0,-0x7fee7ddc(,%eax,8)
80105863:	00 
80105864:	c6 04 c5 25 82 11 80 	movb   $0x8e,-0x7fee7ddb(,%eax,8)
8010586b:	8e 
8010586c:	66 89 14 c5 20 82 11 	mov    %dx,-0x7fee7de0(,%eax,8)
80105873:	80 
80105874:	c1 ea 10             	shr    $0x10,%edx
80105877:	66 89 14 c5 26 82 11 	mov    %dx,-0x7fee7dda(,%eax,8)
8010587e:	80 
void
tvinit(void)
{
...
80105891:	83 ec 18             	sub    $0x18,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105894:	a1 0c a1 10 80       	mov    0x8010a10c,%eax

  initlock(&tickslock, "time");
80105899:	c7 44 24 04 05 78 10 	movl   $0x80107805,0x4(%esp)
801058a0:	80 
801058a1:	c7 04 24 e0 81 11 80 	movl   $0x801181e0,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801058a8:	66 89 15 22 84 11 80 	mov    %dx,0x80118422
801058af:	66 a3 20 84 11 80    	mov    %ax,0x80118420
801058b5:	c1 e8 10             	shr    $0x10,%eax
801058b8:	c6 05 24 84 11 80 00 	movb   $0x0,0x80118424
801058bf:	c6 05 25 84 11 80 ef 	movb   $0xef,0x80118425
801058c6:	66 a3 26 84 11 80    	mov    %ax,0x80118426

  initlock(&tickslock, "time");
801058cc:	e8 af ea ff ff       	call   80104380 <initlock>
}
801058d1:	c9                   	leave  
801058d2:	c3                   	ret    
...
801058eb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801058ef:	b8 20 82 11 80       	mov    $0x80118220,%eax
...
80105922:	0f 84 08 01 00 00    	je     80105a30 <trap+0x120>
    if(proc->killed)
      exit(0);
    return;
  }
...
8010592e:	77 60                	ja     80105990 <trap+0x80>
80105930:	ff 24 85 ac 78 10 80 	jmp    *-0x7fef8754(,%eax,4)
80105937:	90                   	nop
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
80105938:	e8 13 ce ff ff       	call   80102750 <cpunum>
8010593d:	85 c0                	test   %eax,%eax
8010593f:	90                   	nop
80105940:	0f 84 ea 01 00 00    	je     80105b30 <trap+0x220>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80105946:	e8 a5 ce ff ff       	call   801027f0 <lapiceoi>
...
80105953:	74 2d                	je     80105982 <trap+0x72>
80105955:	8b 50 24             	mov    0x24(%eax),%edx
80105958:	85 d2                	test   %edx,%edx
8010595a:	0f 85 9c 00 00 00    	jne    801059fc <trap+0xec>
    exit(0);

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80105960:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105964:	0f 84 9e 01 00 00    	je     80105b08 <trap+0x1f8>
    yield();

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
8010596a:	8b 40 24             	mov    0x24(%eax),%eax
8010596d:	85 c0                	test   %eax,%eax
8010596f:	74 11                	je     80105982 <trap+0x72>
80105971:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105975:	83 e0 03             	and    $0x3,%eax
80105978:	66 83 f8 03          	cmp    $0x3,%ax
8010597c:	0f 84 d8 00 00 00    	je     80105a5a <trap+0x14a>
    exit(0);
}
80105982:	83 c4 2c             	add    $0x2c,%esp
80105985:	5b                   	pop    %ebx
80105986:	5e                   	pop    %esi
80105987:	5f                   	pop    %edi
80105988:	5d                   	pop    %ebp
...
8010598a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80105990:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
80105997:	85 c9                	test   %ecx,%ecx
80105999:	0f 84 c1 01 00 00    	je     80105b60 <trap+0x250>
8010599f:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801059a3:	0f 84 b7 01 00 00    	je     80105b60 <trap+0x250>
...
801059ac:	8b 73 38             	mov    0x38(%ebx),%esi
801059af:	e8 9c cd ff ff       	call   80102750 <cpunum>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
801059b4:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059bb:	89 7c 24 1c          	mov    %edi,0x1c(%esp)
801059bf:	89 74 24 18          	mov    %esi,0x18(%esp)
801059c3:	89 44 24 14          	mov    %eax,0x14(%esp)
801059c7:	8b 43 34             	mov    0x34(%ebx),%eax
801059ca:	89 44 24 10          	mov    %eax,0x10(%esp)
801059ce:	8b 43 30             	mov    0x30(%ebx),%eax
801059d1:	89 44 24 0c          	mov    %eax,0xc(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
801059d5:	8d 42 6c             	lea    0x6c(%edx),%eax
801059d8:	89 44 24 08          	mov    %eax,0x8(%esp)
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059dc:	8b 42 10             	mov    0x10(%edx),%eax
801059df:	c7 04 24 68 78 10 80 	movl   $0x80107868,(%esp)
801059e6:	89 44 24 04          	mov    %eax,0x4(%esp)
801059ea:	e8 61 ac ff ff       	call   80100650 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
            rcr2());
    proc->killed = 1;
801059ef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059f5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
  ...
  // until it gets to the regular system call return.)
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
801059fc:	0f b7 53 3c          	movzwl 0x3c(%ebx),%edx
80105a00:	83 e2 03             	and    $0x3,%edx
80105a03:	66 83 fa 03          	cmp    $0x3,%dx
80105a07:	0f 85 53 ff ff ff    	jne    80105960 <trap+0x50>
    exit(0);
80105a0d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a14:	e8 37 e2 ff ff       	call   80103c50 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80105a19:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a1f:	85 c0                	test   %eax,%eax
80105a21:	0f 85 39 ff ff ff    	jne    80105960 <trap+0x50>
80105a27:	e9 56 ff ff ff       	jmp    80105982 <trap+0x72>
...
80105a3b:	0f 85 af 00 00 00    	jne    80105af0 <trap+0x1e0>
      exit(0);
    proc->tf = tf;
80105a41:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105a44:	e8 17 ef ff ff       	call   80104960 <syscall>
    if(proc->killed)
80105a49:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a4f:	8b 58 24             	mov    0x24(%eax),%ebx
80105a52:	85 db                	test   %ebx,%ebx
80105a54:	0f 84 28 ff ff ff    	je     80105982 <trap+0x72>
      exit(0);
80105a5a:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
    yield();
...
80105a61:	83 c4 2c             	add    $0x2c,%esp
80105a64:	5b                   	pop    %ebx
80105a65:	5e                   	pop    %esi
80105a66:	5f                   	pop    %edi
80105a67:	5d                   	pop    %ebp
    ...
    if(proc->killed)
      exit(0);
80105a68:	e9 e3 e1 ff ff       	jmp    80103c50 <exit>
...
80105a7a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105a80:	e9 cc fe ff ff       	jmp    80105951 <trap+0x41>
...
80105a92:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105a98:	e9 b4 fe ff ff       	jmp    80105951 <trap+0x41>
80105a9d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105aa0:	e8 2b 02 00 00       	call   80105cd0 <uartintr>
    lapiceoi();
80105aa5:	e8 46 cd ff ff       	call   801027f0 <lapiceoi>
80105aaa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105ab0:	e9 9c fe ff ff       	jmp    80105951 <trap+0x41>
...
80105ac4:	c7 04 24 10 78 10 80 	movl   $0x80107810,(%esp)
...
80105ae1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    break;
80105ae7:	e9 65 fe ff ff       	jmp    80105951 <trap+0x41>
...
80105af7:	e8 54 e1 ff ff       	call   80103c50 <exit>
80105afc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b02:	e9 3a ff ff ff       	jmp    80105a41 <trap+0x131>
80105b07:	90                   	nop
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
    exit(0);
...
80105b0c:	0f 85 58 fe ff ff    	jne    8010596a <trap+0x5a>
    yield();
80105b12:	e8 79 e2 ff ff       	call   80103d90 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80105b17:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b1d:	85 c0                	test   %eax,%eax
80105b1f:	0f 85 45 fe ff ff    	jne    8010596a <trap+0x5a>
80105b25:	e9 58 fe ff ff       	jmp    80105982 <trap+0x72>
80105b2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
80105b30:	c7 04 24 e0 81 11 80 	movl   $0x801181e0,(%esp)
80105b37:	e8 c4 e8 ff ff       	call   80104400 <acquire>
      ticks++;
      wakeup(&ticks);
80105b3c:	c7 04 24 20 8a 11 80 	movl   $0x80118a20,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
      ticks++;
80105b43:	83 05 20 8a 11 80 01 	addl   $0x1,0x80118a20
      wakeup(&ticks);
80105b4a:	e8 41 e5 ff ff       	call   80104090 <wakeup>
      release(&tickslock);
80105b4f:	c7 04 24 e0 81 11 80 	movl   $0x801181e0,(%esp)
80105b56:	e8 d5 e9 ff ff       	call   80104530 <release>
80105b5b:	e9 e6 fd ff ff       	jmp    80105946 <trap+0x36>
...
80105b66:	e8 e5 cb ff ff       	call   80102750 <cpunum>
...
80105b7a:	c7 04 24 34 78 10 80 	movl   $0x80107834,(%esp)
80105b81:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b85:	e8 c6 aa ff ff       	call   80100650 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
80105b8a:	c7 04 24 0a 78 10 80 	movl   $0x8010780a,(%esp)
...
80105bf7:	e8 14 cc ff ff       	call   80102810 <microdelay>
{
  int i;
...
80105c6e:	74 52                	je     80105cc2 <uartinit+0xa2>
    return;
  uart = 1;
80105c70:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105c77:	00 00 00 
...
80105c7f:	ec                   	in     (%dx),%al
  ...
  inb(COM1+0);
  picenable(IRQ_COM1);
80105c80:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  ioapicenable(IRQ_COM1, 0);

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105c87:	bb 2c 79 10 80       	mov    $0x8010792c,%ebx
  ...
  inb(COM1+0);
  picenable(IRQ_COM1);
80105c8c:	e8 5f d5 ff ff       	call   801031f0 <picenable>
  ioapicenable(IRQ_COM1, 0);
80105c91:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105c98:	00 
80105c99:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105ca0:	e8 fb c5 ff ff       	call   801022a0 <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105ca5:	b8 78 00 00 00       	mov    $0x78,%eax
...
80105cb0:	89 04 24             	mov    %eax,(%esp)
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105cb3:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105cb6:	e8 15 ff ff ff       	call   80105bd0 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80105cbb:	0f be 03             	movsbl (%ebx),%eax
80105cbe:	84 c0                	test   %al,%al
80105cc0:	75 ee                	jne    80105cb0 <uartinit+0x90>
    uartputc(*p);
}
80105cc2:	83 c4 1c             	add    $0x1c,%esp
80105cc5:	5b                   	pop    %ebx
80105cc6:	5e                   	pop    %esi
80105cc7:	5f                   	pop    %edi
80105cc8:	5d                   	pop    %ebp
...
80105cd6:	c7 04 24 a0 5b 10 80 	movl   $0x80105ba0,(%esp)
80105cdd:	e8 ce aa ff ff       	call   801007b0 <consoleintr>
}
80105ce2:	c9                   	leave  
80105ce3:	c3                   	ret    
...
80105ce6:	6a 00                	push   $0x0
  jmp alltraps
80105ce8:	e9 20 fb ff ff       	jmp    8010580d <alltraps>
...
80105cef:	6a 01                	push   $0x1
  jmp alltraps
80105cf1:	e9 17 fb ff ff       	jmp    8010580d <alltraps>
...
80105cf8:	6a 02                	push   $0x2
  jmp alltraps
80105cfa:	e9 0e fb ff ff       	jmp    8010580d <alltraps>
...
80105d01:	6a 03                	push   $0x3
  jmp alltraps
80105d03:	e9 05 fb ff ff       	jmp    8010580d <alltraps>
...
80105d11:	6a 00                	push   $0x0
  pushl $5
80105d13:	6a 05                	push   $0x5
  jmp alltraps
80105d15:	e9 f3 fa ff ff       	jmp    8010580d <alltraps>
...
80105d1a:	6a 00                	push   $0x0
  pushl $6
80105d1c:	6a 06                	push   $0x6
  jmp alltraps
80105d1e:	e9 ea fa ff ff       	jmp    8010580d <alltraps>
...
80105d23:	6a 00                	push   $0x0
  pushl $7
80105d25:	6a 07                	push   $0x7
  jmp alltraps
80105d27:	e9 e1 fa ff ff       	jmp    8010580d <alltraps>

80105d2c <vector8>:
.globl vector8
vector8:
  pushl $8
80105d2c:	6a 08                	push   $0x8
  jmp alltraps
80105d2e:	e9 da fa ff ff       	jmp    8010580d <alltraps>
...
80105d33:	6a 00                	push   $0x0
  pushl $9
80105d35:	6a 09                	push   $0x9
  jmp alltraps
80105d37:	e9 d1 fa ff ff       	jmp    8010580d <alltraps>

80105d3c <vector10>:
.globl vector10
vector10:
  pushl $10
80105d3c:	6a 0a                	push   $0xa
  jmp alltraps
80105d3e:	e9 ca fa ff ff       	jmp    8010580d <alltraps>

80105d43 <vector11>:
.globl vector11
vector11:
  pushl $11
80105d43:	6a 0b                	push   $0xb
  jmp alltraps
...
vector12:
  pushl $12
80105d4a:	6a 0c                	push   $0xc
  jmp alltraps
80105d4c:	e9 bc fa ff ff       	jmp    8010580d <alltraps>

80105d51 <vector13>:
.globl vector13
vector13:
  pushl $13
80105d51:	6a 0d                	push   $0xd
  jmp alltraps
80105d53:	e9 b5 fa ff ff       	jmp    8010580d <alltraps>

80105d58 <vector14>:
.globl vector14
vector14:
  pushl $14
80105d58:	6a 0e                	push   $0xe
  jmp alltraps
80105d5a:	e9 ae fa ff ff       	jmp    8010580d <alltraps>
...
80105d5f:	6a 00                	push   $0x0
  pushl $15
80105d61:	6a 0f                	push   $0xf
  jmp alltraps
80105d63:	e9 a5 fa ff ff       	jmp    8010580d <alltraps>
...
80105d6a:	6a 10                	push   $0x10
  jmp alltraps
80105d6c:	e9 9c fa ff ff       	jmp    8010580d <alltraps>

80105d71 <vector17>:
.globl vector17
vector17:
  pushl $17
80105d71:	6a 11                	push   $0x11
  jmp alltraps
80105d73:	e9 95 fa ff ff       	jmp    8010580d <alltraps>
...
80105d78:	6a 00                	push   $0x0
  pushl $18
80105d7a:	6a 12                	push   $0x12
  jmp alltraps
80105d7c:	e9 8c fa ff ff       	jmp    8010580d <alltraps>
...
80105d81:	6a 00                	push   $0x0
  pushl $19
80105d83:	6a 13                	push   $0x13
  jmp alltraps
80105d85:	e9 83 fa ff ff       	jmp    8010580d <alltraps>
...
80105d8a:	6a 00                	push   $0x0
  pushl $20
80105d8c:	6a 14                	push   $0x14
  jmp alltraps
80105d8e:	e9 7a fa ff ff       	jmp    8010580d <alltraps>
...
80105d93:	6a 00                	push   $0x0
  pushl $21
80105d95:	6a 15                	push   $0x15
  jmp alltraps
80105d97:	e9 71 fa ff ff       	jmp    8010580d <alltraps>
...
80105d9c:	6a 00                	push   $0x0
  pushl $22
80105d9e:	6a 16                	push   $0x16
  jmp alltraps
80105da0:	e9 68 fa ff ff       	jmp    8010580d <alltraps>
...
80105da5:	6a 00                	push   $0x0
  pushl $23
80105da7:	6a 17                	push   $0x17
  jmp alltraps
80105da9:	e9 5f fa ff ff       	jmp    8010580d <alltraps>
...
80105dae:	6a 00                	push   $0x0
  pushl $24
80105db0:	6a 18                	push   $0x18
  jmp alltraps
80105db2:	e9 56 fa ff ff       	jmp    8010580d <alltraps>
...
80105db7:	6a 00                	push   $0x0
  pushl $25
80105db9:	6a 19                	push   $0x19
  jmp alltraps
80105dbb:	e9 4d fa ff ff       	jmp    8010580d <alltraps>
...
80105dc0:	6a 00                	push   $0x0
  pushl $26
80105dc2:	6a 1a                	push   $0x1a
  jmp alltraps
80105dc4:	e9 44 fa ff ff       	jmp    8010580d <alltraps>
...
80105dc9:	6a 00                	push   $0x0
  pushl $27
80105dcb:	6a 1b                	push   $0x1b
  jmp alltraps
80105dcd:	e9 3b fa ff ff       	jmp    8010580d <alltraps>
...
80105dd2:	6a 00                	push   $0x0
  pushl $28
80105dd4:	6a 1c                	push   $0x1c
  jmp alltraps
80105dd6:	e9 32 fa ff ff       	jmp    8010580d <alltraps>
...
80105ddb:	6a 00                	push   $0x0
  pushl $29
80105ddd:	6a 1d                	push   $0x1d
  jmp alltraps
80105ddf:	e9 29 fa ff ff       	jmp    8010580d <alltraps>
...
80105de4:	6a 00                	push   $0x0
  pushl $30
80105de6:	6a 1e                	push   $0x1e
  jmp alltraps
80105de8:	e9 20 fa ff ff       	jmp    8010580d <alltraps>
...
80105ded:	6a 00                	push   $0x0
  pushl $31
80105def:	6a 1f                	push   $0x1f
  jmp alltraps
80105df1:	e9 17 fa ff ff       	jmp    8010580d <alltraps>
...
80105df6:	6a 00                	push   $0x0
  pushl $32
80105df8:	6a 20                	push   $0x20
  jmp alltraps
80105dfa:	e9 0e fa ff ff       	jmp    8010580d <alltraps>
...
80105dff:	6a 00                	push   $0x0
  pushl $33
80105e01:	6a 21                	push   $0x21
  jmp alltraps
80105e03:	e9 05 fa ff ff       	jmp    8010580d <alltraps>
...
80105e08:	6a 00                	push   $0x0
  pushl $34
80105e0a:	6a 22                	push   $0x22
  jmp alltraps
80105e0c:	e9 fc f9 ff ff       	jmp    8010580d <alltraps>
...
80105e11:	6a 00                	push   $0x0
  pushl $35
80105e13:	6a 23                	push   $0x23
  jmp alltraps
80105e15:	e9 f3 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e1a:	6a 00                	push   $0x0
  pushl $36
80105e1c:	6a 24                	push   $0x24
  jmp alltraps
80105e1e:	e9 ea f9 ff ff       	jmp    8010580d <alltraps>
...
80105e23:	6a 00                	push   $0x0
  pushl $37
80105e25:	6a 25                	push   $0x25
  jmp alltraps
80105e27:	e9 e1 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e2c:	6a 00                	push   $0x0
  pushl $38
80105e2e:	6a 26                	push   $0x26
  jmp alltraps
80105e30:	e9 d8 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e35:	6a 00                	push   $0x0
  pushl $39
80105e37:	6a 27                	push   $0x27
  jmp alltraps
80105e39:	e9 cf f9 ff ff       	jmp    8010580d <alltraps>
...
80105e3e:	6a 00                	push   $0x0
  pushl $40
80105e40:	6a 28                	push   $0x28
  jmp alltraps
80105e42:	e9 c6 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e47:	6a 00                	push   $0x0
  pushl $41
80105e49:	6a 29                	push   $0x29
  jmp alltraps
80105e4b:	e9 bd f9 ff ff       	jmp    8010580d <alltraps>
...
80105e50:	6a 00                	push   $0x0
  pushl $42
80105e52:	6a 2a                	push   $0x2a
  jmp alltraps
80105e54:	e9 b4 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e59:	6a 00                	push   $0x0
  pushl $43
80105e5b:	6a 2b                	push   $0x2b
  jmp alltraps
80105e5d:	e9 ab f9 ff ff       	jmp    8010580d <alltraps>
...
80105e62:	6a 00                	push   $0x0
  pushl $44
80105e64:	6a 2c                	push   $0x2c
  jmp alltraps
80105e66:	e9 a2 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e6b:	6a 00                	push   $0x0
  pushl $45
80105e6d:	6a 2d                	push   $0x2d
  jmp alltraps
80105e6f:	e9 99 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e74:	6a 00                	push   $0x0
  pushl $46
80105e76:	6a 2e                	push   $0x2e
  jmp alltraps
80105e78:	e9 90 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e7d:	6a 00                	push   $0x0
  pushl $47
80105e7f:	6a 2f                	push   $0x2f
  jmp alltraps
80105e81:	e9 87 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e86:	6a 00                	push   $0x0
  pushl $48
80105e88:	6a 30                	push   $0x30
  jmp alltraps
80105e8a:	e9 7e f9 ff ff       	jmp    8010580d <alltraps>
...
80105e8f:	6a 00                	push   $0x0
  pushl $49
80105e91:	6a 31                	push   $0x31
  jmp alltraps
80105e93:	e9 75 f9 ff ff       	jmp    8010580d <alltraps>
...
80105e98:	6a 00                	push   $0x0
  pushl $50
80105e9a:	6a 32                	push   $0x32
  jmp alltraps
80105e9c:	e9 6c f9 ff ff       	jmp    8010580d <alltraps>
...
80105ea1:	6a 00                	push   $0x0
  pushl $51
80105ea3:	6a 33                	push   $0x33
  jmp alltraps
80105ea5:	e9 63 f9 ff ff       	jmp    8010580d <alltraps>
...
80105eaa:	6a 00                	push   $0x0
  pushl $52
80105eac:	6a 34                	push   $0x34
  jmp alltraps
80105eae:	e9 5a f9 ff ff       	jmp    8010580d <alltraps>
...
80105eb3:	6a 00                	push   $0x0
  pushl $53
80105eb5:	6a 35                	push   $0x35
  jmp alltraps
80105eb7:	e9 51 f9 ff ff       	jmp    8010580d <alltraps>
...
80105ebc:	6a 00                	push   $0x0
  pushl $54
80105ebe:	6a 36                	push   $0x36
  jmp alltraps
80105ec0:	e9 48 f9 ff ff       	jmp    8010580d <alltraps>
...
80105ec5:	6a 00                	push   $0x0
  pushl $55
80105ec7:	6a 37                	push   $0x37
  jmp alltraps
80105ec9:	e9 3f f9 ff ff       	jmp    8010580d <alltraps>
...
80105ece:	6a 00                	push   $0x0
  pushl $56
80105ed0:	6a 38                	push   $0x38
  jmp alltraps
80105ed2:	e9 36 f9 ff ff       	jmp    8010580d <alltraps>
...
80105ed7:	6a 00                	push   $0x0
  pushl $57
80105ed9:	6a 39                	push   $0x39
  jmp alltraps
80105edb:	e9 2d f9 ff ff       	jmp    8010580d <alltraps>
...
80105ee0:	6a 00                	push   $0x0
  pushl $58
80105ee2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ee4:	e9 24 f9 ff ff       	jmp    8010580d <alltraps>
...
80105ee9:	6a 00                	push   $0x0
  pushl $59
80105eeb:	6a 3b                	push   $0x3b
  jmp alltraps
80105eed:	e9 1b f9 ff ff       	jmp    8010580d <alltraps>
...
80105ef2:	6a 00                	push   $0x0
  pushl $60
80105ef4:	6a 3c                	push   $0x3c
  jmp alltraps
80105ef6:	e9 12 f9 ff ff       	jmp    8010580d <alltraps>
...
80105efb:	6a 00                	push   $0x0
  pushl $61
80105efd:	6a 3d                	push   $0x3d
  jmp alltraps
80105eff:	e9 09 f9 ff ff       	jmp    8010580d <alltraps>
...
80105f04:	6a 00                	push   $0x0
  pushl $62
80105f06:	6a 3e                	push   $0x3e
  jmp alltraps
80105f08:	e9 00 f9 ff ff       	jmp    8010580d <alltraps>
...
80105f0d:	6a 00                	push   $0x0
  pushl $63
80105f0f:	6a 3f                	push   $0x3f
  jmp alltraps
80105f11:	e9 f7 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f16:	6a 00                	push   $0x0
  pushl $64
80105f18:	6a 40                	push   $0x40
  jmp alltraps
80105f1a:	e9 ee f8 ff ff       	jmp    8010580d <alltraps>
...
80105f1f:	6a 00                	push   $0x0
  pushl $65
80105f21:	6a 41                	push   $0x41
  jmp alltraps
80105f23:	e9 e5 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f28:	6a 00                	push   $0x0
  pushl $66
80105f2a:	6a 42                	push   $0x42
  jmp alltraps
80105f2c:	e9 dc f8 ff ff       	jmp    8010580d <alltraps>
...
80105f31:	6a 00                	push   $0x0
  pushl $67
80105f33:	6a 43                	push   $0x43
  jmp alltraps
80105f35:	e9 d3 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f3a:	6a 00                	push   $0x0
  pushl $68
80105f3c:	6a 44                	push   $0x44
  jmp alltraps
80105f3e:	e9 ca f8 ff ff       	jmp    8010580d <alltraps>
...
80105f43:	6a 00                	push   $0x0
  pushl $69
80105f45:	6a 45                	push   $0x45
  jmp alltraps
80105f47:	e9 c1 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f4c:	6a 00                	push   $0x0
  pushl $70
80105f4e:	6a 46                	push   $0x46
  jmp alltraps
80105f50:	e9 b8 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f55:	6a 00                	push   $0x0
  pushl $71
80105f57:	6a 47                	push   $0x47
  jmp alltraps
80105f59:	e9 af f8 ff ff       	jmp    8010580d <alltraps>
...
80105f5e:	6a 00                	push   $0x0
  pushl $72
80105f60:	6a 48                	push   $0x48
  jmp alltraps
80105f62:	e9 a6 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f67:	6a 00                	push   $0x0
  pushl $73
80105f69:	6a 49                	push   $0x49
  jmp alltraps
80105f6b:	e9 9d f8 ff ff       	jmp    8010580d <alltraps>
...
80105f70:	6a 00                	push   $0x0
  pushl $74
80105f72:	6a 4a                	push   $0x4a
  jmp alltraps
80105f74:	e9 94 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f79:	6a 00                	push   $0x0
  pushl $75
80105f7b:	6a 4b                	push   $0x4b
  jmp alltraps
80105f7d:	e9 8b f8 ff ff       	jmp    8010580d <alltraps>
...
80105f82:	6a 00                	push   $0x0
  pushl $76
80105f84:	6a 4c                	push   $0x4c
  jmp alltraps
80105f86:	e9 82 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f8b:	6a 00                	push   $0x0
  pushl $77
80105f8d:	6a 4d                	push   $0x4d
  jmp alltraps
80105f8f:	e9 79 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f94:	6a 00                	push   $0x0
  pushl $78
80105f96:	6a 4e                	push   $0x4e
  jmp alltraps
80105f98:	e9 70 f8 ff ff       	jmp    8010580d <alltraps>
...
80105f9d:	6a 00                	push   $0x0
  pushl $79
80105f9f:	6a 4f                	push   $0x4f
  jmp alltraps
80105fa1:	e9 67 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fa6:	6a 00                	push   $0x0
  pushl $80
80105fa8:	6a 50                	push   $0x50
  jmp alltraps
80105faa:	e9 5e f8 ff ff       	jmp    8010580d <alltraps>
...
80105faf:	6a 00                	push   $0x0
  pushl $81
80105fb1:	6a 51                	push   $0x51
  jmp alltraps
80105fb3:	e9 55 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fb8:	6a 00                	push   $0x0
  pushl $82
80105fba:	6a 52                	push   $0x52
  jmp alltraps
80105fbc:	e9 4c f8 ff ff       	jmp    8010580d <alltraps>
...
80105fc1:	6a 00                	push   $0x0
  pushl $83
80105fc3:	6a 53                	push   $0x53
  jmp alltraps
80105fc5:	e9 43 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fca:	6a 00                	push   $0x0
  pushl $84
80105fcc:	6a 54                	push   $0x54
  jmp alltraps
80105fce:	e9 3a f8 ff ff       	jmp    8010580d <alltraps>
...
80105fd3:	6a 00                	push   $0x0
  pushl $85
80105fd5:	6a 55                	push   $0x55
  jmp alltraps
80105fd7:	e9 31 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fdc:	6a 00                	push   $0x0
  pushl $86
80105fde:	6a 56                	push   $0x56
  jmp alltraps
80105fe0:	e9 28 f8 ff ff       	jmp    8010580d <alltraps>
...
80105fe5:	6a 00                	push   $0x0
  pushl $87
80105fe7:	6a 57                	push   $0x57
  jmp alltraps
80105fe9:	e9 1f f8 ff ff       	jmp    8010580d <alltraps>
...
80105fee:	6a 00                	push   $0x0
  pushl $88
80105ff0:	6a 58                	push   $0x58
  jmp alltraps
80105ff2:	e9 16 f8 ff ff       	jmp    8010580d <alltraps>
...
80105ff7:	6a 00                	push   $0x0
  pushl $89
80105ff9:	6a 59                	push   $0x59
  jmp alltraps
80105ffb:	e9 0d f8 ff ff       	jmp    8010580d <alltraps>
...
80106000:	6a 00                	push   $0x0
  pushl $90
80106002:	6a 5a                	push   $0x5a
  jmp alltraps
80106004:	e9 04 f8 ff ff       	jmp    8010580d <alltraps>
...
80106009:	6a 00                	push   $0x0
  pushl $91
8010600b:	6a 5b                	push   $0x5b
  jmp alltraps
8010600d:	e9 fb f7 ff ff       	jmp    8010580d <alltraps>
...
80106012:	6a 00                	push   $0x0
  pushl $92
80106014:	6a 5c                	push   $0x5c
  jmp alltraps
80106016:	e9 f2 f7 ff ff       	jmp    8010580d <alltraps>
...
8010601b:	6a 00                	push   $0x0
  pushl $93
8010601d:	6a 5d                	push   $0x5d
  jmp alltraps
8010601f:	e9 e9 f7 ff ff       	jmp    8010580d <alltraps>
...
80106024:	6a 00                	push   $0x0
  pushl $94
80106026:	6a 5e                	push   $0x5e
  jmp alltraps
80106028:	e9 e0 f7 ff ff       	jmp    8010580d <alltraps>
...
8010602d:	6a 00                	push   $0x0
  pushl $95
8010602f:	6a 5f                	push   $0x5f
  jmp alltraps
80106031:	e9 d7 f7 ff ff       	jmp    8010580d <alltraps>
...
80106036:	6a 00                	push   $0x0
  pushl $96
80106038:	6a 60                	push   $0x60
  jmp alltraps
8010603a:	e9 ce f7 ff ff       	jmp    8010580d <alltraps>
...
8010603f:	6a 00                	push   $0x0
  pushl $97
80106041:	6a 61                	push   $0x61
  jmp alltraps
80106043:	e9 c5 f7 ff ff       	jmp    8010580d <alltraps>
...
80106048:	6a 00                	push   $0x0
  pushl $98
8010604a:	6a 62                	push   $0x62
  jmp alltraps
8010604c:	e9 bc f7 ff ff       	jmp    8010580d <alltraps>
...
80106051:	6a 00                	push   $0x0
  pushl $99
80106053:	6a 63                	push   $0x63
  jmp alltraps
80106055:	e9 b3 f7 ff ff       	jmp    8010580d <alltraps>
...
8010605a:	6a 00                	push   $0x0
  pushl $100
8010605c:	6a 64                	push   $0x64
  jmp alltraps
8010605e:	e9 aa f7 ff ff       	jmp    8010580d <alltraps>
...
80106063:	6a 00                	push   $0x0
  pushl $101
80106065:	6a 65                	push   $0x65
  jmp alltraps
80106067:	e9 a1 f7 ff ff       	jmp    8010580d <alltraps>
...
8010606c:	6a 00                	push   $0x0
  pushl $102
8010606e:	6a 66                	push   $0x66
  jmp alltraps
80106070:	e9 98 f7 ff ff       	jmp    8010580d <alltraps>
...
80106075:	6a 00                	push   $0x0
  pushl $103
80106077:	6a 67                	push   $0x67
  jmp alltraps
80106079:	e9 8f f7 ff ff       	jmp    8010580d <alltraps>
...
8010607e:	6a 00                	push   $0x0
  pushl $104
80106080:	6a 68                	push   $0x68
  jmp alltraps
80106082:	e9 86 f7 ff ff       	jmp    8010580d <alltraps>
...
80106087:	6a 00                	push   $0x0
  pushl $105
80106089:	6a 69                	push   $0x69
  jmp alltraps
8010608b:	e9 7d f7 ff ff       	jmp    8010580d <alltraps>
...
80106090:	6a 00                	push   $0x0
  pushl $106
80106092:	6a 6a                	push   $0x6a
  jmp alltraps
80106094:	e9 74 f7 ff ff       	jmp    8010580d <alltraps>
...
80106099:	6a 00                	push   $0x0
  pushl $107
8010609b:	6a 6b                	push   $0x6b
  jmp alltraps
8010609d:	e9 6b f7 ff ff       	jmp    8010580d <alltraps>
...
801060a2:	6a 00                	push   $0x0
  pushl $108
801060a4:	6a 6c                	push   $0x6c
  jmp alltraps
801060a6:	e9 62 f7 ff ff       	jmp    8010580d <alltraps>
...
801060ab:	6a 00                	push   $0x0
  pushl $109
801060ad:	6a 6d                	push   $0x6d
  jmp alltraps
801060af:	e9 59 f7 ff ff       	jmp    8010580d <alltraps>
...
801060b4:	6a 00                	push   $0x0
  pushl $110
801060b6:	6a 6e                	push   $0x6e
  jmp alltraps
801060b8:	e9 50 f7 ff ff       	jmp    8010580d <alltraps>
...
801060bd:	6a 00                	push   $0x0
  pushl $111
801060bf:	6a 6f                	push   $0x6f
  jmp alltraps
801060c1:	e9 47 f7 ff ff       	jmp    8010580d <alltraps>
...
801060c6:	6a 00                	push   $0x0
  pushl $112
801060c8:	6a 70                	push   $0x70
  jmp alltraps
801060ca:	e9 3e f7 ff ff       	jmp    8010580d <alltraps>
...
801060cf:	6a 00                	push   $0x0
  pushl $113
801060d1:	6a 71                	push   $0x71
  jmp alltraps
801060d3:	e9 35 f7 ff ff       	jmp    8010580d <alltraps>
...
801060d8:	6a 00                	push   $0x0
  pushl $114
801060da:	6a 72                	push   $0x72
  jmp alltraps
801060dc:	e9 2c f7 ff ff       	jmp    8010580d <alltraps>
...
801060e1:	6a 00                	push   $0x0
  pushl $115
801060e3:	6a 73                	push   $0x73
  jmp alltraps
801060e5:	e9 23 f7 ff ff       	jmp    8010580d <alltraps>
...
801060ea:	6a 00                	push   $0x0
  pushl $116
801060ec:	6a 74                	push   $0x74
  jmp alltraps
801060ee:	e9 1a f7 ff ff       	jmp    8010580d <alltraps>
...
801060f3:	6a 00                	push   $0x0
  pushl $117
801060f5:	6a 75                	push   $0x75
  jmp alltraps
801060f7:	e9 11 f7 ff ff       	jmp    8010580d <alltraps>
...
801060fc:	6a 00                	push   $0x0
  pushl $118
801060fe:	6a 76                	push   $0x76
  jmp alltraps
80106100:	e9 08 f7 ff ff       	jmp    8010580d <alltraps>
...
80106105:	6a 00                	push   $0x0
  pushl $119
80106107:	6a 77                	push   $0x77
  jmp alltraps
80106109:	e9 ff f6 ff ff       	jmp    8010580d <alltraps>
...
8010610e:	6a 00                	push   $0x0
  pushl $120
80106110:	6a 78                	push   $0x78
  jmp alltraps
80106112:	e9 f6 f6 ff ff       	jmp    8010580d <alltraps>
...
80106117:	6a 00                	push   $0x0
  pushl $121
80106119:	6a 79                	push   $0x79
  jmp alltraps
8010611b:	e9 ed f6 ff ff       	jmp    8010580d <alltraps>
...
80106120:	6a 00                	push   $0x0
  pushl $122
80106122:	6a 7a                	push   $0x7a
  jmp alltraps
80106124:	e9 e4 f6 ff ff       	jmp    8010580d <alltraps>
...
80106129:	6a 00                	push   $0x0
  pushl $123
8010612b:	6a 7b                	push   $0x7b
  jmp alltraps
8010612d:	e9 db f6 ff ff       	jmp    8010580d <alltraps>
...
80106132:	6a 00                	push   $0x0
  pushl $124
80106134:	6a 7c                	push   $0x7c
  jmp alltraps
80106136:	e9 d2 f6 ff ff       	jmp    8010580d <alltraps>
...
8010613b:	6a 00                	push   $0x0
  pushl $125
8010613d:	6a 7d                	push   $0x7d
  jmp alltraps
8010613f:	e9 c9 f6 ff ff       	jmp    8010580d <alltraps>
...
80106144:	6a 00                	push   $0x0
  pushl $126
80106146:	6a 7e                	push   $0x7e
  jmp alltraps
80106148:	e9 c0 f6 ff ff       	jmp    8010580d <alltraps>
...
8010614d:	6a 00                	push   $0x0
  pushl $127
8010614f:	6a 7f                	push   $0x7f
  jmp alltraps
80106151:	e9 b7 f6 ff ff       	jmp    8010580d <alltraps>
...
80106158:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010615d:	e9 ab f6 ff ff       	jmp    8010580d <alltraps>
...
80106162:	6a 00                	push   $0x0
  pushl $129
80106164:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106169:	e9 9f f6 ff ff       	jmp    8010580d <alltraps>
...
8010616e:	6a 00                	push   $0x0
  pushl $130
80106170:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106175:	e9 93 f6 ff ff       	jmp    8010580d <alltraps>
...
8010617a:	6a 00                	push   $0x0
  pushl $131
8010617c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106181:	e9 87 f6 ff ff       	jmp    8010580d <alltraps>
...
80106186:	6a 00                	push   $0x0
  pushl $132
80106188:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010618d:	e9 7b f6 ff ff       	jmp    8010580d <alltraps>
...
80106192:	6a 00                	push   $0x0
  pushl $133
80106194:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106199:	e9 6f f6 ff ff       	jmp    8010580d <alltraps>
...
8010619e:	6a 00                	push   $0x0
  pushl $134
801061a0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801061a5:	e9 63 f6 ff ff       	jmp    8010580d <alltraps>
...
801061aa:	6a 00                	push   $0x0
  pushl $135
801061ac:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801061b1:	e9 57 f6 ff ff       	jmp    8010580d <alltraps>
...
801061b6:	6a 00                	push   $0x0
  pushl $136
801061b8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801061bd:	e9 4b f6 ff ff       	jmp    8010580d <alltraps>
...
801061c2:	6a 00                	push   $0x0
  pushl $137
801061c4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801061c9:	e9 3f f6 ff ff       	jmp    8010580d <alltraps>
...
801061ce:	6a 00                	push   $0x0
  pushl $138
801061d0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801061d5:	e9 33 f6 ff ff       	jmp    8010580d <alltraps>
...
801061da:	6a 00                	push   $0x0
  pushl $139
801061dc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061e1:	e9 27 f6 ff ff       	jmp    8010580d <alltraps>
...
801061e6:	6a 00                	push   $0x0
  pushl $140
801061e8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061ed:	e9 1b f6 ff ff       	jmp    8010580d <alltraps>
...
801061f2:	6a 00                	push   $0x0
  pushl $141
801061f4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061f9:	e9 0f f6 ff ff       	jmp    8010580d <alltraps>
...
801061fe:	6a 00                	push   $0x0
  pushl $142
80106200:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106205:	e9 03 f6 ff ff       	jmp    8010580d <alltraps>
...
8010620a:	6a 00                	push   $0x0
  pushl $143
8010620c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106211:	e9 f7 f5 ff ff       	jmp    8010580d <alltraps>
...
80106216:	6a 00                	push   $0x0
  pushl $144
80106218:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010621d:	e9 eb f5 ff ff       	jmp    8010580d <alltraps>
...
80106222:	6a 00                	push   $0x0
  pushl $145
80106224:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106229:	e9 df f5 ff ff       	jmp    8010580d <alltraps>
...
8010622e:	6a 00                	push   $0x0
  pushl $146
80106230:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106235:	e9 d3 f5 ff ff       	jmp    8010580d <alltraps>
...
8010623a:	6a 00                	push   $0x0
  pushl $147
8010623c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106241:	e9 c7 f5 ff ff       	jmp    8010580d <alltraps>
...
80106246:	6a 00                	push   $0x0
  pushl $148
80106248:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010624d:	e9 bb f5 ff ff       	jmp    8010580d <alltraps>
...
80106252:	6a 00                	push   $0x0
  pushl $149
80106254:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106259:	e9 af f5 ff ff       	jmp    8010580d <alltraps>
...
8010625e:	6a 00                	push   $0x0
  pushl $150
80106260:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106265:	e9 a3 f5 ff ff       	jmp    8010580d <alltraps>
...
8010626a:	6a 00                	push   $0x0
  pushl $151
8010626c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106271:	e9 97 f5 ff ff       	jmp    8010580d <alltraps>
...
80106276:	6a 00                	push   $0x0
  pushl $152
80106278:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010627d:	e9 8b f5 ff ff       	jmp    8010580d <alltraps>
...
80106282:	6a 00                	push   $0x0
  pushl $153
80106284:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106289:	e9 7f f5 ff ff       	jmp    8010580d <alltraps>
...
8010628e:	6a 00                	push   $0x0
  pushl $154
80106290:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106295:	e9 73 f5 ff ff       	jmp    8010580d <alltraps>
...
8010629a:	6a 00                	push   $0x0
  pushl $155
8010629c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801062a1:	e9 67 f5 ff ff       	jmp    8010580d <alltraps>
...
801062a6:	6a 00                	push   $0x0
  pushl $156
801062a8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801062ad:	e9 5b f5 ff ff       	jmp    8010580d <alltraps>
...
801062b2:	6a 00                	push   $0x0
  pushl $157
801062b4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801062b9:	e9 4f f5 ff ff       	jmp    8010580d <alltraps>
...
801062be:	6a 00                	push   $0x0
  pushl $158
801062c0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801062c5:	e9 43 f5 ff ff       	jmp    8010580d <alltraps>
...
801062ca:	6a 00                	push   $0x0
  pushl $159
801062cc:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801062d1:	e9 37 f5 ff ff       	jmp    8010580d <alltraps>
...
801062d6:	6a 00                	push   $0x0
  pushl $160
801062d8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801062dd:	e9 2b f5 ff ff       	jmp    8010580d <alltraps>
...
801062e2:	6a 00                	push   $0x0
  pushl $161
801062e4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062e9:	e9 1f f5 ff ff       	jmp    8010580d <alltraps>
...
801062ee:	6a 00                	push   $0x0
  pushl $162
801062f0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062f5:	e9 13 f5 ff ff       	jmp    8010580d <alltraps>
...
801062fa:	6a 00                	push   $0x0
  pushl $163
801062fc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106301:	e9 07 f5 ff ff       	jmp    8010580d <alltraps>
...
80106306:	6a 00                	push   $0x0
  pushl $164
80106308:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010630d:	e9 fb f4 ff ff       	jmp    8010580d <alltraps>
...
80106312:	6a 00                	push   $0x0
  pushl $165
80106314:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106319:	e9 ef f4 ff ff       	jmp    8010580d <alltraps>
...
8010631e:	6a 00                	push   $0x0
  pushl $166
80106320:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106325:	e9 e3 f4 ff ff       	jmp    8010580d <alltraps>
...
8010632a:	6a 00                	push   $0x0
  pushl $167
8010632c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106331:	e9 d7 f4 ff ff       	jmp    8010580d <alltraps>
...
80106336:	6a 00                	push   $0x0
  pushl $168
80106338:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010633d:	e9 cb f4 ff ff       	jmp    8010580d <alltraps>
...
80106342:	6a 00                	push   $0x0
  pushl $169
80106344:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106349:	e9 bf f4 ff ff       	jmp    8010580d <alltraps>
...
8010634e:	6a 00                	push   $0x0
  pushl $170
80106350:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106355:	e9 b3 f4 ff ff       	jmp    8010580d <alltraps>
...
8010635a:	6a 00                	push   $0x0
  pushl $171
8010635c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106361:	e9 a7 f4 ff ff       	jmp    8010580d <alltraps>
...
80106366:	6a 00                	push   $0x0
  pushl $172
80106368:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010636d:	e9 9b f4 ff ff       	jmp    8010580d <alltraps>
...
80106372:	6a 00                	push   $0x0
  pushl $173
80106374:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106379:	e9 8f f4 ff ff       	jmp    8010580d <alltraps>
...
8010637e:	6a 00                	push   $0x0
  pushl $174
80106380:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106385:	e9 83 f4 ff ff       	jmp    8010580d <alltraps>
...
8010638a:	6a 00                	push   $0x0
  pushl $175
8010638c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106391:	e9 77 f4 ff ff       	jmp    8010580d <alltraps>
...
80106396:	6a 00                	push   $0x0
  pushl $176
80106398:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010639d:	e9 6b f4 ff ff       	jmp    8010580d <alltraps>
...
801063a2:	6a 00                	push   $0x0
  pushl $177
801063a4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801063a9:	e9 5f f4 ff ff       	jmp    8010580d <alltraps>
...
801063ae:	6a 00                	push   $0x0
  pushl $178
801063b0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801063b5:	e9 53 f4 ff ff       	jmp    8010580d <alltraps>
...
801063ba:	6a 00                	push   $0x0
  pushl $179
801063bc:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801063c1:	e9 47 f4 ff ff       	jmp    8010580d <alltraps>
...
801063c6:	6a 00                	push   $0x0
  pushl $180
801063c8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801063cd:	e9 3b f4 ff ff       	jmp    8010580d <alltraps>
...
801063d2:	6a 00                	push   $0x0
  pushl $181
801063d4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801063d9:	e9 2f f4 ff ff       	jmp    8010580d <alltraps>
...
801063de:	6a 00                	push   $0x0
  pushl $182
801063e0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063e5:	e9 23 f4 ff ff       	jmp    8010580d <alltraps>
...
801063ea:	6a 00                	push   $0x0
  pushl $183
801063ec:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063f1:	e9 17 f4 ff ff       	jmp    8010580d <alltraps>
...
801063f6:	6a 00                	push   $0x0
  pushl $184
801063f8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063fd:	e9 0b f4 ff ff       	jmp    8010580d <alltraps>
...
80106402:	6a 00                	push   $0x0
  pushl $185
80106404:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106409:	e9 ff f3 ff ff       	jmp    8010580d <alltraps>
...
8010640e:	6a 00                	push   $0x0
  pushl $186
80106410:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106415:	e9 f3 f3 ff ff       	jmp    8010580d <alltraps>
...
8010641a:	6a 00                	push   $0x0
  pushl $187
8010641c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106421:	e9 e7 f3 ff ff       	jmp    8010580d <alltraps>
...
80106426:	6a 00                	push   $0x0
  pushl $188
80106428:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010642d:	e9 db f3 ff ff       	jmp    8010580d <alltraps>
...
80106432:	6a 00                	push   $0x0
  pushl $189
80106434:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106439:	e9 cf f3 ff ff       	jmp    8010580d <alltraps>
...
8010643e:	6a 00                	push   $0x0
  pushl $190
80106440:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106445:	e9 c3 f3 ff ff       	jmp    8010580d <alltraps>
...
8010644a:	6a 00                	push   $0x0
  pushl $191
8010644c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106451:	e9 b7 f3 ff ff       	jmp    8010580d <alltraps>
...
80106456:	6a 00                	push   $0x0
  pushl $192
80106458:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010645d:	e9 ab f3 ff ff       	jmp    8010580d <alltraps>
...
80106462:	6a 00                	push   $0x0
  pushl $193
80106464:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106469:	e9 9f f3 ff ff       	jmp    8010580d <alltraps>
...
8010646e:	6a 00                	push   $0x0
  pushl $194
80106470:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106475:	e9 93 f3 ff ff       	jmp    8010580d <alltraps>
...
8010647a:	6a 00                	push   $0x0
  pushl $195
8010647c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106481:	e9 87 f3 ff ff       	jmp    8010580d <alltraps>
...
80106486:	6a 00                	push   $0x0
  pushl $196
80106488:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010648d:	e9 7b f3 ff ff       	jmp    8010580d <alltraps>
...
80106492:	6a 00                	push   $0x0
  pushl $197
80106494:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106499:	e9 6f f3 ff ff       	jmp    8010580d <alltraps>
...
8010649e:	6a 00                	push   $0x0
  pushl $198
801064a0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801064a5:	e9 63 f3 ff ff       	jmp    8010580d <alltraps>
...
801064aa:	6a 00                	push   $0x0
  pushl $199
801064ac:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801064b1:	e9 57 f3 ff ff       	jmp    8010580d <alltraps>
...
801064b6:	6a 00                	push   $0x0
  pushl $200
801064b8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801064bd:	e9 4b f3 ff ff       	jmp    8010580d <alltraps>
...
801064c2:	6a 00                	push   $0x0
  pushl $201
801064c4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801064c9:	e9 3f f3 ff ff       	jmp    8010580d <alltraps>
...
801064ce:	6a 00                	push   $0x0
  pushl $202
801064d0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801064d5:	e9 33 f3 ff ff       	jmp    8010580d <alltraps>
...
801064da:	6a 00                	push   $0x0
  pushl $203
801064dc:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064e1:	e9 27 f3 ff ff       	jmp    8010580d <alltraps>
...
801064e6:	6a 00                	push   $0x0
  pushl $204
801064e8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064ed:	e9 1b f3 ff ff       	jmp    8010580d <alltraps>
...
801064f2:	6a 00                	push   $0x0
  pushl $205
801064f4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064f9:	e9 0f f3 ff ff       	jmp    8010580d <alltraps>
...
801064fe:	6a 00                	push   $0x0
  pushl $206
80106500:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106505:	e9 03 f3 ff ff       	jmp    8010580d <alltraps>
...
8010650a:	6a 00                	push   $0x0
  pushl $207
8010650c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106511:	e9 f7 f2 ff ff       	jmp    8010580d <alltraps>
...
80106516:	6a 00                	push   $0x0
  pushl $208
80106518:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010651d:	e9 eb f2 ff ff       	jmp    8010580d <alltraps>
...
80106522:	6a 00                	push   $0x0
  pushl $209
80106524:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106529:	e9 df f2 ff ff       	jmp    8010580d <alltraps>
...
8010652e:	6a 00                	push   $0x0
  pushl $210
80106530:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106535:	e9 d3 f2 ff ff       	jmp    8010580d <alltraps>
...
8010653a:	6a 00                	push   $0x0
  pushl $211
8010653c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106541:	e9 c7 f2 ff ff       	jmp    8010580d <alltraps>
...
80106546:	6a 00                	push   $0x0
  pushl $212
80106548:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010654d:	e9 bb f2 ff ff       	jmp    8010580d <alltraps>
...
80106552:	6a 00                	push   $0x0
  pushl $213
80106554:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106559:	e9 af f2 ff ff       	jmp    8010580d <alltraps>
...
8010655e:	6a 00                	push   $0x0
  pushl $214
80106560:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106565:	e9 a3 f2 ff ff       	jmp    8010580d <alltraps>
...
8010656a:	6a 00                	push   $0x0
  pushl $215
8010656c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106571:	e9 97 f2 ff ff       	jmp    8010580d <alltraps>
...
80106576:	6a 00                	push   $0x0
  pushl $216
80106578:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010657d:	e9 8b f2 ff ff       	jmp    8010580d <alltraps>
...
80106582:	6a 00                	push   $0x0
  pushl $217
80106584:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106589:	e9 7f f2 ff ff       	jmp    8010580d <alltraps>
...
8010658e:	6a 00                	push   $0x0
  pushl $218
80106590:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106595:	e9 73 f2 ff ff       	jmp    8010580d <alltraps>
...
8010659a:	6a 00                	push   $0x0
  pushl $219
8010659c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801065a1:	e9 67 f2 ff ff       	jmp    8010580d <alltraps>
...
801065a6:	6a 00                	push   $0x0
  pushl $220
801065a8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801065ad:	e9 5b f2 ff ff       	jmp    8010580d <alltraps>
...
801065b2:	6a 00                	push   $0x0
  pushl $221
801065b4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801065b9:	e9 4f f2 ff ff       	jmp    8010580d <alltraps>
...
801065be:	6a 00                	push   $0x0
  pushl $222
801065c0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801065c5:	e9 43 f2 ff ff       	jmp    8010580d <alltraps>
...
801065ca:	6a 00                	push   $0x0
  pushl $223
801065cc:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801065d1:	e9 37 f2 ff ff       	jmp    8010580d <alltraps>
...
801065d6:	6a 00                	push   $0x0
  pushl $224
801065d8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801065dd:	e9 2b f2 ff ff       	jmp    8010580d <alltraps>
...
801065e2:	6a 00                	push   $0x0
  pushl $225
801065e4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065e9:	e9 1f f2 ff ff       	jmp    8010580d <alltraps>
...
801065ee:	6a 00                	push   $0x0
  pushl $226
801065f0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065f5:	e9 13 f2 ff ff       	jmp    8010580d <alltraps>
...
801065fa:	6a 00                	push   $0x0
  pushl $227
801065fc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106601:	e9 07 f2 ff ff       	jmp    8010580d <alltraps>
...
80106606:	6a 00                	push   $0x0
  pushl $228
80106608:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010660d:	e9 fb f1 ff ff       	jmp    8010580d <alltraps>
...
80106612:	6a 00                	push   $0x0
  pushl $229
80106614:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106619:	e9 ef f1 ff ff       	jmp    8010580d <alltraps>
...
8010661e:	6a 00                	push   $0x0
  pushl $230
80106620:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106625:	e9 e3 f1 ff ff       	jmp    8010580d <alltraps>
...
8010662a:	6a 00                	push   $0x0
  pushl $231
8010662c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106631:	e9 d7 f1 ff ff       	jmp    8010580d <alltraps>
...
80106636:	6a 00                	push   $0x0
  pushl $232
80106638:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010663d:	e9 cb f1 ff ff       	jmp    8010580d <alltraps>
...
80106642:	6a 00                	push   $0x0
  pushl $233
80106644:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106649:	e9 bf f1 ff ff       	jmp    8010580d <alltraps>
...
8010664e:	6a 00                	push   $0x0
  pushl $234
80106650:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106655:	e9 b3 f1 ff ff       	jmp    8010580d <alltraps>
...
8010665a:	6a 00                	push   $0x0
  pushl $235
8010665c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106661:	e9 a7 f1 ff ff       	jmp    8010580d <alltraps>
...
80106666:	6a 00                	push   $0x0
  pushl $236
80106668:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010666d:	e9 9b f1 ff ff       	jmp    8010580d <alltraps>
...
80106672:	6a 00                	push   $0x0
  pushl $237
80106674:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106679:	e9 8f f1 ff ff       	jmp    8010580d <alltraps>
...
8010667e:	6a 00                	push   $0x0
  pushl $238
80106680:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106685:	e9 83 f1 ff ff       	jmp    8010580d <alltraps>
...
8010668a:	6a 00                	push   $0x0
  pushl $239
8010668c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106691:	e9 77 f1 ff ff       	jmp    8010580d <alltraps>
...
80106696:	6a 00                	push   $0x0
  pushl $240
80106698:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010669d:	e9 6b f1 ff ff       	jmp    8010580d <alltraps>
...
801066a2:	6a 00                	push   $0x0
  pushl $241
801066a4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801066a9:	e9 5f f1 ff ff       	jmp    8010580d <alltraps>
...
801066ae:	6a 00                	push   $0x0
  pushl $242
801066b0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801066b5:	e9 53 f1 ff ff       	jmp    8010580d <alltraps>
...
801066ba:	6a 00                	push   $0x0
  pushl $243
801066bc:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801066c1:	e9 47 f1 ff ff       	jmp    8010580d <alltraps>
...
801066c6:	6a 00                	push   $0x0
  pushl $244
801066c8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801066cd:	e9 3b f1 ff ff       	jmp    8010580d <alltraps>
...
801066d2:	6a 00                	push   $0x0
  pushl $245
801066d4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801066d9:	e9 2f f1 ff ff       	jmp    8010580d <alltraps>
...
801066de:	6a 00                	push   $0x0
  pushl $246
801066e0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066e5:	e9 23 f1 ff ff       	jmp    8010580d <alltraps>
...
801066ea:	6a 00                	push   $0x0
  pushl $247
801066ec:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066f1:	e9 17 f1 ff ff       	jmp    8010580d <alltraps>
...
801066f6:	6a 00                	push   $0x0
  pushl $248
801066f8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066fd:	e9 0b f1 ff ff       	jmp    8010580d <alltraps>
...
80106702:	6a 00                	push   $0x0
  pushl $249
80106704:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106709:	e9 ff f0 ff ff       	jmp    8010580d <alltraps>
...
8010670e:	6a 00                	push   $0x0
  pushl $250
80106710:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106715:	e9 f3 f0 ff ff       	jmp    8010580d <alltraps>
...
8010671a:	6a 00                	push   $0x0
  pushl $251
8010671c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106721:	e9 e7 f0 ff ff       	jmp    8010580d <alltraps>
...
80106726:	6a 00                	push   $0x0
  pushl $252
80106728:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010672d:	e9 db f0 ff ff       	jmp    8010580d <alltraps>
...
80106732:	6a 00                	push   $0x0
  pushl $253
80106734:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106739:	e9 cf f0 ff ff       	jmp    8010580d <alltraps>
...
8010673e:	6a 00                	push   $0x0
  pushl $254
80106740:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106745:	e9 c3 f0 ff ff       	jmp    8010580d <alltraps>
...
8010674a:	6a 00                	push   $0x0
  pushl $255
8010674c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106751:	e9 b7 f0 ff ff       	jmp    8010580d <alltraps>
80106756:	66 90                	xchg   %ax,%ax
80106758:	66 90                	xchg   %ax,%ax
...
80106765:	89 d6                	mov    %edx,%esi
  ...
  pde = &pgdir[PDX(va)];
80106767:	c1 ea 16             	shr    $0x16,%edx
// Return the address of the PTE in page table pgdir
// that corresponds to virtual address va.  If alloc!=0,
// create any required page table pages.
static pte_t *
...
8010676e:	83 ec 1c             	sub    $0x1c,%esp
  ...
  pde = &pgdir[PDX(va)];
  if(*pde & PTE_P){
80106771:	8b 1f                	mov    (%edi),%ebx
80106773:	f6 c3 01             	test   $0x1,%bl
80106776:	74 28                	je     801067a0 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106778:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
8010677e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106784:	c1 ee 0a             	shr    $0xa,%esi
}
80106787:	83 c4 1c             	add    $0x1c,%esp
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801067a2:	74 34                	je     801067d8 <walkpgdir+0x78>
801067a4:	e8 e7 bc ff ff       	call   80102490 <kalloc>
801067a9:	85 c0                	test   %eax,%eax
801067ab:	89 c3                	mov    %eax,%ebx
801067ad:	74 29                	je     801067d8 <walkpgdir+0x78>
      return 0;
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
801067af:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801067b6:	00 
801067b7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801067be:	00 
801067bf:	89 04 24             	mov    %eax,(%esp)
801067c2:	e8 b9 dd ff ff       	call   80104580 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801067c7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801067cd:	83 c8 07             	or     $0x7,%eax
801067d0:	89 07                	mov    %eax,(%edi)
801067d2:	eb b0                	jmp    80106784 <walkpgdir+0x24>
...
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
801067f8:	83 ec 1c             	sub    $0x1c,%esp
801067fb:	8b 7d 08             	mov    0x8(%ebp),%edi
  char *a, *last;
  pte_t *pte;
...
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
80106804:	89 45 e0             	mov    %eax,-0x20(%ebp)
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106807:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
8010680b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
8010680e:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
{
  char *a, *last;
  pte_t *pte;
  ...
  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106812:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
80106819:	29 df                	sub    %ebx,%edi
8010681b:	eb 18                	jmp    80106835 <mappages+0x45>
...
80106823:	75 3d                	jne    80106862 <mappages+0x72>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106825:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
80106828:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
...
8010682b:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010682d:	74 29                	je     80106858 <mappages+0x68>
      break;
    a += PGSIZE;
...
80106842:	e8 19 ff ff ff       	call   80106760 <walkpgdir>
...
8010684b:	83 c4 1c             	add    $0x1c,%esp
...
80106861:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106862:	c7 04 24 34 79 10 80 	movl   $0x80107934,(%esp)
...
80106879:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
8010687a:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106880:	83 ec 1c             	sub    $0x1c,%esp
  uint a, pa;
  ...
  a = PGROUNDUP(newsz);
80106883:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106889:	39 d3                	cmp    %edx,%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010688b:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
8010688e:	72 3b                	jb     801068cb <deallocuvm.part.0+0x5b>
80106890:	eb 5e                	jmp    801068f0 <deallocuvm.part.0+0x80>
...
8010689d:	74 22                	je     801068c1 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010689f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
801068a5:	74 54                	je     801068fb <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
801068a7:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
801068ad:	89 14 24             	mov    %edx,(%esp)
801068b0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068b3:	e8 28 ba ff ff       	call   801022e0 <kfree>
      *pte = 0;
801068b8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801068bb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
801068c7:	39 f3                	cmp    %esi,%ebx
801068c9:	73 25                	jae    801068f0 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
801068cb:	31 c9                	xor    %ecx,%ecx
801068cd:	89 da                	mov    %ebx,%edx
801068cf:	89 f8                	mov    %edi,%eax
801068d1:	e8 8a fe ff ff       	call   80106760 <walkpgdir>
    if(!pte)
801068d6:	85 c0                	test   %eax,%eax
801068d8:	75 be                	jne    80106898 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801068da:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
801068e0:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801068e6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801068ec:	39 f3                	cmp    %esi,%ebx
801068ee:	72 db                	jb     801068cb <deallocuvm.part.0+0x5b>
      kfree(v);
      *pte = 0;
    }
  }
...
801068f0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801068f3:	83 c4 1c             	add    $0x1c,%esp
801068f6:	5b                   	pop    %ebx
801068f7:	5e                   	pop    %esi
801068f8:	5f                   	pop    %edi
801068f9:	5d                   	pop    %ebp
801068fa:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
801068fb:	c7 04 24 f2 72 10 80 	movl   $0x801072f2,(%esp)
80106902:	e8 59 9a ff ff       	call   80100360 <panic>
...
80106913:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpunum()];
80106916:	e8 35 be ff ff       	call   80102750 <cpunum>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010691b:	31 c9                	xor    %ecx,%ecx
8010691d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
80106922:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80106928:	05 a0 27 11 80       	add    $0x801127a0,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010692d:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106931:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106936:	66 89 48 7a          	mov    %cx,0x7a(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010693a:	31 c9                	xor    %ecx,%ecx
8010693c:	66 89 90 80 00 00 00 	mov    %dx,0x80(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106943:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106948:	66 89 88 82 00 00 00 	mov    %cx,0x82(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010694f:	31 c9                	xor    %ecx,%ecx
80106951:	66 89 90 90 00 00 00 	mov    %dx,0x90(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106958:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010695d:	66 89 88 92 00 00 00 	mov    %cx,0x92(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106964:	31 c9                	xor    %ecx,%ecx
80106966:	66 89 90 98 00 00 00 	mov    %dx,0x98(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010696d:	8d 90 b4 00 00 00    	lea    0xb4(%eax),%edx
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106973:	66 89 88 9a 00 00 00 	mov    %cx,0x9a(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010697a:	31 c9                	xor    %ecx,%ecx
8010697c:	66 89 88 88 00 00 00 	mov    %cx,0x88(%eax)
80106983:	89 d1                	mov    %edx,%ecx
80106985:	c1 e9 10             	shr    $0x10,%ecx
80106988:	66 89 90 8a 00 00 00 	mov    %dx,0x8a(%eax)
8010698f:	c1 ea 18             	shr    $0x18,%edx
80106992:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80106998:	b9 37 00 00 00       	mov    $0x37,%ecx
8010699d:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
801069a3:	8d 50 70             	lea    0x70(%eax),%edx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801069a6:	c6 40 7d 9a          	movb   $0x9a,0x7d(%eax)
801069aa:	c6 40 7e cf          	movb   $0xcf,0x7e(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801069ae:	c6 80 85 00 00 00 92 	movb   $0x92,0x85(%eax)
801069b5:	c6 80 86 00 00 00 cf 	movb   $0xcf,0x86(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801069bc:	c6 80 95 00 00 00 fa 	movb   $0xfa,0x95(%eax)
801069c3:	c6 80 96 00 00 00 cf 	movb   $0xcf,0x96(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801069ca:	c6 80 9d 00 00 00 f2 	movb   $0xf2,0x9d(%eax)
801069d1:	c6 80 9e 00 00 00 cf 	movb   $0xcf,0x9e(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801069d8:	c6 80 8d 00 00 00 92 	movb   $0x92,0x8d(%eax)
801069df:	c6 80 8e 00 00 00 c0 	movb   $0xc0,0x8e(%eax)
801069e6:	66 89 4d f2          	mov    %cx,-0xe(%ebp)
  pd[1] = (uint)p;
801069ea:	66 89 55 f4          	mov    %dx,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
801069ee:	c1 ea 10             	shr    $0x10,%edx
801069f1:	66 89 55 f6          	mov    %dx,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
801069f5:	8d 55 f2             	lea    -0xe(%ebp),%edx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801069f8:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801069fc:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a00:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80106a07:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a0e:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80106a15:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a1c:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80106a23:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)
80106a2a:	0f 01 12             	lgdtl  (%edx)
}
...
80106a2d:	ba 18 00 00 00       	mov    $0x18,%edx
80106a32:	8e ea                	mov    %edx,%gs
  lgdt(c->gdt, sizeof(c->gdt));
  loadgs(SEG_KCPU << 3);
  ...
  cpu = c;
  proc = 0;
80106a34:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80106a3b:	00 00 00 00 
  ...
  // Initialize cpu-local storage.
  cpu = c;
80106a3f:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
}
80106a45:	c9                   	leave  
80106a46:	c3                   	ret    
...
80106a61:	74 55                	je     80106ab8 <setupkvm+0x68>
    return 0;
...
80106a7b:	e8 00 db ff ff       	call   80104580 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106a96:	e8 55 fd ff ff       	call   801067f0 <mappages>
...
80106abf:	5d                   	pop    %ebp
80106ac0:	c3                   	ret    
80106ac1:	eb 0d                	jmp    80106ad0 <kvmalloc>
80106ac3:	90                   	nop
80106ac4:	90                   	nop
80106ac5:	90                   	nop
80106ac6:	90                   	nop
...
80106ad3:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106ad6:	e8 75 ff ff ff       	call   80106a50 <setupkvm>
80106adb:	a3 24 8a 11 80       	mov    %eax,0x80118a24
...
{
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106af0:	a1 24 8a 11 80       	mov    0x80118a24,%eax
...
80106b1c:	0f 84 94 00 00 00    	je     80106bb6 <switchuvm+0xa6>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80106b22:	8b 43 08             	mov    0x8(%ebx),%eax
80106b25:	85 c0                	test   %eax,%eax
80106b27:	0f 84 a1 00 00 00    	je     80106bce <switchuvm+0xbe>
...
80106b32:	0f 84 8a 00 00 00    	je     80106bc2 <switchuvm+0xb2>
  ...
  pushcli();
80106b38:	e8 73 d9 ff ff       	call   801044b0 <pushcli>
...
80106b52:	89 d1                	mov    %edx,%ecx
80106b54:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
80106b5b:	c1 ea 18             	shr    $0x18,%edx
80106b5e:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
80106b64:	c1 e9 10             	shr    $0x10,%ecx
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
80106b67:	ba 10 00 00 00       	mov    $0x10,%edx
80106b6c:	66 89 50 10          	mov    %dx,0x10(%eax)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
  ...
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106b70:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80106b76:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80106b7d:	c6 80 a5 00 00 00 89 	movb   $0x89,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
...
80106b8d:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  ...
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106b92:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
80106b95:	66 89 48 6e          	mov    %cx,0x6e(%eax)
}
...
80106bac:	83 c4 14             	add    $0x14,%esp
80106baf:	5b                   	pop    %ebx
80106bb0:	5d                   	pop    %ebp
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106bb1:	e9 2a d9 ff ff       	jmp    801044e0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106bb6:	c7 04 24 3a 79 10 80 	movl   $0x8010793a,(%esp)
80106bbd:	e8 9e 97 ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
80106bc2:	c7 04 24 65 79 10 80 	movl   $0x80107965,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80106bce:	c7 04 24 50 79 10 80 	movl   $0x80107950,(%esp)
...
80106c17:	e8 64 d9 ff ff       	call   80104580 <memset>
...
80106c36:	00 
80106c37:	e8 b4 fb ff ff       	call   801067f0 <mappages>
  memmove(mem, init, sz);
...
80106c4b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106c4c:	e9 cf d9 ff ff       	jmp    80104620 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80106c51:	c7 04 24 79 79 10 80 	movl   $0x80107979,(%esp)
...
80106d01:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106d02:	c7 04 24 93 79 10 80 	movl   $0x80107993,(%esp)
80106d09:	e8 52 96 ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
80106d0e:	c7 04 24 34 7a 10 80 	movl   $0x80107a34,(%esp)
...
80106d63:	e8 18 d8 ff ff       	call   80104580 <memset>
...
80106d82:	00 
80106d83:	e8 68 fa ff ff       	call   801067f0 <mappages>
...
80106d9f:	75 af                	jne    80106d50 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106da1:	c7 04 24 b1 79 10 80 	movl   $0x801079b1,(%esp)
...
80106dca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106dd0:	c7 04 24 c9 79 10 80 	movl   $0x801079c9,(%esp)
...
80106de9:	e8 82 fa ff ff       	call   80106870 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106e02:	e8 69 fa ff ff       	call   80106870 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106e20:	5d                   	pop    %ebp
80106e21:	e9 4a fa ff ff       	jmp    80106870 <deallocuvm.part.0>
...
80106e4a:	e8 21 fa ff ff       	call   80106870 <deallocuvm.part.0>
...
freevm(pde_t *pgdir)
{
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106e98:	c7 04 24 e5 79 10 80 	movl   $0x801079e5,(%esp)
...
80106ebe:	e8 9d f8 ff ff       	call   80106760 <walkpgdir>
  if(pte == 0)
...
80106ecb:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106ecc:	c7 04 24 f6 79 10 80 	movl   $0x801079f6,(%esp)
...
80106ee6:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106ee9:	e8 62 fb ff ff       	call   80106a50 <setupkvm>
...
80106f1d:	e8 fe d6 ff ff       	call   80104620 <memmove>
...
80106f3c:	e8 af f8 ff ff       	call   801067f0 <mappages>
...
80106f57:	e8 04 f8 ff ff       	call   80106760 <walkpgdir>
...
80106fad:	eb e4                	jmp    80106f93 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    ...
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106faf:	c7 04 24 1a 7a 10 80 	movl   $0x80107a1a,(%esp)
80106fb6:	e8 a5 93 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106fbb:	c7 04 24 00 7a 10 80 	movl   $0x80107a00,(%esp)
...
80106fde:	e8 7d f7 ff ff       	call   80106760 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010704c:	e8 cf d5 ff ff       	call   80104620 <memmove>
    len -= n;
    buf += n;
