...
main(int argc, char *argv[])
{
  ...
  61:	c7 44 24 04 41 08 00 	movl   $0x841,0x4(%esp)
  68:	00 
  ...
  f3:	c3                   	ret    
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0) {
    if (write(1, buf, n) != n) {
      printf(1, "cat: write error\n");
  f4:	c7 44 24 04 1e 08 00 	movl   $0x81e,0x4(%esp)
  fb:	00 
 ...
 10f:	e8 4e 02 00 00       	call   362 <exit>
  ...
  if(n < 0){
    printf(1, "cat: read error\n");
 114:	c7 44 24 04 30 08 00 	movl   $0x830,0x4(%esp)
 11b:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 449:	0f b6 92 5d 08 00 00 	movzbl 0x85d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5df:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 5e1:	b8 56 08 00 00       	mov    $0x856,%eax
...
000006a0 <free>:
 6a0:	55                   	push   %ebp
 6a1:	a1 20 0b 00 00       	mov    0xb20,%eax
 ...
 71d:	a3 20 0b 00 00       	mov    %eax,0xb20
...
00000730 <malloc>:
 ...
 73c:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 791:	39 05 20 0b 00 00    	cmp    %eax,0xb20
 ...
 7bb:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 7df:	89 15 20 0b 00 00    	mov    %edx,0xb20
 ...
 7f6:	c7 05 20 0b 00 00 24 	movl   $0xb24,0xb20
 7fd:	0b 00 00 
 800:	c7 05 24 0b 00 00 24 	movl   $0xb24,0xb24
 807:	0b 00 00 
 80a:	b8 24 0b 00 00       	mov    $0xb24,%eax
 80f:	c7 05 28 0b 00 00 00 	movl   $0x0,0xb28
 816:	00 00 00 
