...
main(int argc, char *argv[])
{
  ...
  46:	c7 44 24 04 72 07 00 	movl   $0x772,0x4(%esp)
  4d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 389:	0f b6 92 92 07 00 00 	movzbl 0x792(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 8b 07 00 00       	mov    $0x78b,%eax
...
000005e0 <free>:
 ...
 639:	a3 10 0a 00 00       	mov    %eax,0xa10
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 641:	5d                   	pop    %ebp
 ...
 65d:	a3 10 0a 00 00       	mov    %eax,0xa10
...
00000670 <malloc>:
 ...
 67c:	8b 15 10 0a 00 00    	mov    0xa10,%edx
 ...
 6fb:	8b 15 10 0a 00 00    	mov    0xa10,%edx
 ...
 71f:	89 15 10 0a 00 00    	mov    %edx,0xa10
 ...
 736:	c7 05 10 0a 00 00 14 	movl   $0xa14,0xa10
 73d:	0a 00 00 
 740:	c7 05 14 0a 00 00 14 	movl   $0xa14,0xa14
 747:	0a 00 00 
 74a:	b8 14 0a 00 00       	mov    $0xa14,%eax
 74f:	c7 05 18 0a 00 00 00 	movl   $0x0,0xa18
 756:	00 00 00 
