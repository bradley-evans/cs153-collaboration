...
main(int argc, char *argv[])
{
  ...
  20:	c7 44 24 0c 5e 07 00 	movl   $0x75e,0xc(%esp)
  27:	00 
  28:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2c:	c7 44 24 04 60 07 00 	movl   $0x760,0x4(%esp)
  33:	00 
  ...
  4b:	c7 44 24 0c 65 07 00 	movl   $0x765,0xc(%esp)
  52:	00 
  53:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  57:	c7 44 24 04 60 07 00 	movl   $0x760,0x4(%esp)
  5e:	00 
...
000005e0 <free>:
 ...
 639:	a3 e8 09 00 00       	mov    %eax,0x9e8
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 641:	5d                   	pop    %ebp
 ...
 65d:	a3 e8 09 00 00       	mov    %eax,0x9e8
...
00000670 <malloc>:
 ...
 67c:	8b 15 e8 09 00 00    	mov    0x9e8,%edx
 ...
 6d1:	39 05 e8 09 00 00    	cmp    %eax,0x9e8
 ...
 6fb:	8b 15 e8 09 00 00    	mov    0x9e8,%edx
 ...
 71f:	89 15 e8 09 00 00    	mov    %edx,0x9e8
 ...
 736:	c7 05 e8 09 00 00 ec 	movl   $0x9ec,0x9e8
 73d:	09 00 00 
 740:	c7 05 ec 09 00 00 ec 	movl   $0x9ec,0x9ec
 747:	09 00 00 
 74a:	b8 ec 09 00 00       	mov    $0x9ec,%eax
 74f:	c7 05 f0 09 00 00 00 	movl   $0x0,0x9f0
 756:	00 00 00 
